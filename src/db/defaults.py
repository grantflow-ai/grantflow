...
RESEARCH_ASPECT_DEFAULTS_MAPPING: Final[dict[ResearchAspectEnum, list[str]]] = {
    ...
    ResearchAspectEnum.NOVELTY_AND_INNOVATION: [
    ...
    ResearchAspectEnum.TEAM_EXCELLENCE: [
    ...
    ResearchAspectEnum.FEASIBILITY: [
    ...
    ResearchAspectEnum.SPECIFIC_AIMS: [
        "Aim completion timeline",
        "Dependencies between objectives",
        "Hypothesis testing methodology per aim",
        "Logical progression between aims",
        "Primary research objectives",
        "Success outcome metrics",
    ],
    ResearchAspectEnum.PRELIMINARY_DATA: [
    ...
    ResearchAspectEnum.MILESTONES_AND_TIMELINE: [
    ...
    ResearchAspectEnum.SCIENTIFIC_INFRASTRUCTURE: [
...
def set_default_facets(context: DefaultExecutionContext) -> list[str]:
    """Set default facets based on the research aspect type.

    Args:
        context: The default execution context.

    Returns:
        The default facets for the research aspect type.
    """
    return RESEARCH_ASPECT_DEFAULTS_MAPPING[context.get_current_parameters()["type"]]  # type: ignore[no-untyped-call]
