...
class WorkspaceUser(Base):
    ...
    workspace_id: Mapped[UUID] = mapped_column(UUID(), ForeignKey("workspaces.id", ondelete="CASCADE", onupdate="CASCADE"), primary_key=True)
    user_id: Mapped[UUID] = mapped_column(UUID(), ForeignKey("users.id", ondelete="CASCADE", onupdate="CASCADE"), primary_key=True)
...
class GrantCfp(Base):
    ...
    id: Mapped[UUID] = mapped_column(UUID(), primary_key=True, default=uuid4)
    funding_organization_id: Mapped[UUID] = mapped_column(UUID(), ForeignKey("funding_organizations.id", ondelete="CASCADE", onupdate="CASCADE"), nullable=False)
...
class GrantApplication(Base):
    ...
    id: Mapped[UUID] = mapped_column(UUID(), primary_key=True, default=uuid4)
    workspace_id: Mapped[UUID] = mapped_column(UUID(), ForeignKey("workspaces.id", ondelete="CASCADE", onupdate="CASCADE"), nullable=False)
    cfp_id: Mapped[UUID] = mapped_column(UUID(), ForeignKey("grant_cfps.id", ondelete="CASCADE", onupdate="CASCADE"), nullable=False)
    title: Mapped[str] = mapped_column(String(255), nullable=False)
    status: Mapped[ApplicationStatusEnum] = mapped_column(Enum(ApplicationStatusEnum), nullable=False, default=ApplicationStatusEnum.DRAFT)
...
class ApplicationFile(Base):
    ...
    id: Mapped[UUID] = mapped_column(UUID(), primary_key=True, default=uuid4)
    application_id: Mapped[UUID] = mapped_column(UUID(), ForeignKey("grant_applications.id", ondelete="CASCADE", onupdate="CASCADE"), nullable=False)
...
class ResearchTask(Base):
    ...
    id: Mapped[UUID] = mapped_column(UUID(), primary_key=True, default=uuid4)
    aim_id: Mapped[UUID] = mapped_column(UUID(), ForeignKey("research_aims.id", ondelete="CASCADE", onupdate="CASCADE"), nullable=False)
    title: Mapped[str] = mapped_column(String(255), nullable=False)
    description: Mapped[str] = mapped_column(Text, nullable=False)
...
class ApplicationVector(Base):
    ...
    application_id: Mapped[UUID] = mapped_column(UUID(), ForeignKey("grant_applications.id", ondelete="CASCADE"), primary_key=True)
    chunk_index: Mapped[int] = mapped_column(Integer, primary_key=True)
    content: Mapped[str] = mapped_column(Text, nullable=False)
    element_type: Mapped[str] = mapped_column(String(50), nullable=False)
    embedding: Mapped[list[float]] = mapped_column(Vector(EMBEDDING_DIMENSIONS), nullable=False)
    file_id: Mapped[UUID] = mapped_column(UUID(), ForeignKey("application_files.id", ondelete="CASCADE"), primary_key=True)
