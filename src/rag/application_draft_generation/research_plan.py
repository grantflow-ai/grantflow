...
from src.rag.dto import ResearchAimDTO
...
async def handle_research_aim_components_generation(
    *,
    application_id: str,
    research_aim_dto: ResearchAimDTO,
    session_maker: async_sessionmaker[Any],
) -> str:
    """Generate the text for the research aim and its components.
    ...
    Returns:
        The generated research aim text.
    """
...
async def handle_research_plan_text_generation(
    *,
    ...
    research_aim_texts: list[str] = [
        await handle_research_aim_components_generation(
            application_id=application_id,
            research_aim_dto=research_aim_dto,
            session_maker=session_maker,
        )
        for research_aim_dto in sorted(research_aim_dtos, key=lambda x: x.aim_number)
    ]
