...
from src.db.tables import FundingOrganization, Workspace
...
async def test_generate_erc_application_for_lampel(
    ...
    form_inputs: dict[str, str] = {
        ...
        "research_feasibility": "Research plan details were not provided in the input text.",
        ...
        "scientific_infrastructure": "Scientific infrastructure details were not provided in the input text.",
    }
