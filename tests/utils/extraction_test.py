...
async def test_extract_pdf(mock_document_intelligence_client: AsyncMock) -> None:
...
async def test_extract_docx(mock_document_intelligence_client: AsyncMock) -> None:
