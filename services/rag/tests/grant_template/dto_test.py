...
def test_cfp_content_section_required_fields() -> None:
...
def test_cfp_content_section_empty_subtitles() -> None:
    section: CFPContentSection = {
...
def test_cfp_content_section_single_subtitle() -> None:
    section: CFPContentSection = {
        "title": "Methodology",
...
def test_cfp_content_section_multiple_subtitles() -> None:
    section: CFPContentSection = {
        "title": "Research Plan",
        "subtitles": [
            "Specific Aims",
...
def test_extracted_cfp_data_required_fields() -> None:
...
def test_extracted_cfp_data_null_organization() -> None:
    cfp_data: ExtractedCFPData = {
...
def test_extracted_cfp_data_null_submission_date() -> None:
    cfp_data: ExtractedCFPData = {
...
def test_extracted_cfp_data_empty_content() -> None:
    cfp_data: ExtractedCFPData = {
...
def test_extracted_cfp_data_with_error() -> None:
    cfp_data: ExtractedCFPData = {
        "organization_id": None,
...
def test_extracted_cfp_data_complex_content() -> None:
    cfp_data: ExtractedCFPData = {
...
def test_organization_namespace_required_fields() -> None:
    org_id = uuid4()
...
def test_organization_namespace_different_organizations() -> None:
    nsf_id = uuid4()
...
def test_organization_namespace_uuid_validation() -> None:
    org_id = uuid4()
    organization: OrganizationNamespace = {
...
def test_organization_namespace_long_names() -> None:
    org_id = uuid4()
    organization: OrganizationNamespace = {
...
def test_organization_namespace_minimal_abbreviation() -> None:
    org_id = uuid4()
    organization: OrganizationNamespace = {
...
def test_dto_integration_cfp_data_with_cfp_content_sections() -> None:
...
def test_dto_integration_organization_in_cfp_context() -> None:
    org_id = uuid4()
    organization: OrganizationNamespace = {
        "full_name": "National Science Foundation",
        "abbreviation": "NSF",
