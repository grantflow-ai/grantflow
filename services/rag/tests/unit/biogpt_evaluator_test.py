...
class TestBioGPTEvaluator:
    ...
    @pytest.fixture
    def sample_biomedical_text(self):
    ...
    def test_load_model_success(self, mock_torch, mock_model_class, mock_tokenizer_class, mock_tokenizer, mock_model):
    ...
    def test_is_model_loaded_true(self, mock_model, mock_tokenizer):
    ...
    def test_calculate_perplexity_model_not_loaded(self):
    ...
    def test_calculate_perplexity_empty_text(self, mock_model, mock_tokenizer):
    ...
    @patch('services.rag.src.utils.biogpt_evaluator.torch')
    def test_calculate_perplexity_success(self, mock_torch, mock_model, mock_tokenizer):
    ...
    def test_evaluate_text_quality_excellent(self, mock_model, mock_tokenizer):
    ...
    def test_evaluate_text_quality_good(self, mock_model, mock_tokenizer):
    ...
    def test_evaluate_text_quality_acceptable(self, mock_model, mock_tokenizer):
    ...
    def test_evaluate_text_quality_poor(self, mock_model, mock_tokenizer):
    ...
    def test_batch_evaluate_texts(self, mock_model, mock_tokenizer):
    ...
    def test_batch_evaluate_texts_with_errors(self, mock_model, mock_tokenizer):
    ...
    def test_get_model_info_loaded(self, mock_model, mock_tokenizer):
        ...
        assert info["parameters"] == 3  # 3 elements in the tensor
...
class TestGlobalFunctions:
    ...
    def test_get_biogpt_evaluator_singleton(self):
    ...
    def test_get_biogpt_evaluator_with_path(self):
    ...
    def test_load_biogpt_model(self, mock_get_evaluator):
    ...
    @patch('services.rag.src.utils.biogpt_evaluator.get_biogpt_evaluator')
    def test_calculate_biogpt_perplexity(self, mock_get_evaluator):
    ...
    @patch('services.rag.src.utils.biogpt_evaluator.get_biogpt_evaluator')
    def test_evaluate_biomedical_text_quality(self, mock_get_evaluator):
