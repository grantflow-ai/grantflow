...
async def test_complete_evaluation_workflow_biomedical_research() -> None:
    ...
    section_config: GrantLongFormSection = GrantLongFormSection(
        ...
        order=1,
        evidence="CFP evidence for Biomarker Discovery Research Proposal",
        parent_id=None,
        depends_on=[],
...
async def test_complete_evaluation_workflow_poor_content() -> None:
    ...
    section_config: GrantLongFormSection = GrantLongFormSection(
        ...
        order=1,
        evidence="CFP evidence for Poor Content Test",
        parent_id=None,
        depends_on=[],
...
async def test_evaluation_workflow_with_word_limit_violation() -> None:
    ...
    section_config: GrantLongFormSection = GrantLongFormSection(
        ...
        order=1,
        evidence="CFP evidence for Word Limit Test",
        parent_id=None,
        depends_on=[],
...
async def test_evaluation_workflow_edge_case_empty_content() -> None:
    ...
    section_config: GrantLongFormSection = GrantLongFormSection(
        ...
        order=1,
        evidence="CFP evidence for Empty Content Test",
        parent_id=None,
        depends_on=[],
