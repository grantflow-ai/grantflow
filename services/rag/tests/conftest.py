...
# REMOVED: Real grant data (see ADR-002)
...
#         background_context=(
#             "Brain metastases (BMs) occur in almost 50% of patients with metastatic melanoma, resulting in a dismal"
#             " prognosis with a poor overall survival for most patients. Immunotherapy has revolutionized treatment for"
#             " melanoma patients, extending median survival from 6 months to nearly 6 years for patients in advanced"
#             " disease stages. However, many patients still face early relapse or do not respond to treatments."
#             " Particularly in BMs, the milieu of the brain creates a highly immunosuppressive tumor microenvironment"
#             " (TME). Single-cell technologies together with machine learning have emerged as powerful tools to decipher"
#             " complex interactions between cells in the TME, enabling development of data driven designs of"
#             " immunotherapies. Using our advanced technologies to study cells in the tumor microenvironment at a"
#             " single-cell resolution, we identified a subtype of immune cell which is a central part of the TME coined"
#             " regulatory (TREM2+) macrophages. These cells play a crucial role in suppressing the body's ability to fight"
#             " cancer, especially in subsets of immunotherapy-resistant tumors such as melanoma. We have already developed"
#             " an antibody that blocks the suppressive action of these cells."
#         ),
#         hypothesis=(
#             "Our hypothesis is that using our advanced single cell technologies, including cell temporal tracking"
#             " (ZMAN-seq, differentiation flows), cell-cell interactions (PIC-seq), and improved strategies for AI"
#             " analysis of spatial transcriptomics with Stereo-seq, we can to get an in-depth understanding of the BM TME"
#             " and identify cytokines capable of remodulating the TME towards anti-tumor activity. This understanding will"
#             " enable us to design novel immunocytokines combining the most promising cytokines with our antiTREM2"
#             " antibody to modulate both the myeloid and T and NK cell compartments. Our hypothesis is that our single"
#             " cell and AI analysis will also enable us to identify biomarkers to design masking strategies to increase"
#             " the specificity of the immunocytokine to the BM TME."
#         ),
#         rationale=(
#             "Our rationale is that the advances in single cell technologies enable an in depth understanding of the"
#             " immune environment of BMs and identifying novel approaches for activating the immune system to eliminate"
#             " the BMs. Our rationale is also that simultaneously modulating different immune cell compartments"
#             " (macrophages, T cells, NK cells) can induce unprecedented anti-tumor immune response."
#         ),
#         novelty_and_innovation=(
#             "Our research is innovative in the utilization of state-of-the-art single cell technologies including"
#             " ZMAN-seq, PIC-seq and STEREO-seq, in combination with generative AI tools. It is also highly innovative in"
#             " its goal to develop first-in-its-class therapeutic modality simultaneously modulating different immune"
#             " cell compartments (macrophages, T cells, NK cells). Our innovative approach also includes the use of"
#             " masking techniques to increase the molecule's specificity to the BM TME."
#         ),
#         team_excellence=(
#             "Our team of world leaders in immunology, brain tumors and computer science research is ideally suited to"
#             " deliver this disruptive proposal. Our lab is a pioneer and leader in the development and utilization of"
#             " advanced single cell technologies for the study of immunology. We have a track record of innovation and"
#             " groundbreaking discovery. We have already identified TREM2 as a pathway of immunosuppresive macrophages in"
#             " the TME and developed a successful antibody blocking this pathway. We have also made significant advances"
#             " in studying and developing anti-TREM2 immunocytokines."
#         ),
#         preliminary_data=(
#             "As part of our previous research, we demonstrated the synergistic potential of an anti-TREM2 antibody"
#             " combined with cytokines through the induction of strong pro-inflammatory macrophage activity in vitro. We"
#             " have also tested the feasibility of producing TREM2 immunocytokines and developed preliminary model"
#             " molecules, including an IL-2-anti-TREM2 fusion protein. We have also designed a masking strategy for the"
#             " cytokine arm using blocking moieties responsive only to TAM-specific proteases and tested them in vivo."
#         ),
#         research_feasibility=(
#             "We plan to systematically analyse the BM TME using our advanced single cell and AI technologies, rely on"
#             " melanoma BM tumor models and our expertise in antibody design.Our background and capabilities, as well as"
#             " preliminary ensure our goals are ambitious yet feasible and could be completed as part of this project."
#         ),
#         impact=(
#             "Brain metastases (BMs) occur in almost 50% of patients with metastatic melanoma, resulting in a dismal"
#             " prognosis with a poor overall survival for most patients. Development of effective novel therapies for"
#             " melanoma BMs could significantly increase life expectancy and not less important - life quality of"
#             " metastatic melanoma patients."
#         ),
#         scientific_infrastructure=(
#             "Our lab is equipped with the state-of-the-art single cell and molecular biology technologies and is"
#             " supported by the vast scientific infrastructure of the Weizmann Institute of Science."
#         ),
#     )
