...
class TestGenerateObjectiveWithTasks:
    """Test generate_objective_with_tasks function."""
    ...
    async def test_generate_objective_with_tasks_success(
        ...
        assert first_call.kwargs["application_id"] == "test-app-id"
        ...
        assert first_call.kwargs["trace_id"] == "test-trace"
