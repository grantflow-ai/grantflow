...
@performance_test(execution_speed=ExecutionSpeed.SMOKE, domain=Domain.VECTOR_BENCHMARK, timeout=120)
...
@performance_test(execution_speed=ExecutionSpeed.E2E_FULL, domain=Domain.VECTOR_BENCHMARK, timeout=600)
