...
async def create_job_manager_for_baseline(
    session_maker: async_sessionmaker[Any], application_id: UUID
) -> JobManager:
...
async def test_baseline_full_application_generation(
    ...
    async with grant_application_test(
        ...
        expected_patterns=[
            "objective", "methodology", "timeline", "work plan",
            "research", "analysis", "hypothesis"
        ]
    ) as perf_ctx:

        progress.report_step("Starting baseline application generation", {
            "application_id": melanoma_alliance_full_application_id,
        ...
        try:
            progress.report_step("Creating job manager", {
            ...
            progress.report_step("Initializing pipeline", {
                "job_manager": "created",
                "stages": 5
            })
            ...
            progress.report_step("Extracting objectives", {
            ...
            progress.report_step("Running full application generation pipeline", {
            ...
            progress.report_step("Validating generated content", {
            ...
            progress.report_step("Completing baseline analysis", {
            ...
            progress.report_final_status(True, {
                "sections_generated": len(section_texts),
                "total_characters": len(full_text),
            ...
            progress.report_final_status(False, {
...
async def test_baseline_stage_timing_analysis(
    ...
    with create_performance_context(
        ...
        section_texts = [
            "Abstract", "Specific Aims", "Research Methodology",
            "Work Plan and Timeline", "Expected Outcomes", "Budget"
        ]
