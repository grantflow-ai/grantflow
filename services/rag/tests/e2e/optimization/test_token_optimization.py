...
async def test_token_optimization_performance(logger: logging.Logger) -> None:
    ...
    with create_performance_context(
        ...
        test_docs: list[DocumentDTO] = [
            {"id": "1", "content": "This is a test document for melanoma research. " * 50, "metadata": {}},
            {"id": "2", "content": "Another test document about cancer treatment and therapy. " * 50, "metadata": {}},
            {"id": "3", "content": "Research document on immunotherapy and biomarkers. " * 50, "metadata": {}},
        ]
        ...
        with (
            perf_ctx.stage_timer("token_optimization"),
...
async def test_token_optimization_quick_validation(logger: logging.Logger) -> None:
    ...
    with create_performance_context(
        ...
        validation_sections = ["Validation Scenarios", "Key Insights", "Validation Results"]
