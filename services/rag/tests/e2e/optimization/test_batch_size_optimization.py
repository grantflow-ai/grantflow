...
async def test_batch_size_performance(logger: logging.Logger) -> None:
    ...
    with create_performance_context(
        ...
        expected_patterns=[
            "objective", "research", "task", "methodology", "enrichment"
        ]
    ) as perf_ctx:
            ...
            with perf_ctx.stage_timer(f"batch_size_{batch_size}"), \
                 ...
                 patch("services.rag.src.grant_application.batch_enrich_objectives.with_prompt_evaluation") as mock_eval:
                    ...
                    logger.info(
                        ...
                        batch_size, total_llm_calls, batch_results[batch_size]["efficiency"]
                    )
        ...
        section_analysis = [
            "Test Configuration", "Results Summary",
...
async def test_batch_size_2_specifically(logger: logging.Logger) -> None:
    ...
    with create_performance_context(
        ...
        expected_patterns=[
            "objective", "research", "task", "enrichment"
        ]
    ) as perf_ctx:
        ...
        batch_sections = [
            "Test Configuration", "Results", "Validation Summary"
        ]
...
async def test_batch_size_3_specific(logger: logging.Logger) -> None:
    ...
    with create_performance_context(
        ...
        baseline_test_name="baseline_full_application_generation",
        expected_patterns=[
            "melanoma", "immunotherapy", "resistance", "biomarkers",
            "objective", "research", "task", "methodology"
        ]
    ) as perf_ctx:
        ...
        detailed_sections = [
            "Research Context", "Batch Processing Results", "Quality Validation",
            "Performance Analysis", "Optimization Impact"
        ]
