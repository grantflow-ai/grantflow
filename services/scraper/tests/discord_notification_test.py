...
class TestDiscordNotifications:
    """Test suite for Discord notification functionality."""

    def test_create_scraper_report_embed_success(self) -> None:
    ...
    def test_create_scraper_report_embed_failure(self) -> None:
    ...
    def test_create_scraper_report_embed_time_formatting(self) -> None:
    ...
    async def test_send_discord_webhook_success(self, mock_client_class: Mock) -> None:
    ...
    @patch("packages.shared_utils.src.discord.httpx.AsyncClient")
    async def test_send_discord_webhook_failure(self, mock_client_class: Mock) -> None:
    ...
    @patch("packages.shared_utils.src.discord.httpx.AsyncClient")
    async def test_send_discord_webhook_exception(self, mock_client_class: Mock) -> None:
    ...
    async def test_send_discord_webhook_empty_url(self) -> None:
    ...
    async def test_send_scraper_report(self, mock_send_webhook: AsyncMock) -> None:
...
class TestScraperMainIntegration:
    """Integration tests for scraper main functionality with Discord notifications."""
