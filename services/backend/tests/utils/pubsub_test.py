...
def test_get_pubsub_client_creates_singleton(mock_publisher: MagicMock, reset_client_ref: None) -> None:
...
def test_get_pubsub_client_uses_env_vars(mock_publisher: MagicMock, reset_client_ref: None) -> None:
...
@pytest.mark.asyncio
async def test_publish_url_crawling_task_success(mock_publisher: MagicMock, reset_client_ref: None) -> None:
    future = MagicMock()
...
@pytest.mark.asyncio
async def test_publish_url_crawling_task_with_workspace_id(mock_publisher: MagicMock, reset_client_ref: None) -> None:
    future = MagicMock()
...
@pytest.mark.asyncio
async def test_publish_url_crawling_task_with_string_ids(mock_publisher: MagicMock, reset_client_ref: None) -> None:
    future = MagicMock()
...
@pytest.mark.asyncio
async def test_publish_url_crawling_task_message_too_large(mock_publisher: MagicMock, reset_client_ref: None) -> None:
...
@pytest.mark.asyncio
async def test_publish_url_crawling_task_generic_exception(mock_publisher: MagicMock, reset_client_ref: None) -> None:
...
@pytest.mark.asyncio
async def test_publish_url_crawling_task_run_sync_failure(mock_publisher: MagicMock, reset_client_ref: None) -> None:
    future = MagicMock()
    mock_publisher.publish.return_value = future
...
@pytest.mark.asyncio
async def test_publish_url_crawling_task_with_env_topic(mock_publisher: MagicMock, reset_client_ref: None) -> None:
    future = MagicMock()
