...
This ERC Proof of Concept project aims to revolutionize ultra-long DNA synthesis by exploiting C. elegans' natural DNA concatemerization process. Our innovation lies in harnessing the worm's ability to form extrachromosomal arrays (ECAs) from injected DNA, creating a cost-effective "cloning machine" for synthesizing and amplifying error-free DNA sequences up to 1-3 Mb long. The project objectives include deciphering the rules of ECA formation, understanding the role of DNA repair mechanisms, and establishing a one-stop-shop system for in-vermis long DNA synthesis. Our methodology involves long-read sequencing, CRISPR-Cas9, and AI-driven design to optimize ECA formation and capture. Expected outcomes include a validated platform for ultra-long DNA synthesis at a cost of <$0.01/bp, significantly lower than current methods. The project's impact will be transformative, enabling rapid and affordable construction of entire genomes and synthetic pathways. Commercial viability is high, targeting the $1.2M/genome synthetic biology market with applications in synthetic biology, genomics, gene therapy, and DNA-based data storage. This project addresses a critical bottleneck in biotechnology, offering a scalable solution for generating ultra-long DNA sequences and accelerating innovation in diverse fields.
...
Compared to competing products, such as traditional chemical synthesis and enzymatic assembly methods, our technology offers a distinct competitive advantage in terms of cost, speed, and sequence length. While chemical synthesis struggles with sequences longer than 200 bp, and assembly methods require high-quality short fragments, our in-vermis approach can generate megabase-scale DNA sequences in a single step. This breakthrough addresses an unmet need in synthetic biology, genomics, gene therapy, and bioengineering, where the demand for long, accurate DNA sequences is rapidly growing. The potential market size for synthetic biology is estimated at $1.2M/genome **[MISSING INFORMATION: More granular Market size data]**, with applications ranging from drug discovery to biofuels. Our technology's scalability and cost-effectiveness position it for rapid commercialization, with a strategy focused on IP protection, strategic partnerships, and compliance with**[MISSING INFORMATION: FDA/regulatory pathway]** for genome-scale applications. The commercialization strategy will involve securing patents on novel technical features, establishing partnerships with biotechnology companies for pilot studies, and adhering to regulatory pathways for genome-scale applications. Further details on the commercialization strategy and regulatory pathway are described in Objective 4.
...
The proposed PoC project will explore the commercial potential of our ERC-funded research by addressing the DNA synthesis bottleneck in synthetic biology. A preliminary market analysis indicates a substantial market opportunity, with the synthetic biology sector projected for significant growth. Our innovation pathway focuses on patenting and strategic licensing agreements to maximize technology transfer. This approach is optimal due to the broad applicability of our technology across multiple sectors, including synthetic biology, genomics, and personalized medicine. Our in-vermis DNA synthesis represents a paradigm shift, offering a cost-effective and scalable alternative to existing chemical and enzymatic methods. Key competitive advantages include reduced synthesis costs, increased DNA length capabilities (1-3 Mb), and a simplified single-step process.
...
We will systematically characterize ECA formation mechanisms through long-read sequencing analysis, progressing from single-sequence arrays to complex 43-plasmid configurations. Leveraging NHEJ-deficient mutants and homology-directed repair pathways, we will establish optimal sequence parameters for megabase-scale in-vermis DNA synthesis, addressing current cost and length limitations of chemical synthesis methods.

#### 1.1: Identify optimal homology length for ECA formation

DNA constructs with **[MISSING INFORMATION: specific bp range]** overlaps will be microinjected (100 ng/μL) into lig-4 NHEJ-deficient C. elegans at 20°C using automated injection systems at**[MISSING INFORMATION: specific injection pressure]**. Array formation analysis employs PacBio HiFi sequencing and PFGE (1% agarose, 6V/cm, 16h) with size-fractionation.

#### 1.2: Sequence the successful recombination products

PacBio HiFi and Oxford Nanopore sequencing will characterize ECAs from single-sequence to 43-plasmid configurations, with specialized focus on junction regions and concatenation patterns. De novo assembly algorithms optimized for repetitive sequences will map array architecture, while NHEJ-deficient mutant analysis will validate formation mechanisms and structural stability.

#### 1.3: Increase the number of homologous subunits with the optimal overlap length

Building on NHEJ-deficient mutant studies, we will systematically scale array complexity from single-sequence to 43-plasmid configurations using homology-directed repair pathways. Long-read sequencing will characterize array size distribution and composition stability. Automated microinjection protocols will optimize multi-fragment delivery efficiency. Results will inform Task 3.3's capture protocols.

### Objective 2: Understand the role of DNA repair mechanisms in ECA formation

We will elucidate DNA repair pathway contributions to ECA formation through systematic mutation studies in C. elegans, leveraging preliminary NHEJ-deficient mutant data to optimize homology-directed repair protocols. PacBio HiFi sequencing analysis will inform megabase-scale array assembly parameters, establishing foundations for automated array synthesis in Objective 3.
...
Using NHEJ-deficient mutants, we will screen DNA repair pathways through CRISPR-Cas9 disruption of lig-4 and **[MISSING INFORMATION: additional repair genes]**. Selection with**[MISSING INFORMATION: specific selection markers]** will identify array architectures. Validation uses PacBio HiFi sequencing at**[MISSING INFORMATION: specific coverage depth]** for junction characterization.

#### 2.3: Create arrays with only desired connections from homology-directed repair

Using optimized homology regions (200-400bp) from Task 1.1 and NHEJ-deficient lig-4 backgrounds from Task 2, we will conduct template-directed array assembly at **[MISSING INFORMATION: specific DNA concentration]** and 20°C. Arrays undergo validation via PacBio HiFi, PFGE (6V/cm, 16h), and structural mapping through Nanopore sequencing.

### Objective 3: Establish a one-stop-shop system for in-vermis long DNA synthesis

We will develop an integrated system for ultra-long DNA synthesis utilizing C. elegans' ECA formation, combining AI-driven design, automated gonad microinjection at **[MISSING INFORMATION: specific injection pressure]**, and homology-directed repair with 200-400bp overlaps in lig-4 NHEJ-deficient mutants to generate 1-3Mb constructs at sub-$0.10/bp.

#### 3.1: Develop software for injection mix prediction

An ML pipeline utilizing XGBoost and random forest models will predict DNA injection parameters from molecular features (homology overlap, NHEJ status, carrier DNA ratios, fragment distributions). System validation uses PacBio-sequenced arrays at **[MISSING INFORMATION: specific coverage depth]** for parameter export to controllers at**[MISSING INFORMATION: specific injection pressure]**.

#### 3.2: Usage of robotic injection system (outsource)

Automated microinjection system will be calibrated to **[MISSING INFORMATION: specific injection pressure]** using prediction software's real-time parameter optimization. Daily maintenance includes capillary cleaning, pressure system calibration, and microscope alignment. System achieves**[MISSING INFORMATION: specific throughput rate]** injections/hour with >95% viability, incorporating automated tracking and fluorescence-based quality monitoring.

#### 3.3: Develop ability to capture array

Missing Information:

- Specific extraction protocol details for isolating ECAs from C. elegans
- DNA purification methods and parameters for maintaining array integrity
- Technical specifications for separating ECAs from genomic DNA
- Quality control metrics and thresholds for array purity assessment
- Concrete methodology for preventing DNA shearing during extraction

#### 3.4: Proof of concept of prediction software + array capture and sequencing

Integration validation employs PacBio HiFi (30x coverage) and Nanopore sequencing for array fidelity verification, with PFGE confirming 1-3Mb distribution. Quality metrics assess prediction accuracy (>95%), injection success at **[MISSING INFORMATION: specific injection pressure]**, array stability across 10 generations, and cost efficiency (<$0.10/bp).

### Objective 4: Commercialization and path to market plan

Our commercialization strategy targets the $1.2M/genome synthetic biology market through in-vermis DNA synthesis, delivering 1-2 Mb sequences at <$0.01/bp versus current $0.10/bp methods. Strategic execution encompasses IP protection, biotech partnerships, and **[MISSING INFORMATION: FDA/regulatory pathway]** compliance for genome-scale applications.

#### 4.1: Intellectual Property and Legal Framework

Missing Information:

- Specific details about existing patents in DNA synthesis technology that could affect freedom to operate
- Current regulatory requirements for using C. elegans in DNA synthesis applications
- Specific novel technical features that differentiate this technology from existing DNA synthesis methods for patent claims
- Existing IP agreements or restrictions that might affect commercialization
- Current legal framework for biological manufacturing processes using C. elegans

#### 4.2: Strategic Partnerships and Pilot Studies

Missing Information:

- Specific criteria for evaluating potential industry partners
- Concrete IP protection requirements and constraints
- Detailed metrics for measuring pilot study success
- Specific parameters for pilot study design
- Required partnership agreement terms and conditions
- Target timeline for partnership development and pilot studies
- Specific technical validation requirements for pilot studies
...
Objective 4, led by the Commercialization Manager, will require 2 person-months from a Legal Consultant for IP protection and strategic partnership development. This objective will require access to legal databases and consulting services. The expected duration is 6 months.
