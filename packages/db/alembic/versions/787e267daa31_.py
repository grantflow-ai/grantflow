...
def upgrade() -> None:
    ...
    op.create_table('funding_organizations',
    ...
    op.create_index(op.f('ix_funding_organizations_abbreviation'), 'funding_organizations', ['abbreviation'], unique=False)
    ...
    op.create_table('funding_organization_rag_sources',
    ...
    op.create_index(op.f('ix_funding_organization_rag_sources_created_at'), 'funding_organization_rag_sources', ['created_at'], unique=False)
    ...
    sa.Column('status', sa.Enum('DRAFT', 'IN_PROGRESS', 'COMPLETED', 'CANCELLED', name='applicationstatusenum'), nullable=False),
    ...
    op.create_table('user_workspace_invitations',
    sa.Column('workspace_id', sa.UUID(), nullable=False),
    ...
    op.create_index(op.f('ix_user_workspace_invitations_created_at'), 'user_workspace_invitations', ['created_at'], unique=False)
    op.create_index(op.f('ix_user_workspace_invitations_email'), 'user_workspace_invitations', ['email'], unique=False)
    op.create_index(op.f('ix_user_workspace_invitations_workspace_id'), 'user_workspace_invitations', ['workspace_id'], unique=False)
    ...
    op.create_table('grant_application_rag_sources',
    ...
    op.create_index(op.f('ix_grant_application_rag_sources_created_at'), 'grant_application_rag_sources', ['created_at'], unique=False)
    ...
    op.create_table('grant_template_rag_sources',
    sa.Column('rag_source_id', sa.UUID(), nullable=False),
    ...
    op.create_index(op.f('ix_grant_template_rag_sources_created_at'), 'grant_template_rag_sources', ['created_at'], unique=False)
