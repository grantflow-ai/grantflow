...
def test_validate_scientific_analysis_with_valid_result(
    valid_analysis_result: ScientificAnalysisResult,
) -> None:
...
def test_validate_scientific_analysis_raises_error_for_invalid_objective_reference(
    ...
    with pytest.raises(ValidationError, match="supports non-existent objective 999"):
        validate_scientific_analysis(invalid_result)


def test_validate_scientific_analysis_with_empty_lists() -> None:
...
def test_aggregate_analyses_with_empty_list() -> None:
...
def test_aggregate_analyses_updates_task_dependencies() -> None:
...
def test_serialize_none_returns_null_bytes() -> None:
...
def test_serialize_empty_analysis_returns_valid_json() -> None:
