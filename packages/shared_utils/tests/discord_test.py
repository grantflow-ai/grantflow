...
class TestDiscordUtilities:
    ...
    def test_create_scraper_report_embed_required_fields(self) -> None:
    ...
    def test_create_scraper_report_embed_with_optional_fields(self) -> None:
    ...
    def test_create_scraper_report_embed_large_numbers(self) -> None:
    ...
    @patch("packages.shared_utils.src.discord.httpx.AsyncClient")
    async def test_send_discord_webhook_network_error(
        self, mock_client_class: Mock
    ) -> None:
    ...
    async def test_send_scraper_report_success(
        self, mock_send_webhook: AsyncMock
    ) -> None:
    ...
    @patch("packages.shared_utils.src.discord.send_discord_webhook")
    async def test_send_scraper_report_failure(
        self, mock_send_webhook: AsyncMock
    ) -> None:
        ...
        status_field = next(
            field for field in embed["fields"] if "Status" in field["name"]
        )
    ...
    def test_create_scraper_report_embed_zero_values(self) -> None:
    ...
    def test_create_scraper_report_embed_without_total_files(self) -> None:
