...
export const Toolbar = React.forwardRef(({ children, className, variant = "fixed", ...props }, ref) => {
    ...
    if (!isVisible)
        return null;
    return (_jsx("div", { ref: mergeRefs([toolbarRef, ref]), role: "toolbar", "aria-label": "toolbar", "data-variant": variant, className: cn("tiptap-toolbar", className), ...props, children: children }));
});
...
export const ToolbarGroup = React.forwardRef(({ children, className, ...props }, ref) => {
    ...
    if (!isVisible)
        return null;
    return (_jsx("div", { ref: mergeRefs([groupRef, ref]), role: "group", className: cn("tiptap-toolbar-group", className), ...props, children: children }));
});
