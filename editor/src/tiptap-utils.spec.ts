...
describe("tiptap-utils", () => {
	...
	describe("convertFileToBase64", () => {
		...
		// Note: FileReader-based tests skipped due to complex mocking requirements
		// These would be better tested in integration tests with real browser environment
	});
