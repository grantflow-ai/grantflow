...
import type { UseColorHighlightConfig } from "@/components/ui/color-highlight-button";
import { COLOR_HIGHLIGHT_SHORTCUT_KEY, useColorHighlight } from "@/components/ui/color-highlight-button";
