<!--
meta-description: NIH Funding Opportunities and Notices in the NIH Guide for Grants and Contracts: Secondary Analysis of Existing Datasets in Heart, Lung, and Blood Diseases and Sleep Disorders (R21 Clinical Trial Not Allowed) PAR-25-056. NHLBI
meta-keywords: PAR-25-056: Secondary Analysis of Existing Datasets in Heart, Lung, and Blood Diseases and Sleep Disorders (R21 Clinical Trial Not Allowed)
meta-viewport: width=device-width, initial-scale=1.0
title: PAR-25-056: Secondary Analysis of Existing Datasets in Heart, Lung, and Blood Diseases and Sleep Disorders (R21 Clinical Trial Not Allowed)
-->
...
Funding Opportunity Title Secondary Analysis of Existing Datasets in Heart, Lung, and Blood Diseases and Sleep Disorders (R21 Clinical Trial Not Allowed)Activity Code [R21](//grants.nih.gov/grants/funding/ac_search_results.htm?text_curr=r21&Search.x=0&Search.y=0&Search_Type=Activity) Exploratory/Developmental Research Grant

Announcement Type Reissue of [PAR-23-036](https://grants.nih.gov/grants/guide/pa-files/PAR-23-036.html)\
...
Funding Opportunity Number (FON) PAR-25-056Companion Funding Opportunity None Number of Applications See [Section III. 3. Additional Information on Eligibility](#_3._Additional_Information).

Assistance Listing Number(s) 93.837, 93.839, 93.838, 93.233, 93.840 Funding Opportunity Purpose This Notice of Funding Opportunity (NOFO) encourages R21 applications that propose to conduct secondary analyses using existing human datasets in areas relevant to the National Heart, Lung, Blood Diseases and Sleep Disorders Institute (NHLBI) scientific mission. The NOFO aims to stimulate the use of existing human datasets to investigate novel scientific ideas, and/or generate new models, systems, tools, or technologies that have the potential for significant impact on biomedical or biobehavioral research. Generation of new primary data is not allowed.

## Key Dates

Posted Date December 30, 2024 Open Date (Earliest Submission Date) January 28, 2025 Letter of Intent Due Date(s) Not Applicable
...
| February 28, 2025 | February 28, 2025 | May 07, 2025 * | July 2025 | October 2025 | December 2025 |
| October 28, 2025 | October 28, 2025 | January 07, 2026 * | March 2026 | May 2026 | July 2026 |
...
1. Use [Grants.gov](https://grants.gov/search-grants?oppStatuses=closed%7Carchived%7Cposted%7Cforecasted&fon=PAR-25-056) Workspace to prepare and submit your application and [eRA Commons](http://public.era.nih.gov/commons/) to track your application.
...
The primary objective of this Notice of Funding Opportunity (NOFO)FOA) is to invite R21 applications that use existing dataset(s) for secondary analysis in areas relevant to the NHLBI scientific mission.

NHLBI and other funding sources often produce data with utility beyond the hypotheses and questions the original projects were designed to address. However, the data cannot be exploited due to a lack of support. This NOFO provides the support to stimulate the use of existing dataset(s) for secondary analysis.

**Background**

Secondary analysis of existing datasets offers a cost-effective way to foster research within NHLBIs scientific mission. Analyzing existing data provides a relatively rapid means to answer important questions and generate needed tools, technology, and methodologies. Additionally, it enables development of new research directions, especially for researchers early in their careers and/or at resource-limited institutions.

**Research Scope**

The full range of secondary analysis approaches and methodologies using existing human datasets will be considered, as long as the objectives are relevant to the NHLBIs programs and priorities as described in the [NHLBI Strategic Vision - Strategic Goals and Objectives](https://www.nhlbi.nih.gov/about/strategic-vision).

Proposed analyses may investigate novel scientific ideas; generate new models, systems, tools, methods, or technologies that have the potential for significant impact on biomedical or biobehavioral research.

Meta-analyses using patient level data from the original studies are encouraged.

This NOFO also supports the merging of datasets from various sources to better address important research questions.

For projects using data from a parent research project, the proposed project may be related to but must be distinct from the specific aims of the original research project.

Areas for possible secondary analyses include, but are not limited to:

- Disease etiology, detection, diagnosis, treatment, progression, exacerbation, endophenotypes, risk, prevention, and survivorship
- Questions related to important social determinants of health (SDOH) and/or generating related novel methods/tools/technology
- Preliminary exploration of potential epidemiological relationships
- Questions related to important health disparities questions and/or generating related novel methods/tools/technology
- Development and/or validation of prevention strategies
- Questions related to behavioral health and/or generating related novel methods/tools/technology
- Risk stratification
- Development and/or validation of screening algorithms
- Implementation and translation of research findings into practice
- Determination of factors that support implementation of evidence-based interventions
- Development and validation of new statistical methodologies or computational modeling
- Methods/tools/technology to improve imaging in CT, MRI and other imaging methodologies
- Application of geospatial or other novel technologies
- Identification of novel biomedical and environmental risk factors
- Effects of environmental factors
- Questions related to genomic research and/or generating novel methods/tools/technology

**Data Sources**

Applicants are encouraged to collaborate with investigators holding publicly as well as non-publicly available datasets, using innovative statistical strategies to link methodologically suitable datasets.

Datasets can be from a variety of sources, including, but not limited to:

- [NHLBI BioData Catalyst](https://biodatacatalyst.nhlbi.nih.gov/) (BDC):
  - The NHLBI BioData Catalyst welcomes all researchers. This new resource is a powerful, cloud-based infrastructure where researchers can go to find, search, access, share, cross-link, and compute on large (or small) scale datasets. It provides tools, applications, and workflows to enable those capabilities in secure workspaces. Additionally, BDC allows researchers to bring their own dataset(s) and workflows into the ecosystem.
- [NHLBI Biologic Specimen and Data Repository (BioLINCC)](https://biolincc.nhlbi.nih.gov/home/);

Note: Some of the datasets may have been transferred to BDC

- [Database of Genotypes and Phenotypes (dbGaP)](https://www.ncbi.nlm.nih.gov/gap);
- [Other NIH Data Sharing Resources](https://www.nlm.nih.gov/NIHbmic/nih_data_sharing_repositories.html)

Non-NIH sources of datasets, including, but not limited to:
...
- Use existing human dataset(s)
- Have a project within the NHLBI scientific mission
- Include the Dataset(s) description attachment, see NOFOSection IV, Other attachments for details. Applications lacking the Dataset(s) attachment will be deemed incomplete and will not be reviewed

Proposed projects must not:

- Include the generation of new primary data. This NOFO will not support the collection of new data. This includes, but is not limited to: biospecimen analysis, additional data collected from participants, etc.
- Propose application budgets that exceed the direct costs outlined in Section II.

Applications which are incomplete or not responsive to this NOFO will not be reviewed.
...
The NHLBI intends to commit up to $2,187,000 per year in total costs for new awards in Fiscal Year2026.

NHLBI may fund up to eighteen new awards per year in Fiscal Year2026.

Award Budget Application budgets may request up to $75,000 in direct costs per year. Investigators are encouraged to request what is well-justified for their proposed research.

**Applications exceeding this amount will not be reviewed**.
...
1. Provide dataset description(s) for the reviewers that include the full dataset title and acronym, the purpose and primary aims of the parent study or project for which the data were originally collected, who collected the data, dates of the collection, the proposed project's relevant variables, quantity of missing data, and any other pertinent information needed to assess the adequacy of a dataset for the proposed project. When possible, keep the description to 1-2 pages for each dataset. When using multiple datasets place the dataset title or acronym on each page. Information may be provided in a table format. Use the filename "Data Sets.pdf" for this attachment. **Applications lacking the Data Sets attachment will be deemed incomplete and will not be reviewed.**
1. Provide a description of any relevant policies governing the proposed data sets and how the project will comply. Applicants are responsible for adhering to any policies governing access to and disposition of study data sets. The filename "Relevant Policies.pdf" should be used for this attachment and may not exceed 3 pages.
...
1. Describe the focus of the proposed secondary analyses to investigate novel scientific ideas or new models, systems, tools, methods, or technologies.
1. Clearly outline the suitability of the proposed dataset(s) chosen to fulfill the research aims. If applicable, include a description of any preliminary data provided.
1. Include a timeline that has the important milestones that may include, but are not limited to: data procurement, data processing, data analysis, manuscript(s) preparation and submission to peer review journals.
...
Upon receipt, applications will be evaluated for completeness and compliance with application instructions by the Center for Scientific Review, and responsiveness by the NHLBI, NIH. Applications that are incomplete or non-compliant will not be reviewed.
...
Send written disclosures to the NIH Chief Grants Management Officer listed on the Notice of Award for the IC that funded the award and to the[HHS Office of Inspector Grant Self Disclosure Program](https://oig.hhs.gov/compliance/self-disclosure-info/hhs-oig-grant-self-disclosure-program/) at\[[email protected]\](/cdn-cgi/l/email-protection#e68194878892828f95858a899593948395a6898f81c88e8e95c8818990).
...
- Evaluate the likelihood that the proposed data sets are suitable and sufficient to fulfill the research aims specifically related to heart, lung, blood and/or sleep.
...
Email:\[[email protected]\](/cdn-cgi/l/email-protection#b7c4c2c7c7d8c5c3f7d0c5d6d9c3c499d0d8c1)

Scientific/Research Contact(s) Ruth Kirby, RN, BS\
National Heart, Lung, and Blood Institute, (NHLBI)\
Telephone: 301-435-0401\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#8de6e4ffeff4ffcde3e4e5a3eae2fb)
...
Financial/Grants Management Contact(s) Leslye Fulwider\
National Heart, Lung, and Blood Institute (NHLBI)\
Telephone: 301-480-9544\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#d4b8b1a7b8adb1fab2a1b8a3bdb0b1a694babdbcfab3bba2)
