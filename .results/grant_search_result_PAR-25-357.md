<!--
meta-description: NIH Funding Opportunities and Notices in the NIH Guide for Grants and Contracts: NEI Research Grant for Vision-Related Secondary Data Analysis (R21 Clinical Trial Not Allowed) PAR-25-357. NEI
meta-keywords: PAR-25-357: NEI Research Grant for Vision-Related Secondary Data Analysis (R21 Clinical Trial Not Allowed)
meta-viewport: width=device-width, initial-scale=1.0
title: PAR-25-357: NEI Research Grant for Vision-Related Secondary Data Analysis (R21 Clinical Trial Not Allowed)
-->
...
Funding Opportunity Title NEI Research Grant for Vision-Related Secondary Data Analysis (R21 Clinical Trial Not Allowed)Activity Code [R21](//grants.nih.gov/grants/funding/ac_search_results.htm?text_curr=r21&Search.x=0&Search.y=0&Search_Type=Activity) Exploratory/Developmental Research Grant

Announcement Type Reissue of [PAR-22-141](https://grants.nih.gov/grants/guide/pa-files/PAR-22-141.html)\
Related NoticesSee [Notices of Special Interest](https://grants.nih.gov/grants/guide/NOSIs_targetingList.cfm?GuideDocID=42234) associated with this funding opportunity
...
Posted Date January 02, 2025 Open Date (Earliest Submission Date) January 16, 2025 Letter of Intent Due Date(s) Not Applicable
...
Expiration Date October 17, 2027 Due Dates for E.O. 12372 Not Applicable
...
1. Use [Grants.gov](https://grants.gov/search-grants?oppStatuses=closed%7Carchived%7Cposted%7Cforecasted&fon=PAR-25-357) Workspace to prepare and submit your application and [eRA Commons](http://public.era.nih.gov/commons/) to track your application.
...
The goal of this Notice of Funding Opportunity (NOFO) reissuance is to stimulate secondary analyses of data collected from humans to investigate new scientific ideas, models, systems, tools, or methods that have the potential for significant impact in areas relevant to the NEI mission. Applications may be related to, but must be distinct from, the specific aims of the original data collection. This NOFO will not support the collection of new data, nor analyses of animal data.

**Rationale**

The NEI supports an extensive portfolio of clinical trials and large-scale epidemiologic research projects wherein numerous data collection activities are required to meet each project's specific aims. The resultant wealth of data generated by these studies often provides unique, cost-effective opportunities to investigate additional research questions or develop new analytical approaches secondary to a project's originally intended purpose.

This NOFO reissuance provides an opportunity to leverage existing vision-related clinical and health care research data currently available in analyzable format to further the NEI mission. Data are not limited to those collected under NEI support, but these data sets are of the highest programmatic interest. Data may also be derived from databases such as but not limited to EHR, administrative claims data, surveys, registry data, and patient-reported data from personal devices. This NOFO also supports systematic reviews and meta-analyses using patient-level data from original studies that have been merged into a single data set to better address important research questions. The development of statistical methodology necessary for improving methods to analyze vision health data using existing vision data may also be proposed. Applicants should consider the relevance of their proposed analyses to NEI programs and priorities as described in the [NEI Strategic Plan: Vision for the Future](https://www.nei.nih.gov/about/strategic-planning).

**Objectives and Scope**

A typical project supported under this NOFO is expected to make substantial progress towards having at least one vision-related manuscript submitted to a peer-reviewed journal within the first year.

Examples of secondary analyses projects include, but are not limited to:

- exploration of associations between risk factors and vision health outcomes
...
To facilitate the exchange of health care information electronically the NEI encourages integration of FHIR (Fast Healthcare Interoperability Resources) ([https://hl7.org/fhir/us/cdmh/](https://hl7.org/fhir/us/cdmh/ "Link to Non-U.S. Government Site")), OMOP ([https://www.ohdsi.org/data-standardization/](https://www.ohdsi.org/data-standardization/ "Link to Non-U.S. Government Site")) common data models, FAIR (Findability, Accessibility, Interoperability, Reuse) principles ([https://www.go-fair.org/fair-principles/](https://www.go-fair.org/fair-principles/ "Link to Non-U.S. Government Site")) for all healthcare data, and DICOM (Digital Imaging and Communications in Medicine) standards ([https://www.dicomstandard.org/](https://www.dicomstandard.org/ "Link to Non-U.S. Government Site")) for all imaging data.

**Applications Not Responsive to this NOFO**

The following types of applications will be considered non-responsive to this NOFO and will not be reviewed and will be withdrawn:

- Studies that propose to collect or generate new data, e.g., grading images, running lab assays
- Studies that propose to analyze data obtained from non-human samples or animal studies
- Studies that propose to carry out or complete currently ongoing data analysis or to maintain and distribute data sets.
- Studies that propose analyses of data sets that are currently not available in analyzable format
...
Award Budget The NEI permits direct costs up to $275,000 for the entire two-year project period, plus applicable F&A for consortia. No more than $200,000 in direct costs may be requested in any single year.
...
1. Explain how the proposed secondary analyses provide important insight into vision health problems.
1. Provide details of the existing data (data sets or databases) and describe how these data will be utilized to address the project's specific aims and NEIs mission. Explain how the data are of sufficient quality to address the specific aims of the study and currently exist in analyzable format (i.e., structured and reasonably cleaned). Include plans to control or account for potential biases and deficiencies in data (e.g., missing, inconsistent or implausible data; misclassification and information bias; selection bias; potential confounding).
1. As applicable, demonstrate how the proposed new methodologies may improve future analyses of vision-related research data and provide evidence that the new approaches are needed.
1. Describe specific milestones and timelines for data analysis, manuscript(s) preparation and submission to peer-reviewed journals. These milestones must include at least two manuscript submissions: one submitted for peer review prior to submission of the Research Performance Progress Report (RPPR) and one manuscript submitted prior to the submission of the Final Progress Report.
...
Upon receipt, applications will be evaluated for completeness and compliance with application instructions by the Center for Scientific Review and responsiveness by NEI, NIH. Applications that are incomplete or non-compliant will not be reviewed.
...
Send written disclosures to the NIH Chief Grants Management Officer listed on the Notice of Award for the IC that funded the award and to the[HHS Office of Inspector Grant Self Disclosure Program](https://oig.hhs.gov/compliance/self-disclosure-info/hhs-oig-grant-self-disclosure-program/) at\[[email protected]\](/cdn-cgi/l/email-protection#baddc8dbd4ceded3c9d9d6d5c9cfc8dfc9fad5d3dd94d2d2c994ddd5cc).
...
- Assess whether data are of sufficient quality and in analyzable format to address the specific aims of the study and how well the research plan include plans to control or account for potential biases and deficiencies (e.g., missing, inconsistent or implausible data; misclassification and information bias; selection bias; potential confounding).
...
Email:\[[email protected]\](/cdn-cgi/l/email-protection#5e192c3f302a2d173038311e30373670393128)(preferred method of contact)\
...
Email: \[[email protected]\](/cdn-cgi/l/email-protection#412437243324353525012c20282d6f2f28296f262e37)

Jimmy Le, ScD\
National Eye Institute(NEI)\
Telephone:301-435-8160\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#a1cbc8ccccd88fcdc4e1cfc8c98fc6ced7)

Azadeh Shoaibi, PhD, MHS\
National Eye Institute (NEI)\
Telephone: 301-443-7964\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#b3d2c9d2d7d6db9dc0dbdcd2dad1daf3dddadb9dd4dcc5)

Peer Review Contact(s) Brian Hoshaw, PhD\
National Eye Institute (NEI)\
Telephone: 301-402-0566\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#5230203b333c7c3a3d213a3325123c3b3a7c353d24)

Financial/Grants Management Contact(s) Karen Robinson Smith\
National Eye Institute (NEI)\
Telephone 301-435-8178\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#cf84aebdaaa1e19da0ada6a1bca0a1e19ca2a6bba78fa1aaa6e1a1a6a7e1a8a0b9)
