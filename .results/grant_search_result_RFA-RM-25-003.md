<!--
meta-description: NIH Funding Opportunities and Notices in the NIH Guide for Grants and Contracts: NIH Directors Transformative Research Awards (R01 Clinical Trial Optional) RFA-RM-25-003. NIH
meta-keywords: RFA-RM-25-003: NIH Directors Transformative Research Awards (R01 Clinical Trial Optional)
meta-viewport: width=device-width, initial-scale=1.0
title: RFA-RM-25-003: NIH Directors Transformative Research Awards (R01 Clinical Trial Optional)
-->
...
This Notice of Funding Opportunity (NOFO) is developed as a [Common Fund](https://commonfund.nih.gov/) initiative through the Office of the NIH Director, Office of Strategic Coordination. All NIH Institutes and Centers participate in Common Fund initiatives.

Funding Opportunity Title NIH Directors Transformative Research Awards (R01 Clinical Trial Optional)Activity Code [R01](//grants.nih.gov/grants/funding/ac_search_results.htm?text_curr=r01&Search.x=0&Search.y=0&Search_Type=Activity) Research Project Grant

Announcement Type Reissue of [RFA-RM-24-004](https://grants.nih.gov/grants/guide/rfa-files/RFA-RM-24-004.html)\
...
Posted Date June 16, 2025 Open Date (Earliest Submission Date) August 03, 2025 Letter of Intent Due Date(s) Not Applicable

| Application Due Dates | | | Review and Award Cycles | | |
| --- | --- | --- | --- | --- | --- |
| New | Renewal / Resubmission / Revision (as allowed) | AIDS - New/Renewal/Resubmission/Revision, as allowed | Scientific Merit Review | Advisory Council Review | Earliest Start Date |
| September 03, 2025 | Not Applicable | September 03, 2025 | March 2026 | May 2026 | July 2026 |
...
Expiration Date September 04, 2025 Due Dates for E.O. 12372 Not Applicable
...
1. Use [Grants.gov](https://grants.gov/search-grants?oppStatuses=closed%7Carchived%7Cposted%7Cforecasted&fon=RFA-RM-25-003) Workspace to prepare and submit your application and [eRA Commons](http://public.era.nih.gov/commons/) to track your application.
...
Prospective applicants are invited to view a pre-recorded, pre-application webinar on the [Transformative Research Award website](https://commonfund.nih.gov/TRA), where NIH staff discuss the initiative and answer common questions about the application and review process. Additional information and resources can be found on the website, and any questions can be sent to \[[email protected]\](/cdn-cgi/l/email-protection#edb99f8c839e8b829f808c99849b88b2ac9a8c9f899ead808c8481c3838485c38a829b).

The [NIH Director's Transformative Research Award](https://commonfund.nih.gov/TRA) is part of the [High-Risk, High-Reward Research program](https://commonfund.nih.gov/highrisk) funded through the [NIH Common Fund](https://commonfund.nih.gov/), which supports cross-cutting programs that are expected to have exceptionally high impact. All Common Fund initiatives invite investigators to develop bold, innovative, and often risky approaches to address problems that may seem intractable or to seize new opportunities that offer the potential for rapid progress.
...
Funds Available and Anticipated Number of Awards NIH intends to commit approximately $8 million in FY 2026 and make approximately 7 awards, depending on the size and scope of the most meritorious awards. The number of awards is contingent upon NIH appropriations and the submission of a sufficient number of meritorious applications.

Award Budget Application budgets are not limited but must be commensurate with the scope of the proposed research. Award Project Period The maximum project period is five years.
...
Upon receipt, applications will be evaluated for completeness and compliance with application instructions by the Center for Scientific Review, NIH. Applications that are incomplete or non-compliantwill not be reviewed.
...
Send written disclosures to the NIH Chief Grants Management Officer listed on the Notice of Award for the IC that funded the award and to the[HHS Office of Inspector Grant Self Disclosure Program](https://oig.hhs.gov/compliance/self-disclosure-info/hhs-oig-grant-self-disclosure-program/) at\[[email protected]\](/cdn-cgi/l/email-protection#f29580939c86969b81919e9d8187809781b29d9b95dc9a9a81dc959d84).
...
For this review, a three stage review process will be used. In the first stage, the peer review Editorial Panel, consisting of individuals with broad scientific expertise, will use the Specific Aims pages to identify a subset of applications with the most transformative potential. In the second stage, the applications identified as most highly transformative in phase 1 will be evaluated by "Mail Reviewers," who will provide feedback on the significance, innovation, and approach. The Mail Reviewers will be selected for their scientific expertise in the area of the application and will submit written comments but will not meet to discuss the applications. In the third stage, the peer review panel, informed by the Mail Reviews, will prioritize applications to be discussed and will discuss and score them in a panel meeting. All criteria will be assessed in the discussion by the panel. All other applications will be considered as "Not Discussed."
...
- Evaluate how clear and convincing the transformative potential of the proposed study is articulated.

- Evaluate the impacts and consequences of the proposed research on the field.

- Evaluate how fundamental the proposed or challenged paradigm is to the field.

- Evaluate how the application challenges and seeks to shift current research or clinical practice paradigms by utilizing novel theoretical concepts, approaches or instrumentation.

- Evaluate how the study is exceptionally innovative, and/or considered unconventional research with the potential to establish new scientific paradigms, establish entirely new and improved clinical approaches, or develop transformative technologies.
...
- Despite the lack of experimental details and substantial preliminary data, evaluate how compelling the logic and evidence of the approach is compared to standard approaches.

- Evaluate how strong the evidence is that the investigators will pursue the project (despite its inherent risks) in a robust, reproducible, and rigorous manner.

- Evaluate how the information in the timeline inspires confidence that the PD(s)/PI(s) will be able to assess progress each year of the award and either complete the project or demonstrate conclusively that it cannot be completed (despite good-faith efforts) during the term of the award.
...
Applications will undergo a selection in which only those applications deemed to have the highest scientific and technical merit will be discussed and assigned an overall impact score.

For "Discussed" applications, the summary statement will contain a resume and summary of discussion and the Mail Reviewer comments. For Not Discussed applications that progress to stage 2, the summary statement will contain the Mail Reviewer comments. For Not Discussed applications that do not progress to stage 2, the summary statement will contain a summary of the review process without evaluative comments.
...
Email: \[[email protected]\](/cdn-cgi/l/email-protection#3a6e485b54495c5548575b4e534c5f657b4d5b485e497a575b535614545352145d554c)

Peer Review Contact(s) Center for Scientific Review (CSR)\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#92dcddd4ddc0f7e4fbf7e5d1fdfce6f3f1e6d2f1e1e0bcfcfbfabcf5fde4)

Financial/Grants Management Contact(s) Office of Strategic Coordination\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#1743657679647178657a76637e617248566076657364577a767e7b39797e7f39707861)
