<!--
meta-description: NIH Funding Opportunities and Notices in the NIH Guide for Grants and Contracts: Targeting Cell Surface HIV Envelope for Cell Elimination (R01 Clinical Trial Not Allowed) PAR-25-300. NIAID
meta-keywords: PAR-25-300: Targeting Cell Surface HIV Envelope for Cell Elimination (R01 Clinical Trial Not Allowed)
meta-viewport: width=device-width, initial-scale=1.0
title: PAR-25-300: Targeting Cell Surface HIV Envelope for Cell Elimination (R01 Clinical Trial Not Allowed)
-->
...
Funding Opportunity Title Targeting Cell Surface HIV Envelope for Cell Elimination (R01 Clinical Trial Not Allowed)Activity Code [R01](//grants.nih.gov/grants/funding/ac_search_results.htm?text_curr=r01&Search.x=0&Search.y=0&Search_Type=Activity) Research Project Grant
...
Posted Date December 02, 2024 Open Date (Earliest Submission Date) April 07, 2025 Letter of Intent Due Date(s) Not Applicable
...
1. Use [Grants.gov](https://grants.gov/search-grants?oppStatuses=closed%7Carchived%7Cposted%7Cforecasted&fon=PAR-25-300) Workspace to prepare and submit your application and [eRA Commons](http://public.era.nih.gov/commons/) to track your application.
...
HIV-1 infected cells are not efficiently eliminated by host immune responses despite antiviral treatment that suppresses viral replication and spread. The HIV-1 envelope glycoprotein (Env) is the only viral protein expressed on the cell surface. HIV-1 has evolved ways to prevent Env-expressing cells from being recognized by Env-specific antibodies (Ab) and subsequent Ab-mediated immune clearance. Besides Env escape mutations and glycan shielding, HIV-1 encodes an internalization signal in the cytoplasmic domain of Env to mediate its rapid endocytosis, prevents the exposure of highly conserved, CD4 induced epitopes by downregulating CD4, and reduces the accumulation of surface Env by antagonizing host restriction factor BST-2/Tetherin, facilitating viral particle release. To overcome these evasion mechanisms and enhance immune recognition of Env-expressing cells, it is essential to gain a deeper understanding of cellular pathways and molecular determinants that control Env surface expression.

HIV-1 Env is a main target of current immunotherapy strategies for HIV cure. Env-targeting biologics, such as engineered antibodies/antibody-like molecules, T/natural killer (NK) cell engagers, and chimeric antigen receptor (CAR) T/NK cells, are examples of potential new therapeutics that eliminate HIV-infected cells. Efficient cell killing mediated by these biologics likely requires the formation of cytotoxic immune synapses between HIV-infected cells and cytotoxic immune cells. Activation of cytotoxic immune cells depends on the number of Env molecules available on the surface of infected cells as well as the design of the biologic. Elucidating the structural basis for biologic-mediated killing will facilitate the development of next-generation biologics that kill HIV-infected cells, particularly those expressing low-level surface Env.

Recent advances in technologies, such as live cell imaging and *in situ* structural determination of protein complexes, open new possibilities to investigate the viral-host interactions that impact Env surface expression, as well as the structural basis for biologic-mediated cell killing. This notice of funding opportunity (NOFO) aims to capture these opportunities with the goal to advance HIV-1 Env biology and enhance the elimination of Env-expressing, HIV-infected cells.

#### **Research Objectives**

The scientific objectives of this NOFO are to understand the regulation of Env cell surface expression, explore the structural mechanism of biologic-mediated cell killing , and develop novel approaches to enhance the recognition and elimination of HIV-infected cells with different levels of Env surface expression. This NOFO supports basic research on HIV-1 Env biology, and/or translational research that develops/optimizes biologics, including engineered antibodies/antibody-like molecules, T/NK cell engagers, and CAR design.

Specific areas of research that are within the scope of this NOFO include but are not limited to:
...
- Develop Env-specific reagents or technology to detect and/or isolate Env expressing, HIV-infected cells from clinical samples
...
- Investigation solely focused on transcriptional control of Env expression
...
\*\*Research Strategy:\*\*Provide a brief overview of the scientific problem being addressed and its potential to inform the goal of eliminating Env-expressing, HIV-infected cells with biologics *in vivo*.

- Discuss relevant information or data that support the approach, from preliminary results, scientific literature reports, or other inferential data that establish the potential for research success.
- Describe any complementary approaches used to test hypotheses.
- Describe any new or existing technologies used in novel ways to address the knowledge gap in Env biology, and/or the challenge of killing infected cells with low-level Env expression.
- Describe the physiological relevance of the experimental models proposed.
- Applications proposing investigation of viral-host interactions are encouraged to describe plans for validating research findings, using established primary cell models of HIV infection or existing biospecimens from observational cohorts or clinical trials.
- Describe plans to evaluate biologic-mediated cell killing at various levels of surface Env expression when applicable.

\*\*Letters of Support:**Provide letters of support from each collaborator named on the application describing their contribution to the proposed research**.\*\*If nonhuman primate (NHP) studies are proposed, please provide letters as documentation of source and availability of NHPs.
...
- Evaluate the likelihood that the project will increase the fundamental understanding of HIV-1 Env surface expression and dynamics, and/or advance the development of biologics capable of killing HIV-infected cells in vivo.
...
Email:\[[email protected]\](/cdn-cgi/l/email-protection#226550434c56516b4c444d624c4b4a0c454d54)(preferred method of contact)\
Telephone: 301-480-7075

Grants.gov Customer Support (Questions regarding Grants.gov registration and Workspace)\
Contact Center Telephone: 800-518-4726\
Email:\[[email protected]\](/cdn-cgi/l/email-protection#99eaece9e9f6ebedd9feebf8f7edeab7fef6ef)

Scientific/Research Contact(s) Yan Zhou, Ph.D.\
National Institute of Allergy and Infectious Diseases (NIAID)\
Telephone: 240-485-9785\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#a4decccbd1dd9592e4cacdc5cdc08acacdcc8ac3cbd2)
...
Email: \[[email protected]\](/cdn-cgi/l/email-protection#0a7865686f787e24616378616f78384a646362246d657c)
