<!--
meta-description: NIH Funding Opportunities and Notices in the NIH Guide for Grants and Contracts: D-START: Data Science Track Award for Research Transition (D/START) (R03-Clinical Trial Optional) PAS-25-236. NIDA
meta-keywords: PAS-25-236: D-START: Data Science Track Award for Research Transition (D/START) (R03-Clinical Trial Optional)
meta-viewport: width=device-width, initial-scale=1.0
title: PAS-25-236: D-START: Data Science Track Award for Research Transition (D/START) (R03-Clinical Trial Optional)
-->
...
Funding Opportunity Title D-START: Data Science Track Award for Research Transition (D/START) (R03-Clinical Trial Optional)Activity Code [R03](//grants.nih.gov/grants/funding/ac_search_results.htm?text_curr=r03&Search.x=0&Search.y=0&sort=ac&Search_Type=Activity&text_prev=) Small Grant Program

Announcement Type Reissue of [PAS-24-242](https://grants.nih.gov/grants/guide/pa-files/PAS-24-242.html)\
...
Funding Opportunity Number (FON) PAS-25-236Companion Funding Opportunity None Number of Applications See Section III. 3. Additional Information on Eligibility.

Assistance Listing Number(s) 93.279 Funding Opportunity Purpose This notice of funding opportunity (NOFO) seeks to support investigators interested in applying cutting-edge data science techniques to address timely and challenging research questions related to substance use and/or substance use disorder (SUD) in all areas of research supported by the National Institute on Drug Abuse (NIDA). This NOFO requests Small Research Grant (R03) applications to support research projects that can be carried out in a short period of time with limited resources.
...
Posted Date December 16, 2024 Open Date (Earliest Submission Date) January 16, 2025 Letter of Intent Due Date(s) Not Applicable
...
| February 16, 2027 * | March 16, 2027 * | May 07, 2027 * | July 2027 | August 2027 | December 2027 |
...
1. Use [Grants.gov](https://grants.gov/search-grants?oppStatuses=closed%7Carchived%7Cposted%7Cforecasted&fon=PAS-25-236) Workspace to prepare and submit your application and [eRA Commons](http://public.era.nih.gov/commons/) to track your application.
...
NIH defines data science as the interdisciplinary field of inquiry in which quantitative and analytical approaches, processes, and systems are developed and used to extract knowledge and insights from increasingly large and/or complex sets of data. Data science is an important cross-cutting research priority for the National Institute on Drug Abuse (NIDA), as described in the [NIDA Strategic Plan](https://nida.nih.gov/about-nida/2022-2026-strategic-plan/executive-summary). The Data Science Track Award for Research Transition (D-START) is intended for investigators who are interested in applying cutting edge data science techniques to research substance use and/or substance use disorder (SUD).

Increasing the pool of experts in data science (particularly big data analytics and computational science) for substance use and/or SUD research is critical. Research that utilizes data science methodologies is needed to deliver timely, data-driven insights to guide development, testing, implementation, and scale-up of interventions designed for meeting the prevention, treatment, and recovery needs for individuals with substance use or SUDs.

Cross-disciplinary collaborations are encouraged for this notice of funding opportunity (NOFO).

It is expected that investigators who are funded under D-START will use findings from their projects to develop a subsequent R01 or other appropriate grant applications on the intersection of substance use and/or SUD and data science.
...
Secondary datasets are accessible via the [National Addiction & HIV Data Archive Program](https://www.icpsr.umich.edu/icpsrweb/NAHDAP/ "Link to Non-U.S. Government Site"), [NIDA Center for Genetic Studies](https://nidagenetics.org/ "Link to Non-U.S. Government Site"), or other NIDA-funded initiatives such as the [Adolescent Brain Cognitive Development (ABCD) Study](https://abcdstudy.org/ "Link to Non-U.S. Government Site") and [NIDA Clinical Trials Network.](https://nida.nih.gov/organization/center-clinical-trials-network-cctn/clinical-trials-network-ctn) Additional data repositories or platforms of potential interest include, but not limited to, database of [Genotypes and Phenotypes](https://www.ncbi.nlm.nih.gov/gap/) (dbGaP), [Mouse Phenome Database (MPD)](https://phenome.jax.org/ "Link to Non-U.S. Government Site"), [Rat Genome Database (RGD)](https://rgd.mcw.edu/ "Link to Non-U.S. Government Site"), [All of Us Research Program](https://allofus.nih.gov/), [UK Biobank](https://www.ukbiobank.ac.uk/ "Link to Non-U.S. Government Site"), [ScHARe](https://nimhd.nih.gov/resources/schare/), [SCORCH (Single Cell Opioid Responses in the Context of HIV) Program](<https://nida.nih.gov/about-nida/organization/divisions/division-neuroscience-behavior-dnb/basic-research-hiv-substance-use-disorder/scorch-program#:~:text=Purpose&text=The%20purpose%20of%20NIDA's%20SCORCH,opioid%20use%20disorder%20(OUD).>), [Gene Expression Omnibus (GEO)](https://www.ncbi.nlm.nih.gov/geo/), and [HEAL Platform](https://healdata.org/landing "Link to Non-U.S. Government Site"). Of particular interest are analyses of data that have been harmonized and merged across data sets, such as those using[PhenX](https://www.phenxtoolkit.org/ "Link to Non-U.S. Government Site")and[NIH Toolbox measures](http://www.healthmeasures.net/explore-measurement-systems/nih-toolbox "Link to Non-U.S. Government Site"); public/restricted-use longitudinal data from the[Population Assessment of Tobacco and Health (PATH) Study](https://pathstudyinfo.nih.gov/researchers); or imaging datasets, such as the[Human Connectome Project](http://www.humanconnectomeproject.org/ "Link to Non-U.S. Government Site"). We also strongly encourage utilization of the[National Addiction & HIV Data Archive Program (NAHDAP)](https://www.icpsr.umich.edu/web/pages/NAHDAP/index.html "Link to Non-U.S. Government Site")hosted by ICPSR, as well as data from[NIDA Data Share for clinical trials](https://datashare.nida.nih.gov/). Additional NIH data repositories can be found at<https://www.nlm.nih.gov/NIHbmic/domain_specific_repositories.html>and sources of public health policy information include the[Opioid Policy Tools and Information Center (OPTIC)](https://www.rand.org/health-care/centers/optic/resources/datasets.html "Link to Non-U.S. Government Site"), [NIAAAs Alcohol Policy Information System (APIS)](https://alcoholpolicy.niaaa.nih.gov/), and[LawAtlas](http://lawatlas.org/ "Link to Non-U.S. Government Site").

**Applications Not Responsive to this NOFO**

The following types of studies are not responsive to this NOFO and will not be reviewed:

- Studies that focus solely on alcohol-related outcomes
- Applications that do not apply advanced data science techniques, such as (but not limited to) artificial intelligence/machine learning (AI/ML), or big data analytics

Applicants are strongly encouraged to contact Program Staff to discuss potential research projects prior to submitting a D/START application.
...
Funds Available and Anticipated Number of Awards Six to seven awards, corresponding to a total of $1,000,000 per year for fiscal year 2025, 2026 and 2027.

Award Budget Budgets for direct costs of up to $100,000 per year for up to 2 years, may be requested.
...
Scientific/Research Contact(s) Diek Wheeler, Ph.D.\
National Institute on Drug Abuse (NIDA)
Division of Neuroscience and Behavior (DNB)\
Phone: 301- 480-0520\
Email: \[[email protected]\](diek.wheeler@nih.gov)

Janet Kuramoto-Crawford, Ph.D.\
National Institute on Drug Abuse (NIDA)\
Division of Epidemiology, Services and Prevention Research (DESPR)\
Phone: 301-443-8856\
E-mail:\[[email protected]\](/cdn-cgi/l/email-protection#d6bcb7b8b3a2f8bda3a4b7bbb9a2b9fbb5a4b7a1b0b9a4b296b8bfbef8b1b9a0)
...
Email:\[[email protected]\](/cdn-cgi/l/email-protection#214f484540464c43444c40484d614f4845400f4f48490f464e57)
