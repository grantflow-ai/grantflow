<!--
meta-description: NIH Funding Opportunities and Notices in the NIH Guide for Grants and Contracts: Navigator Emergency Department Diversion Models for Non-Urgent Mental Health Concerns (R01 Clinical Trial Required) PAR-25-289. NIMH
meta-keywords: PAR-25-289: Navigator Emergency Department Diversion Models for Non-Urgent Mental Health Concerns (R01 Clinical Trial Required)
meta-viewport: width=device-width, initial-scale=1.0
title: PAR-25-289: Navigator Emergency Department Diversion Models for Non-Urgent Mental Health Concerns (R01 Clinical Trial Required)
-->
...
Funding Opportunity Title Navigator Emergency Department Diversion Models for Non-Urgent Mental Health Concerns (R01 Clinical Trial Required)Activity Code [R01](//grants.nih.gov/grants/funding/ac_search_results.htm?text_curr=r01&Search.x=0&Search.y=0&Search_Type=Activity) Research Project Grant
...
Posted Date November 25, 2024 Open Date (Earliest Submission Date) January 05, 2025 Letter of Intent Due Date(s) 30 days prior to application due date
...
1. Use [Grants.gov](https://grants.gov/search-grants?oppStatuses=closed%7Carchived%7Cposted%7Cforecasted&fon=PAR-25-289) Workspace to prepare and submit your application and [eRA Commons](http://public.era.nih.gov/commons/) to track your application.
...
This NOFO is intended to support research projects that are supported by pilot data and are statistically powered to provide a definitive test of effectiveness and answers questions about how, why, and for whom navigator models are effective.  Support for pilot/developmental studies is provided through a companion NOFO that utilizes the R34 mechanism [PAR-25-288](https://grants.nih.gov/grants/guide/pa-files/PAR-25-288.html)[R34](//grants.nih.gov/grants/funding/ac_search_results.htm?text_curr=r34&Search.x=0&Search.y=0&Search_Type=Activity) Planning Grant (R34 Clinical Trial Required). Research applications must involve rigorous examination of factors that impact or account for the effectiveness of existing models (e.g., research on mechanisms of action for existing practices).

**Specific Areas of Research Interest**

Areas of interest include (but are not limited to) research that:

- Examines the effectiveness of patient navigation models (e.g., studies that test or compare alternative approaches) and moderators/mediators of response),
- Tests navigator models that contain evidence-based components (e.g., psychoeducation to build mental health knowledge, engagement strategies, problem-solving skills),
...
- Optimizes culturally relevant approaches that reduce access and outcome disparities amongst underserved populations and enhances understanding of how navigator models can reduce disparities,
...
NIMH emphasizes approaches that are relevant and valid for use with a variety of service users.  NIMH is committed to supporting research that reduces disparities in prevalence, course and outcomes of mental illnesses, and advances mental health interventions, services, and outcomes. Accordingly, this NOFO encourages research studies that examine approaches that can be used to reduce disparities in underserved groups, for example, racial and ethnic minority groups, individuals limited by language or cultural barriers, and individuals living in rural areas.
...
For studies that involve the assessment of patient-level outcomes, plans are expected that describe the assessment of mental health symptoms and functioning and related outcomes using strategies that can facilitate integration and sharing of data (e.g., see[NOT-MH-23-100-](https://grants.nih.gov/grants/guide/notice-files/NOT-MH-23-100.html)\[)\](file:///C:/Users/acrimc/AppData/Local/Microsoft/Windows/INetCache/Content.Outlook/WEXHGGV0/ NOT-MH-15%20009) and [https://nda.nih.gov](https://nda.nih.gov/) for constructs and corresponding assessment strategies), as appropriate, or provide a rationale for excluding such measures if they are not included.
...
Email:\[[email protected]\](/cdn-cgi/l/email-protection#026c6b6f6a726767707067746b6775426f636b6e2c6c6b6a2c656d743d717760686761763f5044432f4f4a2f30332f333031)
...
- Considering ethical issues, p~~P~~rovide plans for recruitment outreach, enrollment, retention, handling dropouts, missed visits, and losses to follow-up are appropriate to ensure robust data collection, that the planned recruitment timelines are feasible, and ~~is~~ the plan to monitor accrual is adequate.
...
- Adequately address any ethical issues, such as~~Detail~~ the need for randomization (or not), masking (if appropriate), and controls.
...
Send written disclosures to the NIH Chief Grants Management Officer listed on the Notice of Award for the IC that funded the award and to the[HHS Office of Inspector Grant Self Disclosure Program](https://oig.hhs.gov/compliance/self-disclosure-info/hhs-oig-grant-self-disclosure-program/) at\[[email protected]\](/cdn-cgi/l/email-protection#5c3b2e3d322838352f3f30332f292e392f1c33353b7234342f723b332a).
...
- Assess if the study will adequately leverage resources and expertise from existing infrastructure or utilize other available resources to increase the efficiency of participant recruitment and data collection. Or if it provides a sufficient justification in the event that such efficiencies cannot be incorporated.
...
Email:\[[email protected]\](/cdn-cgi/l/email-protection#99deebf8f7edead0f7fff6d9f7f0f1b7fef6ef)(preferred method of contact)\
Telephone: 301-480-7075

Grants.gov Customer Support (Questions regarding Grants.gov registration and Workspace)\
Contact Center Telephone: 800-518-4726\
Email:\[[email protected]\](/cdn-cgi/l/email-protection#93e0e6e3e3fce1e7d3f4e1f2fde7e0bdf4fce5)

Scientific/Research Contact(s) Mary Acri, Ph.D.\
National Institute of Mental Health (NIMH)\
Telephone: 301-910-8230\
Email: mary.acri[@mail.nih.gov](/cdn-cgi/l/email-protection#d1a9a9a9a991bcb0b8bdffbfb8b9ffb6bea7)

Peer Review Contact(s) Nicholas Gaiano, Ph.D.\
National Institute of Mental Health (NIMH)\
Telephone: 301-827-3420\
Email:\[[email protected]\](/cdn-cgi/l/email-protection#bbd5d2d8d095dcdad2dad5d4fbd5d2d395dcd4cd)
...
Email: \[[email protected]\](/cdn-cgi/l/email-protection#36555e445f45425f585318555a57445d4559587618585f5e18515940)
