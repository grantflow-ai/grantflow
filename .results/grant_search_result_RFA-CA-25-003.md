<!--
meta-description: NIH Funding Opportunities and Notices in the NIH Guide for Grants and Contracts: Innovative Biospecimen Science Technologies for Basic and Clinical Cancer Research (R61 Clinical Trial Not Allowed) RFA-CA-25-003. NCI
meta-keywords: RFA-CA-25-003: Innovative Biospecimen Science Technologies for Basic and Clinical Cancer Research (R61 Clinical Trial Not Allowed)
meta-viewport: width=device-width, initial-scale=1.0
title: RFA-CA-25-003: Innovative Biospecimen Science Technologies for Basic and Clinical Cancer Research (R61 Clinical Trial Not Allowed)
-->
...
Funding Opportunity Title Innovative Biospecimen Science Technologies for Basic and Clinical Cancer Research (R61 Clinical Trial Not Allowed)Activity Code [R61](https://grants.nih.gov/grants/funding/ac_search_results.htm?text_curr=R61&sort=ac&Search_Type=Activity) Phase 1 Exploratory/Developmental Grant

Announcement Type Reissue of [RFA-CA-24-010](https://grants.nih.gov/grants/guide/rfa-files/RFA-CA-24-010.html)\
Related NoticesSee [Notices of Special Interest](https://grants.nih.gov/grants/guide/NOSIs_targetingList.cfm?GuideDocID=42141) associated with this funding opportunity
...
Funding Opportunity Number (FON) RFA-CA-25-003Companion Funding Opportunity [RFA-CA-25-001](https://grants.nih.gov/grants/guide/rfa-files/RFA-CA-25-001.html), [R61](https://grants.nih.gov/grants/funding/ac_search_results.htm?text_curr=R61&&Search.x=0&&Search.y=0&&Search_Type=Activity)Phase 1 Exploratory/Developmental Grant
...
Posted Date December 16, 2024 Open Date (Earliest Submission Date) March 04, 2025 Letter of Intent Due Date(s) 30 days prior to the application due date
...
1. Use [Grants.gov](https://grants.gov/search-grants?oppStatuses=closed%7Carchived%7Cposted%7Cforecasted&fon=RFA-CA-25-003) Workspace to prepare and submit your application and [eRA Commons](http://public.era.nih.gov/commons/) to track your application.
...
Through this Notice of Funding Opportunity (NOFO), the National Cancer Institute (NCI) solicits grant applications proposing exploratory research projects focused on early-stage development of highly innovative technologies that improve the quality and handling of samples used for cancer research or clinical care. This NOFO is meant to support highly innovative projects with high potential impact in a cancer-relevant field of research, even if they involve some level of risk of failure. Through this NOFO, NCI will support the development of technologies (including tools, devices, instrumentation, assays, and associated methods) to improve the collection, handling, processing, preservation, or storage of biological samples and their derivatives (*e.g.*, DNA, RNA, metabolites, proteins, etc.). This includes tools with new capabilities to maximize or interrogate the quality and utility of biological samples or address issues related to pre-analytical degradation of targeted analytes. These technologies are expected to accelerate and/or enhance research in cancer biology, early detection, screening, clinical diagnosis, treatment, epidemiology, and/or address issues in cancer health disparities.

This NOFO utilizes the R61 award mechanism for exploratory/developmental projects. The R61 mechanism is suitable for projects that are at their inception, conceptual, or idea-based phase. In this phase, technical feasibility of the proposed technology or methodology should have not yet been established. Preliminary data are not required but are accepted if available. If preliminary data are sufficient to suggest the feasibility of the approach is established, then consideration should be given to submitting to the companion R33 NOFO ([RFA-CA-25-004](https://grants.nih.gov/grants/guide/rfa-files/RFA-CA-25-004.html)).

Applications involving an existing technology not yet demonstrated in the cancer-relevant application being proposed are also within the scope of this NOFO but must involve significant additional technical modifications to allow for the proposed cancer-relevant context of use or some significant question of feasibility persists for achieving the proposed aims. If the focus for the application involves further development or significant modification to an existing technology, a clear description of the feasibility risk for the proposed advancement of that technology must be included in the application to justify the use of the R61 mechanism. Applicants are encouraged to reach out to the Scientific/Research Contact below with any questions.

This funding opportunity is part of a broader NCI-sponsored [Innovative Molecular Analysis Technologies (IMAT)](https://www.cancer.gov/about-nci/organization/cssi/research/imat) Program.

#### The IMAT Program

Since its inception in 1998, the [IMAT Program](https://www.cancer.gov/about-nci/organization/cssi/research/imat) has focused on stimulating and accelerating the development, validation, maturation, and dissemination of the most novel and highly innovative technologies in support of cancer research and medicine. Together with NCI's other technology-focused programs, the IMAT program continues to support the development of tools and methods that enable cancer researchers to make new discoveries, enhance our understanding of cancer etiology and proliferation, improve detection capabilities, develop diagnostic methods and treatment strategies, conduct population-scale studies, address and reduce disparities in clinical care, and assist in clinical decision-making.
...
- **Cancer-Relevant Biospecimen Science Technologies** is centered on the development and validation of novel technologies to improve and reduce variability in the collection, processing, handling, preservation, or isolation of cancer-relevant biospecimens and their derivatives, including tools to assess their quality and biological integrity.
  - RFA-CA-25-003 (*this NOFO, R61*): Supports an early-stage feasibility study (inception through preliminary development) to demonstrate the core functional capabilities of the proposed technology.
  - [RFA-CA-25-004](https://grants.nih.gov/grants/guide/rfa-files/RFA-CA-25-004.html) (R33): Supports the advanced development and robust validation of the technology following completion of the initial phase of development.
...
The proposed projects must be focused on early-stage development of innovative, biospecimen science-relevant technologies and methods that improve the quality or handling of biospecimens and/or samples derived from biospecimens to increase their utility in cancer research and/or clinical care. The proposed technology should address unmet needs in basic, preventative, diagnostics, translational, epidemiological, health disparities, and/or clinical cancer research or have broad potential use in cancer research.

In addition, all projects proposed in response to this NOFO must involve all the following general attributes:

- Development of a novel tool with potential for substantial improvements over current approaches and/or adding qualitatively new research capabilities.
- New or improved technical capabilities that are potentially transformative to research in laboratory, epidemiology, and/or clinical settings, and beyond providing incremental improvements to existing capabilities.
...
**Responsive technologies include relevant techniques, tools, devices, assays, and associated methods.** These technologies must focus on offering improved capabilities for collecting, handling, preserving and/or preparing cancer biospecimens for basic or clinical research purposes with a focus on improving or assessing the integrity of targeted molecular and/or cellular features. Applicants are encouraged to consider how their proposed technology may impact cancer health disparities and address how new or exacerbated disparities will be mitigated.
...
- New methods, tools, and procedures to improve the preparation of biospecimens for downstream molecular analysis (e.g., genomic or RNA sequencing, mass spectrometry-based protein profiling or metabolite analysis, etc.) or improve the quality of patient-derived models;
...
- Projects focused primarily on software/informatics solutions, database development, data mining, statistical tools, and computational/mathematical modeling with the exception of projects which include limited amounts of software development or computational efforts as might be needed to support the proposed development of new devices or methods.

*Additionally, applications that lack quantitative performance measures as determined by the NCI program staff will not be reviewed*. As there are several unique review considerations for this NOFO, applicants must address the requested items outlined for the Research Plan in [Section IV.2. Application and Submission Information](#_Section_IV._Application_1).
...
**Related IMAT NOFO:** Applicants proposing projects that are beyond questions of feasibility, but still require further development and validation should consider applying to the companion NOFO ([RFA-CA-25-004](https://grants.nih.gov/grants/guide/rfa-files/RFA-CA-25-004.html)), which uses the R33 mechanism. Further development encompasses optimization and scaling of the technology or merging with complementary technologies to improve the overall functionality.

**NOTE:** Applications proposing to apply new technologies in pursuit of a biological hypothesis or merge complementary technologies without a substantial requirement for further development or a clear need for analytical validation are beyond the scope of the IMAT program solicitations altogether.
...
Funds Available and Anticipated Number of Awards NCI intends to fund an estimate of 4 awards, corresponding to a total of $1,000,000, for the fiscal year 2026.

Award Budget Application budgets are limited to $150,000 per year (in direct costs).

Award Project Period The total project period request may not exceed 3 years.
...
Email: \[[email protected]\](/cdn-cgi/l/email-protection#b6ddd3dadacf98d5c4d9c2c2cff6d8dfde98d1d9c0)
...
- What is the new capability provided by the proposed technology? How may it be expected to be highly impactful on biomedical research or medicine?
- How will the proposed technology overcome limitations of currently available technologies or alternative approaches?
...
- Describe the *new or improved technical capabilities* that are proposed to be developed. The project must be focused on the initial development and demonstration of highly novel technologies and/or methodologies that improve the quality and utility of biospecimens for cancer research and/or clinical care. The proposed technology must offer novel technical capabilities or substantial improvement over currently available approaches to address an unmet need in the field of cancer research. This NOFO is meant to support projects with high technical innovation, even if they come with a relatively high level of risk.
- Describe the *potential impact* of the proposed tool on cancer research or clinical care. Applicants are encouraged to explain the significance of the proposed work and why potential impact outweighs risks. They should describe the unmet technical need from the research community that will be addressed by the technology and its anticipated use in laboratory research and/or clinical settings. There should be a description of how the project may impact health disparities and how any new or exacerbated cancer disparities will be addressed or mitigated.

*Rigor and Feasibility*

- Describe the *technical approach*, including anticipated difficulties and possible workarounds.

*Quantitative Performance Measures*

- There must be a dedicated subsection within Research Strategy labeled Performance Measures. Performance measures are objective measures of target performance capabilities and must include the numerically described target as well as the means by which it will be assessed.
- Performance measures are specific to the technology being proposed. They should be carefully selected and precisely defined. Whenever appropriate, present the proposed measures in the context of current technologies to substantiate the anticipated transformative potential.
- Performance measures should address any key risk factors for the project. They are a means of judging the success of the R61 project for demonstrating that key feasibility gaps have been overcome, thereby justifying support for further developmental efforts (e.g. under a future R33 project).
- For some specific aims, it may be sufficient to define a single performance measure. For others, multiple performance measures may be more appropriate.
- Performance measures may be a measure of sensitivity, specificity, throughput, reproducibility, a price point, or any other measure or test to demonstrate progress towards the aims. They must be well-described, quantifiable, and scientifically justified.
- An example of a properly described performance measure could be achieving improved recovery of spike-in molecular additives from whole blood with X efficiency (+/- Y) under conditions a, b, and c over a concentration range from g to h.
...
The R61 exploratory/developmental grant supports investigation of novel scientific ideas or systems, tools, or technologies that have the potential for significant impact on biomedical or biobehavioral research. An R61 grant application need not have extensive background material or preliminary information. Accordingly, reviewers will emphasize the conceptual framework, the level of innovation, and the potential to significantly advance our knowledge or understanding. Appropriate justification for the proposed work can be provided through literature citations, data from other sources, or, when available, from investigator-generated data. Preliminary data are not required for R61 applications; however, they may be included if available.
...
Describe the potential impact of the proposed technology on cancer research or clinical care and evaluate the potential for it to be widely adopted by the relevant research community.
...
Evaluate how appropriate the performance measures are to determine whether the aims of the project have been accomplished and whether key risk factors for the project have been addressed. Assess whether the measures are quantitative, feasible, and if achieved would be adequate to establish proof-of-concept for the technology to serve as a foundation for the next phase of developmental efforts. Describe whether meeting these proposed performance capabilities would establish a useful tool that the research community would be likely to benefit from.
...
Email:\[[email protected]\](/cdn-cgi/l/email-protection#652217040b11162c0b030a250b0c0d4b020a13)(preferred method of contact)\
Telephone: 301-480-7075

Grants.gov Customer Support (Questions regarding Grants.gov registration and Workspace)\
Contact Center Telephone: 800-518-4726\
Email:\[[email protected]\](/cdn-cgi/l/email-protection#3d4e484d4d524f497d5a4f5c53494e135a524b)

Scientific/Research Contact(s) **Kelly Crotty, Ph.D.**
National Cancer Institute (NCI)\
Telephone: 240-255-0917\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#046f6168687d2a67766b70707d446a6d6c2a636b72)

Peer Review Contact(s) **Referral Officer**
National Cancer Institute (NCI)\
Telephone: 240-276-6390\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#97f9f4fee5f2f1f8f1d7f3f2f6b9f9f4feb9f9feffb9f0f8e1)

Financial/Grants Management Contact(s) **Sean Hine**
National Cancer Institute (NCI)\
Telephone: 240-276-6291\
E-mail:\[[email protected]\](/cdn-cgi/l/email-protection#c3abaaada6b083aea2aaafedadaaabeda4acb5)
