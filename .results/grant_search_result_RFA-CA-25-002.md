<!--
meta-description: NIH Funding Opportunities and Notices in the NIH Guide for Grants and Contracts: Advanced Development and Validation of Emerging Molecular and Cellular Analysis Technologies for Basic and Clinical Cancer Research (R33 Clinical Trial Not Allowed) RFA-CA-25-002. NCI
meta-keywords: RFA-CA-25-002: Advanced Development and Validation of Emerging Molecular and Cellular Analysis Technologies for Basic and Clinical Cancer Research (R33 Clinical Trial Not Allowed)
meta-viewport: width=device-width, initial-scale=1.0
title: RFA-CA-25-002: Advanced Development and Validation of Emerging Molecular and Cellular Analysis Technologies for Basic and Clinical Cancer Research (R33 Clinical Trial Not Allowed)
-->
...
Funding Opportunity Title Advanced Development and Validation of Emerging Molecular and Cellular Analysis Technologies for Basic and Clinical Cancer Research (R33 Clinical Trial Not Allowed)Activity Code [R33](//grants.nih.gov/grants/funding/ac_search_results.htm?text_curr=r33&Search.x=0&Search.y=0&Search_Type=Activity) Exploratory/Developmental Grants Phase II.

Announcement Type Reissue of [RFA-CA-24-009](https://grants.nih.gov/grants/guide/rfa-files/RFA-CA-24-009.html)\
Related NoticesSee [Notices of Special Interest](https://grants.nih.gov/grants/guide/NOSIs_targetingList.cfm?GuideDocID=42143) associated with this funding opportunity
...
Funding Opportunity Number (FON) RFA-CA-25-002Companion Funding Opportunity [RFA-CA-25-001](https://grants.nih.gov/grants/guide/rfa-files/RFA-CA-25-001.html), [R61](https://grants.nih.gov/grants/funding/ac_search_results.htm?text_curr=R61&&Search.x=0&&Search.y=0&&Search_Type=Activity)Phase 1 Exploratory/Developmental Grant
...
1. Use [Grants.gov](https://grants.gov/search-grants?oppStatuses=closed%7Carchived%7Cposted%7Cforecasted&fon=RFA-CA-25-002) Workspace to prepare and submit your application and [eRA Commons](http://public.era.nih.gov/commons/) to track your application.
...
- **Molecular and Cellular Analysis Technology Development for Cancer Research** is intended to support the development of technologies with novel measurement, probing, or targeting of cancer-relevant targets at the molecular or cellular level which may in turn accelerate basic, epidemiologic, or clinical cancer research.
  ...
  - RFA-CA-25-002 (*this NOFO, R33*): Supports the advanced development and robust validation of the technology following completion of the initial phase of development.
...
The proposed projects must be focused on the advanced development, optimization, and validation of an emerging molecular or cellular analysis technology in a biologically relevant system. In addition, all projects proposed in response to this NOFO must involve all the following general attributes:

- Further development of a novel tool with potential for substantial improvements over current approaches and/or adding qualitatively new research capabilities.
- New or improved technical capabilities that are potentially transformative to research in laboratory, epidemiology, and/or in clinical settings, and beyond providing incremental improvements to existing capabilities.
...
**Responsive technologies include relevant novel platforms, assays, instrumentation, devices, and associated methods.** These technologies may be intended for molecular and/or cellular analyses *in vitro*, *in situ,* and/or *in vivo* (with some exceptions listed below), and may target the needs of basic, diagnostic, translational, epidemiological, and/or clinical cancer research or otherwise address issues associated with cancer health disparities. The proposed projects must clearly be focused on the development of generally applicable technologies to advance cancer research, NOT on pursuing specific discoveries with these tools. As novel technologies can create new or exacerbate existing cancer health disparities, developers are encouraged to comment on how the proposed approach will address or otherwise mitigate such effects.

Technology development projects in any area of cancer-related research are encouraged. Technologies may target cancer-relevant atomic, molecular, sub-cellular, and/or cellular features. *At the core of any project must be a novel analysis or targeting capability* (encompassing novel devices, materials, or chemical/biochemical approaches). General areas of interest include, but are not limited to, the following:
...
- Technologies that can facilitate and/or enhance molecular analyses in cancer epidemiology and population sciences (*e.g*., remote methods to monitor molecular and cellular features of individuals outside a laboratory or clinical setting, tools to monitor and analyze the impact of environmental factors or physical activity, tools to enable population-scale genomics or survival cancer research);
...
- Projects focused primarily on software/informatics solutions, database development, data mining, statistical tools, and computational/mathematical modeling with the exception of projects which include limited amounts of software development or computational efforts as might be needed to develop new devices or methods.

\*Additionally, an application lacking appropriate performance measures, as determined by the NCI program staff, will not be reviewed.\*As there are several unique review considerations for this NOFO, applicants must address the requested items outlined for the Research Plan in[Section IV. Application and Submission Information](#_Section_IV._Application_1).
...
**Related IMAT NOFO:** Applicants proposing projects that still involve a critical question as to the overall feasibility of the approach should consider applying to the companion NOFO ([RFA-CA-25-001](https://grants.nih.gov/grants/guide/rfa-files/RFA-CA-25-001.html)) which uses the R61 mechanism. NOTE: Applications proposing to use novel technologies for hypothesis-driven research or merge complementary technologies without a substantial requirement for further development or clear need for analytical validation are beyond the scope of the IMAT program solicitations altogether.
...
Funds Available and Anticipated Number of Awards NCI intends to fund an estimate of 10 awards, corresponding to a total of $4,300,000, for the fiscal year 2026. Future year amounts will depend on annual appropriations.
...
Email: \[[email protected]\](/cdn-cgi/l/email-protection#cba0aea7a7b2e5a8b9a4bfbfb28ba5a2a3e5aca4bd)
...
**Specific Aims:** Include a brief subsection "Statement of Potential Impact" on the expected potential of the proposed technology to transform cancer research or  clinical practice.

The following questions should be addressed within this statement:
...
- Describe the *new or improved technical capabilities* that will be advanced and validation. The project must focus on the further development of a novel technology beyond the early-stage proof of concept demonstration and engage a rigorous validation of the novel capability in a cancer-relevant biological context of use. The technology must off substantial improvements over currently available approaches to address an unmet need in basic, preventative, diagnostic, translational, epidemiological, and/or clinical cancer research. Applications should provide appropriate background/preliminary data to justify that the proposed technology has passed the pilot developmental stage and shows promise. Applications based on work supported by a prior IMAT R21 or R61 award must describe the extent to which the aims of the prior IMAT award have been achieved. For applications not based on work supported by a prior IMAT award, an equivalent level of evidence should be provided.
- Describe the *potential impact* of the proposed tool on cancer research or clinical care. Applicants are encouraged to explain the significance of the proposed work and describe the unmet technical need from the research community that will be addressed by the technology, as well as its anticipated use in laboratory research and/or clinical settings.As novel technologies can create new or exacerbate existing cancer health disparities, applicants should describe how they plan to address or otherwise mitigate such effects and how populations affected by health disparities, or data from these populations, will be integrated into the proposed study.

*Rigor and Feasibility*

- Describe the *technical approach*, including the steps to evaluate and rigoroulsy validate the proposed technology within the context of its intended use, anticipated difficulties, and possible workarounds.
-

*Quantitative Performance Measures*

- There must be a dedicated subsection within the Research Strategy labeled Performances Measures. Performance measures are an objective measure of the target performance capabilities and must include the numerically described target of performance as well as the means by which it will be assessed.
- Performance measures are specific to the technology being developed. They should be carefully selected and precisely defined. Whenever appropriate, the proposed measures should be presented in the context of current technologies to substantiate the anticipated transformative potential.
- Performance measures should appropriately address any key risk factors for the project. They are a means of demonstrating success for the validation of the technology.
...
- An example of a properly described performance measure could be achieving a detection limit of X femtogram per microliter of a sample with a p-value \<0.05 under conditions a, b, and c with 95% confidence limits +/- Y fg over a concentration range of g to h.
...
Send written disclosures to the NIH Chief Grants Management Officer listed on the Notice of Award for the IC that funded the award and to the[HHS Office of Inspector Grant Self Disclosure Program](https://oig.hhs.gov/compliance/self-disclosure-info/hhs-oig-grant-self-disclosure-program/) at\[[email protected]\](/cdn-cgi/l/email-protection#147366757a60707d6777787b6761667167547b7d733a7c7c673a737b62).
...
Evaluate the potential impact of the proposed technology on a broad area of cancer research or clinical care and whether this impact could be considered transformative.

Evaluate its potential to be widely adopted by the relevant research community.
...
Evaluate how appropriate the proposed performance measures are to determine whether the aims of the project have been accomplished and whether key risk factors for the project have been addressed. Assess whether the measures are quantitative, feasible, and if achieved, would be adequate to validate performance of the technology in a biologically-relevant context. Describe whether meeting those proposed performance measures would establish a useful tool that the research community would be likely to benefit from.
...
Email:\[[email protected]\](/cdn-cgi/l/email-protection#9cdbeefdf2e8efd5f2faf3dcf2f5f4b2fbf3ea)(preferred method of contact)\
...
National Cancer Institute (NCI)\
Telephone:  240-255-0917\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#90fbf5fcfce9bef3e2ffe4e4e9d0fef9f8bef7ffe6)

Peer Review Contact(s) Referral Officer\
National Cancer Institute (NCI)\
Telephone: 240-276-6390\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#b1dfd2d8c3d4d7ded7f1d5d4d09fdfd2d89fdfd8d99fd6dec7)

Financial/Grants Management Contact(s) Sean Hine\
National Cancer Institute (NCI)\
Telephone: 240-276-6291\
E-mail:\[[email protected]\](/cdn-cgi/l/email-protection#254d4c4b40566548444c490b4b4c4d0b424a53)
