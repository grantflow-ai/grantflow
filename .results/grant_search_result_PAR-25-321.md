<!--
meta-description: NIH Funding Opportunities and Notices in the NIH Guide for Grants and Contracts: Exploratory/Developmental Bioengineering Research Grants (EBRG) (R21 Clinical Trial Optional) PAR-25-321. NCI
meta-keywords: PAR-25-321: Exploratory/Developmental Bioengineering Research Grants (EBRG) (R21 Clinical Trial Optional)
meta-viewport: width=device-width, initial-scale=1.0
title: PAR-25-321: Exploratory/Developmental Bioengineering Research Grants (EBRG) (R21 Clinical Trial Optional)
-->
...
Funding Opportunity Title Exploratory/Developmental Bioengineering Research Grants (EBRG) (R21 Clinical Trial Optional)Activity Code [R21](//grants.nih.gov/grants/funding/ac_search_results.htm?text_curr=r21&Search.x=0&Search.y=0&Search_Type=Activity) Exploratory/Developmental Research Grant

Announcement Type Reissue of [PAR-22-091](https://grants.nih.gov/grants/guide/pa-files/PAR-22-091.html)\
Related NoticesSee [Notices of Special Interest](https://grants.nih.gov/grants/guide/NOSIs_targetingList.cfm?GuideDocID=42099) associated with this funding opportunity
...
1. Use [Grants.gov](https://grants.gov/search-grants?oppStatuses=closed%7Carchived%7Cposted%7Cforecasted&fon=PAR-25-321) Workspace to prepare and submit your application and [eRA Commons](http://public.era.nih.gov/commons/) to track your application.
...
The following types of studies are not responsive to this NOFO. Applications proposing such studies will be considered non-responsive:

- Studies of basic science aspects of cancer biology, such as (but not limited to) studies of the following:
  - Basic cellular pathways, mechanisms, and oncogenic events that drive the development of tumors and behavior of cancer cells. Studies using therapeutic or preventive agents as tools/probes to interrogate basic cancer-related pathways and cellular mechanisms are not responsive to this NOFO (although studies using agents for the purpose of studying therapeutic/preventive activity, mechanisms of drug action, or mechanisms of drug resistance are appropriate and responsive).
...
Applications that propose phase III clinical trials are not responsive to this NOFO.
...
\*\*Research Strategy:\*\*The Research Strategy should clearly describe the following within the appropriate section (i.e., Importance of the Research,  Rigor and Feasibility, and Expertise and Resources):

Factor 1. Importance of the Research (Significance and Innovation):

- *Significance:*
  - Clarify if the intended objective is to demonstrate a new capability, improve performance of an existing capability or adapt it to a new use.
  - Briefly state if the solution will involve an unproven approach with minimal or no preliminary data. If so, provide a rationale that supports the effort.
  - Clearly state the problem addressed, its significance for basic, preclinical, or clinical research or clinical care delivery or access to care for a high, intermediate, or low resource setting or well-, moderately- or underserved population, and potential benefits of the approach proposed to solve or mitigate the chosen problem.
...
Email:\[[email protected]\](/cdn-cgi/l/email-protection#f09f8383919e949f9db09d91999cde9e9998de979f86)
...
Email:\[[email protected]\](/cdn-cgi/l/email-protection#fd8487959c939abd909c9491d3939495d39a928b)

Rao L. Divi, Ph.D.\
National Cancer Institute (NCI)\
Phone: (240) 276 6913\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#395d504f504b795d5a0a0e5817575a5017575051175e564f)
...
Email:\[[email protected]\](/cdn-cgi/l/email-protection#faa9929b949fd4ad95959e8d9b889eba949392d49d958c)
