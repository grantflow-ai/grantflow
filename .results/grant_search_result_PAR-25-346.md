<!--
meta-description: NIH Funding Opportunities and Notices in the NIH Guide for Grants and Contracts: Exploratory/Developmental Bioengineering Research Grants (EBRG) (R21 Clinical Trial Not Allowed) PAR-25-346. NCI
meta-keywords: PAR-25-346: Exploratory/Developmental Bioengineering Research Grants (EBRG) (R21 Clinical Trial Not Allowed)
meta-viewport: width=device-width, initial-scale=1.0
title: PAR-25-346: Exploratory/Developmental Bioengineering Research Grants (EBRG) (R21 Clinical Trial Not Allowed)
-->
...
Funding Opportunity Title Exploratory/Developmental Bioengineering Research Grants (EBRG) (R21 Clinical Trial Not Allowed)Activity Code [R21](//grants.nih.gov/grants/funding/ac_search_results.htm?text_curr=r21&Search.x=0&Search.y=0&Search_Type=Activity) Exploratory/Developmental Research Grant

Announcement Type Reissue of [PAR-22-090](https://grants.nih.gov/grants/guide/pa-files/PAR-22-090.html)\
...
Posted Date December 11, 2024 Open Date (Earliest Submission Date) January 16, 2025 Letter of Intent Due Date(s) Not Applicable
...
1. Use [Grants.gov](https://grants.gov/search-grants?oppStatuses=closed%7Carchived%7Cposted%7Cforecasted&fon=PAR-25-346) Workspace to prepare and submit your application and [eRA Commons](http://public.era.nih.gov/commons/) to track your application.
...
Innovation in an engineering context is delivery of a new capability to end users. *In the EBRG context of feasibility and early development steps, innovation is defined as a credible research strategy for successful early steps toward delivery of a new capability to end users.*
...
Resubmission - Resubmission of applications to PAR-19-149, PAR-22-090, and this NOFO.
...
**Research Strategy**: The Research Strategy should clearly describe the following within the appropriate section (i.e., Importance of the Research, Rigor and Feasibility):

Factor 1. Importance of the Research (Significance and Innovation):

- Significance: Clarify if the intended objective is to demonstrate a new capability, improve performance of an existing capability or adapt it to a new use. Briefly state if the solution will involve an unproven approach with minimal or no preliminary data. If so, provide a rationale that supports the effort. Clearly state the problem addressed, its significance for basic, preclinical, or clinical research or clinical care delivery or access to care for a high, intermediate, or low resource setting or well-, moderately- or underserved population, and potential benefits of the approach proposed to solve or mitigate the chosen problem.
- Innovation: For this announcement innovation guidelines for NIH grants are modified to define EBRG innovation as a credible research strategy for successful early steps toward delivery of a new capability to end users, namely, early phase demonstration of feasibility and/or exploratory development and preliminary data gathering to determine promise for future delivery of a mitigation or solution to a problem in basic, applied, preclinical or clinical research, or clinical care delivery, or accessibility to care.

Factor 2. Rigor and Feasibility (Approach):

- Approach: Provide a plan, timeline, and objective performance targets for accomplishing the objective.  If needed, include details for demonstrating feasibility. If feasible, provide details on data to be gathered in support of promise for future progress.

Factor 3. Expertise and Resources (Investigator(s) and Environment):

- Investigators: Describe the roles of key investigators without duplicating information in the biosketches.
...
Send written disclosures to the NIH Chief Grants Management Officer listed on the Notice of Award for the IC that funded the award and to the[HHS Office of Inspector Grant Self Disclosure Program](https://oig.hhs.gov/compliance/self-disclosure-info/hhs-oig-grant-self-disclosure-program/) at\[[email protected]\](/cdn-cgi/l/email-protection#1c7b6e7d726878756f7f70736f696e796f5c73757b3274746f327b736a).
...
- Evaluate whether the projectis likely to complete an early step toward delivery of a capability that will be new to a high, intermediate, or low resource setting, or in a well- moderately- or underserved population.
...
- Evaluate whether the project proposes a research strategy to accomplish early-stage development or procure data for promising future mid-level development.

- Evaluate whether the project describes a coherent plan to test feasibility for the mitigation or solution to a problem in: Basic, applied, preclinical or clinical research, or clinical care delivery, or accessibility to care.

- Evaluate whether the project describe appropriate performance specifications such as sensitivity, accuracy, limit of detection (LOD) or others
...
- Evaluate whether the project describes a governance and organizational structures to support a successful outcome.
...
Email:\[[email protected]\](/cdn-cgi/l/email-protection#0f7c7a7f7f607d7b4f687d6e617b7c21686079)

Scientific/Research Contact(s) Asif Rizwan, Ph.D.\
...
Email:\[[email protected]\](/cdn-cgi/l/email-protection#4a2539392b242e25270a272b232664242322642d253c)

Yantian Zhang, Ph.D.\
National Cancer Institute (NCI)\
Telephone: 240-276-5980\
Email:\[[email protected]\](/cdn-cgi/l/email-protection#5920233138373e193438303577373031773e362f)

David Jonathan Miller, Ph.D.\
National Cancer Institute (NCI)\
Telephone: 240-276-6810\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#771316011e13591a1e1b1b12054437191e1f59101801)
...
Email:\[[email protected]\](/cdn-cgi/l/email-protection#bcefd4ddd2d992ebd3d3d8cbddced8fcd2d5d492dbd3ca)
