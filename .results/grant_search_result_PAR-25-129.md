<!--
meta-description: NIH Funding Opportunities and Notices in the NIH Guide for Grants and Contracts: Biology of Bladder Cancer (R01 Clinical Trial Optional) PAR-25-129. NCI
meta-keywords: PAR-25-129: Biology of Bladder Cancer (R01 Clinical Trial Optional)
meta-viewport: width=device-width, initial-scale=1.0
title: PAR-25-129: Biology of Bladder Cancer (R01 Clinical Trial Optional)
-->
...
Funding Opportunity Title Biology of Bladder Cancer (R01 Clinical Trial Optional)Activity Code [R01](//grants.nih.gov/grants/funding/ac_search_results.htm?text_curr=r01&Search.x=0&Search.y=0&Search_Type=Activity) Research Project Grant

Announcement Type Reissue of [PAR-22-218](https://grants.nih.gov/grants/guide/pa-files/PAR-22-218.html)\
...
Funding Opportunity Number (FON) PAR-25-129Companion Funding Opportunity None Number of Applications See [Section III. 3. Additional Information on Eligibility](#_3._Additional_Information).

Assistance Listing Number(s) 93.393, 93.396 Funding Opportunity Purpose Through this Notice of Funding Opportunity (NOFO), the National Cancer Institute (NCI) encourages applications that investigate the biology and underlying mechanisms of bladder cancer. Bladder cancer is a significant health problem both in the United States and globally. Because of the high incidence and frequent tumor recurrence, bladder cancer exacts an outsized medical burden. While recent progress has been made in the molecular profiling of bladder cancers and identification of mutated genes, relatively little is known regarding the molecular mechanisms driving initiation, progression and malignancy of bladder cancer. Furthermore, our understanding of the biological processes of the normal bladder at the molecular, cell and organ levels is limited. Fundamental knowledge of how molecular and cellular functions of the bladder are altered in cancer will aid our understanding of bladder cancer biology and contribute to the future development of new interventions.

## Key Dates

Posted Date November 20, 2024 Open Date (Earliest Submission Date) January 05, 2025 Letter of Intent Due Date(s) 30 days prior to the application due date
...
1. Use [Grants.gov](https://grants.gov/search-grants?oppStatuses=closed%7Carchived%7Cposted%7Cforecasted&fon=PAR-25-129) Workspace to prepare and submit your application and [eRA Commons](http://public.era.nih.gov/commons/) to track your application.
...
Through this Notice of Funding Opportunity (NOFO), the National Cancer Institute (NCI) encourages applications investigating the biology and underlying mechanisms of bladder cancer. Bladder cancer is a significant health problem both in the United States and globally. Because of the high incidence and frequent tumor recurrence, bladder cancer exacts an outsized medical burden. While recent progress has been made in the molecular profiling of bladder cancers and identification of mutated genes, relatively little is known regarding the molecular mechanisms driving the initiation, progression and malignancy of bladder cancer. Furthermore, our understanding of the biological processes of the normal bladder at the molecular, cell and organ levels is limited. Fundamental knowledge of how molecular and cellular functions of the bladder are altered in cancer will aid our understanding of bladder cancer biology and contribute to the future development of new interventions. Applications are encouraged that include one or more co-investigators or co-principal investigators who have committed effort and expertise outside of bladder cancer that is relevant to achieving the project aims.

This NOFO will utilize the Research Project Grant (R01) mechanism and is suitable for projects where proof-of-principle of the proposed technology or methodology has already been established and supportive preliminary data are available.

This NOFO runs in parallel with an NOFO of identical scientific scope, [PAR-22-219](https://grants.nih.gov/grants/guide/pa-files/PAR-22-219.html), which utilizes the Exploratory/Developmental Grant (R21) mechanism.

#### **Background**

*Incidence and survival:* Bladder cancer is expected to claim over 81,000 new cases and over 17,000 deaths in the United States in 2022. About three-quarters of bladder cancer cases occur in men, where it ranks 4th and 8th as the most common cancer in terms of new cases and deaths, respectively. In women, bladder cancer is diagnosed at a later stage. While early-stage bladder cancer has a high survival rate, disseminated late-stage bladder cancer has a 5-year survival rate of 6 percent. Among racial groups, African Americans have lower 5-year survival rates compared to other populations. Bladder cancer incidence has declined 1% each year in the last decade and survival rates, which have been unchanged for decades, have declined almost 2% each year from 2015 to 2019. While these slight declines are encouraging, there is continued need in understanding fundamental bladder cancer biology to further reduce incidence and improve survival.

*Risk factors:* Several etiological factors are linked to bladder cancer. Cigarette smoking is associated with about half of bladder cancers and occupational exposures to chemical carcinogens account for 20-30% of bladder cancers in men and about 10% for women. High-risk occupations include aluminum, rubber and dye manufacturing, painting and dry cleaning. Environmental exposures include arsenic in drinking water, *Schistosoma haematobium* infection and air pollution. In addition to these risk factors, chronic inflammation has been linked to promoting bladder tumorigenesis and malignancy.

*Tumor origin and progression:* Most bladder cancers arise from the uroepithelium, and they represent molecularly and pathologically heterogeneous disease that can be divided into two main subtypes: nonmuscle-invasive bladder cancer (NMIBC), comprising 70-80% of tumors, and muscle invasive bladder cancer (MIBC), constituting 10-20%. NMIBC can originate in luminal cells, which become hyperplastic and give rise to low-grade, papillary tumors. MIBC can arise from basal cells that develop into dysplasia and carcinoma in situ, and progress to invasive and metastatic carcinoma. Patients with NMIBC have a better prognosis than those with MIBC, but the five-year recurrence rate of NMBIC is high (50-70%) and 10-20% of NMIBC progress to MIBC. The cells of origin and pathways of progression for NMIBC and MIBC are not well understood. Understanding the molecular changes that drive NMIBC recurrence or progression would identify tumors that are likely to remain indolent and those likely to advance and require intervention.

*Tumor mutations:* Sequencing studies have identified many significantly mutated genes and genomic alterations. NMIBC is characterized by chromosome 9 deletions, activating mutations in FGFR3, TERT and PIK3CA, and inactivating mutations in STAG2. These alterations are found in MIBC as well but at a lower frequency. MIBC is characterized by features of cell proliferation, genome instability and inactivation of the p53, Pten and Rb pathways. Both tumor groups have inactivating mutations (10-20% frequency) in chromatin-modifying genes including ARID1A, CREBBP, EP300, and KMT2D, indicating that epigenetic changes are central to bladder tumorigenesis. Both groups have high mutational burdens where a large proportion is comprised of APOBEC mutation signatures. High mutation burden as well as high APOBEC load correlate with improved survival, possibly by increased tumor neoantigens that enhance immune surveillance.

*Molecular subtypes:* Expression profiling of bladder cancers has generated different subtypes ranging from two to five groups, depending on the study. All analyses feature luminal and basal groups, but there is less consensus among further subdivisions. NMIBC shows luminal features and one subtype can be distinguished by chromosome 9q deletion, which appears to enhance mTORC1 signaling. MIBC groupings comprise luminal and basal subtypes, as well as additional subtypes with distinct features. Luminal MIBC subtypes include a papillary group that shares features with NMIBC, an infiltrated group characterized by expression of lymphocytic, myofibroblast and EMT markers, and a luminal group that expresses hallmarks of urothelial umbrella cells. Other MIBC subtypes include basal-squamous, which expresses basal, squamous and stem-like markers, and neuronal, which express neuronal or neuroendocrine markers. The basal-squamous and neuronal subtypes are associated with poor prognosis. Currently, little is known about the biology of these molecular subtypes or whether these features are intrinsic characteristics of the tumor or a description of tumor phenotype at a given time.
...
**Research areas of interest for this NOFO include but are not limited to the following:**
...
- Understanding the stromal environment of the normal bladder, including immune cells, extracellular matrix, endothelial cells and fibroblasts, and how these factors contribute to the microenvironment of bladder precancerous lesions, cancer or metastases;
...
All responsive applications must have all or most of the aims devoted to understanding biological aspects of bladder cancer. Projects may include an epidemiological or translational aim, including a clinical trial related to NMIBC, but this aim should complement the overall biological focus.

To promote recruitment of outside investigators to the bladder cancer biology field, applicants are encouraged to include one or more co-investigators or co-principal investigators who have committed effort and expertise outside of bladder cancer that is relevant to achieving the project aims.

#### **Non-Responsive Applications**

Applications with the following attributes will be deemed non-responsive:

- Therapeutic trials with clinical outcomes;
- Clinical trials in MIBC;
- Projects with most or all translational aims.

In addition, projects that examine the response to immunotherapies or the development of treatment resistance, including immunotherapies, are not of high programmatic priority for this funding announcement.

*Applicants are strongly encouraged to contact the program staff listed in the reissue announcement regarding the appropriateness of their project.*
...
Award Budget Application budgets are not limited but need to reflect the actual needs of the proposed project. Award Project Period The maximum project period is 5 years.
...
Email: \[[email protected]\](/cdn-cgi/l/email-protection#deacb4b1b6b0adb1ec9eb3bfb7b2f0b0b7b6f0b9b1a8)
...
- *Significance:* Explain how the project will advance the understanding of bladder cancer biology. Discuss the biological process or fundamental mechanism the project will address and how the work will answer a critical knowledge gap or key question in the biology of bladder cancer.
- *Investigator(s):* Describe how the investigative team is well suited to investigate the biology of bladder cancer. If the team includes expertise outside of bladder cancer, describe how that expertise will contribute to completion of the aims and the projects success.
- *Approach:* Describe unique resources or relevant methods that are well suited to understanding the biology of bladder cancer. Explain how the proposed bladder cancer models are appropriate to the project.
...
Send written disclosures to the NIH Chief Grants Management Officer listed on the Notice of Award for the IC that funded the award and to the[HHS Office of Inspector Grant Self Disclosure Program](https://oig.hhs.gov/compliance/self-disclosure-info/hhs-oig-grant-self-disclosure-program/) at\[[email protected]\](/cdn-cgi/l/email-protection#fc9b8e9d928898958f9f90938f898e998fbc93959bd294948fd29b938a).
...
- Evaluate whether the proposed work applies novel concepts, methods or technologies or uses existing concepts, methods, technologies in novel ways, to enhance the overall impact of the project.
  **Specific to this NOFO:** Evaluate whether the proposed project has the potential to advance the understanding of bladder cancer biology.
...
**Specific to this NOFO:** If the team includes expertise outside of bladder cancer, evaluate whether this expertise contributes to achieving the specific aims and the project's success.
...
Email:\[[email protected]\](/cdn-cgi/l/email-protection#c483b6a5aab0b78daaa2ab84aaadaceaa3abb2)(preferred method of contact)\
Telephone: 301-480-7075

Grants.gov Customer Support (Questions regarding Grants.gov registration and Workspace)\
Contact Center Telephone: 800-518-4726\
Email:\[[email protected]\](/cdn-cgi/l/email-protection#3b484e4b4b54494f7b5c495a554f48155c544d)

Scientific/Research Contact(s)
*(For applications that relate to cancer biology, including carcinogenesis)*\
**Ron Johnson, Ph.D.**
National Cancer Institute (NCI))\
Telephone: 240-276-6250\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#dfadb5b0b7b1acb0ed9fb2beb6b3f1b1b6b7f1b8b0a9)

*(For applications that relate to cancer biology, including tumor microenvironment and progression)*\
**Elisa Woodhouse, Ph.D.**
National Cancer Institute (NCI))\
Telephone: 240-276-6220\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#4d3a2222292522383e28280d202c242163232425632a223b)

*(For applications that relate to cancer prevention)*\
**Howard L. Parnes, M.D.**
National Cancer Institute (NCI)\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#3c4c5d4e52594f547c525554125b534a)

*(For applications that relate to cancer epidemiology)*\
**Tram Kim Lam, Ph.D., M.P.H.**
National Cancer Institute (NCI)\
Telephone: 240-276-6967\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#87ebe6eaf3c7eae6eeeba9e9eeefa9e0e8f1)
...
Financial/Grants Management Contact(s) Amy R. Bartosch\
National Cancer Institute (NCI)\
Telephone: 240-276-6912\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#cbaaa6b2e5a9aab9bfa4b8a8a38ba5a2a3e5aca4bd)
