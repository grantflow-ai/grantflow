<!--
meta-description: NIH Funding Opportunities and Notices in the NIH Guide for Grants and Contracts: Awards Supporting Cutting-Edge Technologies for Translational Science (ASCETTS) (R21 Clinical Trials Not Allowed) PAR-25-157. NCATS
meta-keywords: PAR-25-157: Awards Supporting Cutting-Edge Technologies for Translational Science (ASCETTS) (R21 Clinical Trials Not Allowed)
meta-viewport: width=device-width, initial-scale=1.0
title: PAR-25-157: Awards Supporting Cutting-Edge Technologies for Translational Science (ASCETTS) (R21 Clinical Trials Not Allowed)
-->
...
Funding Opportunity Title Awards Supporting Cutting-Edge Technologies for Translational Science (ASCETTS) (R21 Clinical Trials Not Allowed)Activity Code [R21](//grants.nih.gov/grants/funding/ac_search_results.htm?text_curr=r21&Search.x=0&Search.y=0&Search_Type=Activity) Exploratory/Developmental Research Grant

Announcement Type Reissue of [PAR-23-177](https://grants.nih.gov/grants/guide/pa-files/PAR-23-177.html)\
Related Notices\* **June 5, 2025** - Notice of Extension for PAR-25-157 Awards Supporting Cutting-Edge Technologies for Translational Science (ASCETTS) (R21 Clinical Trials Not Allowed) . See Notice [NOT-TR-25-009](https://grants.nih.gov/grants/guide/notice-files/NOT-TR-25-009.html).
...
Funding Opportunity Number (FON) PAR-25-157Companion Funding Opportunity None Number of Applications See [Section III. 3. Additional Information on Eligibility](#_3._Additional_Information).

Assistance Listing Number(s) 93.350 Funding Opportunity Purpose The National Center for Advancing Translational Sciences (NCATS) invites applications for the Awards Supporting Cutting-Edge Technologies for Translational Science (ASCETTS) Notice of Funding Opportunity (NOFO) to foster investigator-initiated development of highly innovative technologies to address barriers, limitations, or bottlenecks in translational science – particularly for therapeutic development. This program will support the early-stage proof of concept, high-risk and potentially high-reward studies for feasibility and exploratory technology development, which can transform or significantly improve the efficiency of therapeutic development to achieve NCATS ultimate goals - more treatments to all people more quickly. The research proposed should be for the development of technology that can break new ground or extend present technology toward new directions or novel applications. With this initiative, we expect to support the development and/or prototyping of new technologies that will lead to improved efficiency in the therapeutic development pipeline.

## Key Dates

Posted Date December 10, 2024 Open Date (Earliest Submission Date) May 19, 2025 Letter of Intent Due Date(s) Not Applicable

Dates in ***bold and italics*** reflect changes per [NOT-TR-25-009](https://grants.nih.gov/grants/guide/notice-files/NOT-TR-25-009.html).

| **Application Due Dates** | | | **Review and Award Cycles** | | |
| --- | --- | --- | --- | --- | --- |
| **New** | **Renewal / Resubmission / Revision (as allowed)** | **AIDS** | **Scientific Merit Review** | **Advisory Council Review** | **Earliest Start Date** |
| June 19, 2025 | June 19, 2025 | Not Applicable | October 2025 | January 2026 | April 2026 |
| ***June 18, 2026*** | ***June 18, 2026*** | ***Not Applicable*** | ***October 2026*** | ***January 2027*** | ***April 2027*** |

All applications are due by 5:00 PM local time of applicant organization.

Applicants are encouraged to apply early to allow adequate time to make any corrections to errors found in the application during the submission process by the due date.

Expiration Date **New Date** June 19, 2026 per [NOT-TR-25-009](https://grants.nih.gov/grants/guide/notice-files/NOT-TR-25-009.html) (Prior Date June 20, 2025). Due Dates for E.O. 12372 Not Applicable
...
1. Use [Grants.gov](https://grants.gov/search-grants?oppStatuses=closed%7Carchived%7Cposted%7Cforecasted&fon=PAR-25-157) Workspace to prepare and submit your application and [eRA Commons](http://public.era.nih.gov/commons/) to track your application.
...
Therapeutic development is a costly, complex, and time-consuming process. The average length of time from target discovery to approval of a new drug is 10-15 years, and the cost per successful drug can be $1 billion or more. Thus, while humans suffer thousands of diseases, only hundreds of treatments are available, leaving 95% of diseases with no treatment. The National Center for Advancing Translational Sciences (NCATS) at the National Institutes of Health (NIH) strives to develop innovations to reduce, remove or bypass costly and time-consuming bottlenecks in the translational research pipeline in an effort to speed the delivery of new drugs, diagnostics and medical devices to patients.

The Awards Supporting Cutting-Edge Technologies for Translational Science (ASCETTS) funding opportunity aims to facilitate early-stage technology development that is cutting-edge with transformative potential but for which it may be difficult to secure funding. This funding opportunity supports early technology development projects that have a strong rationale and conceptual framework but are still at the first stages where there are little to no preliminary data. The proposed research should focus on prototyping and/or development of technology that is disease agnostic and therefore applicable to broader utilization in therapeutic development and translational research. The technologies developed through this award are expected to fit within a broad range of new and innovative ideas as platform-based approaches. Projects that only address incremental advances in current technology, such as testing only near-term validation studies past the proof-of-concept stage, will not fit this NOFO.

NCATS hopes that many of these concepts can lead to subsequent engagement with industry partners, particularly small businesses, for further development. While the two-year project period may not be sufficient to complete development of the technology, this opportunity is appropriate for development of technologies that could be advanced sufficiently in the two-year project period to garner subsequent support from the NIH or investors outside of the NIH with the ultimate goal of bringing the technology to market.
...
The application must be focused on technology development rather than to immediately address biological questions. Examples could be 1) Platform technology targeting common mechanisms across multiple diseases: Concepts addressing the bottlenecks involved in therapeutic development for multiple diseases, such as cell engineering platforms or drug delivery modalities. 2) Data-driven Technology Solution: Innovative technologies that are driven by large-scale data and will lead to improvements in treatment modalities across a wide range of diseases are encouraged. Database development, data mining tools, and computational modeling applicable to multiple diseases or that shorten the therapeutic development timeline are all examples of technologies that may fit within the expectations of this NOFO.
...
Technologies supported by this NOFO will be expected to improve the translational process for multiple diseases. Successful applications are expected to progress development sufficiently to garner investment in subsequent further development to ultimately bring the technology to market.

The ASCETTS funding opportunity will support development of investigator-initiated breakthrough technology ideas to become marketable applications that not only improve the efficiency of therapeutic development, but also stimulate the development of new fields within translational science.
...
- Applications that propose the study of a specific disease mechanism or the development of technologies that only focus on a single disease
- Any clinical trials or applications that propose clinical studies

Applicants uncertain as to whether their intended technology project meets the requirements of this NOFO are encouraged to contact the Scientific/Research Contact listed below.
...
Resubmission - Resubmission of Applications submitted to PAR-23-177 and this NOFO
...
Award Budget Applications can request budgets that are up to $275,000 direct costs for the 2-year project period of the award. No more than $200,000 direct costs may be requested in any single year.
...
This NOFO is not part of the NIH Small Business Innovation Research (SBIR) and Small Business Technology Transfer (STTR) Programs. Therefore, special provisions provided in the [*NIH Grants Policy Statement*](https://grants.nih.gov/grants/policy/nihgps/HTML5/section_18/18.5_small_business_innovation_research_and_small_business_technology_transfer_programs.htm)under Section 18.5 Small Business Innovation Research and Small Business Technology Transfer Programs do not apply. Additionally, all applicants are subject to NIH pre-award financial analysis and risk assessment reviews.
...
\*\*Other Attachments:\*\*The application must include the following 3 attachments. Please use the filenames suggested below. The filename provided for each document added to the section Other Attachments will be the name used for the bookmark in the electronic application in eRA Commons. Each attachment is limited to 1-page maximum.

*1) Feasibility*\*(1-page maximum)\*

Though preliminary results are not required, a discussion of the feasibility of the planned work must be included, describing the rationale on why the study would work, any potential blockers to completing the proposed work and plans to mitigate or overcome those potential blockers.

This attachment should be titled Feasibility. Applications lacking a*Feasibility*attachment will not be reviewed.

*2) Validation Plan*\*(1-page maximum)\*

A validation plan (i.e., application of the technology to synthetic or well-characterized systems) should be included to demonstrate potential outcomes. A model disease system may be described to demonstrate the concept viability or aid in outcome prediction but is not required.

This attachment should be titled Validation Plan. Applications lacking a*Validation Plan*attachment will not be reviewed.

*3) Future Plans* *(1-page maximum)*

Describe planning for further development that will be needed to bring the technology to market, including any subsequent development that will be needed at the end of this project period.

This attachment should be titled Future Plans. Applications lacking a*Future Plans*attachment will not be reviewed.
...
**Specific Aims:** Specific Aims should propose clear technology development concepts or new platform approaches, which can significantly advance the therapeutic development process and are potentially applicable to multiple disease areas. Examples may include instruments, devices, processes, algorithms, software, chemicals, biomolecules, or cells that have potential value for translational research.

**Research Strategy:**

*Significance*

Applicants must describe  the potential impact of the proposed technology for advancing the current therapeutic development process and the future biomedical applications that would be enabled by this proposed technology. Because this is early-stage exploratory technology development, the impact is not likely to be immediate. Nonetheless, the possible future impact of the proposed technology must be compelling and clearly articulated.

Applicants must describe  how likely the proposed technology to be implemented into current therapeutic processes in a timely and cost-effective manner.

*Innovation*

Applicants must describe  the novelty of the proposed project compared to existing technology, research, and literature with a proof-of-concept to develop prototypes or exploratory technology. The expected project outcome should be a clear test of a concept which can addresses current obstacles in translational research and represents a significant advancement over the current technology.

*Approach*

Applicants must describe  the clear goals and approaches of the proposed study and how to achieve them in two years. Describe those aspects of the experimental approach that are specific to exploratory technology development with clear and measurable objectives. These include the uncertainties underlying the proposed technology research and development, including the risk of failure.
...
Upon receipt, applications will be evaluated for completeness and compliance with application instructions by the Center for Scientific Review and responsiveness by [NCATS , NIH. Applications that are incomplete, non-compliant and/or nonresponsive will not be reviewed.](#_Components_of_Participating)
...
Send written disclosures to the NIH Chief Grants Management Officer listed on the Notice of Award for the IC that funded the award and to the[HHS Office of Inspector Grant Self Disclosure Program](https://oig.hhs.gov/compliance/self-disclosure-info/hhs-oig-grant-self-disclosure-program/) at\[[email protected]\](/cdn-cgi/l/email-protection#88effae9e6fcece1fbebe4e7fbfdfaedfbc8e7e1efa6e0e0fba6efe7fe).
...
Evaluate the quality of the evidence provided that the proposed technology has novel biomedical applications.

Evaluate whether the technology could easily be integrated into current therapeutic development processes.
...
- For clinical trial applications, evaluate whether the study timeline and milestones are feasible.
  ***Specific for this NOFO**:* Evaluate how well the proposed study provides a possible testing strategy for application of the technology. If a model system is being used for proof of concept, evaulate how likely it is that the technology could be utilized, or would benefit, other conditions or areas indicated in the application. Evaluate if the proposed approach is suitable and appropriate to ensure outcomes sufficiently robust to support subsequent steps for the development of the therapeutic, such as for gaining further research funding or implementing technology.
...
Scientific/Research Contact(s) Kihwa Kang, Ph.D.\
National Center for Advancing Translational Sciences (NCATS)\
Telephone: 301-827-5634\
Email:\[[email protected]\](/cdn-cgi/l/email-protection#dbb0b2b3acbaf5b0bab5bc9bb5b2b3f5bcb4ad)
...
Financial/Grants Management Contact(s) Rachel Renee Ratz\
National Center for Advancing Translational Sciences (NCATS)\
Telephone: 301-451-4765\
Email:\[[email protected]\](/cdn-cgi/l/email-protection#98eaf9fbf0fdf4b6eaf9ece2d8f6f1f0b6fff7ee)
...
[Weekly TOC for this Announcement](/grants/guide/WeeklyIndex.cfm?12-13-24)\
