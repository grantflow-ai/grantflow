<!--
meta-description: NIH Funding Opportunities and Notices in the NIH Guide for Grants and Contracts: Grand Opportunity in Medications Development for Substance-Use Disorders (U01 Clinical Trial Optional) PAR-25-328. NIDA
meta-keywords: PAR-25-328: Grand Opportunity in Medications Development for Substance-Use Disorders (U01 Clinical Trial Optional)
meta-viewport: width=device-width, initial-scale=1.0
title: PAR-25-328: Grand Opportunity in Medications Development for Substance-Use Disorders (U01 Clinical Trial Optional)
-->
...
Funding Opportunity Title Grand Opportunity in Medications Development for Substance-Use Disorders (U01 Clinical Trial Optional)Activity Code [U01](//grants.nih.gov/grants/funding/ac_search_results.htm?text_curr=u01&Search.x=0&Search.y=0&Search_Type=Activity) Research Project – Cooperative Agreements

Announcement Type Reissue of [PAR-22-202](https://grants.nih.gov/grants/guide/pa-files/PAR-22-202.html)\
Related NoticesSee [Notices of Special Interest](https://grants.nih.gov/grants/guide/NOSIs_targetingList.cfm?GuideDocID=42235) associated with this funding opportunity
...
Posted Date January 03, 2025 Open Date (Earliest Submission Date) March 10, 2025 Letter of Intent Due Date(s) 30 days prior to the application due date

| Application Due Dates | | | Review and Award Cycles | | |
| --- | --- | --- | --- | --- | --- |
| New | Renewal / Resubmission / Revision (as allowed) | AIDS - New/Renewal/Resubmission/Revision, as allowed | Scientific Merit Review | Advisory Council Review | Earliest Start Date |
| April 10, 2025 | April 10, 2025 | Not Applicable | July 2025 | October 2025 | December 2025 |
...
Expiration Date August 12, 2025 Due Dates for E.O. 12372 Not Applicable
...
1. Use [Grants.gov](https://grants.gov/search-grants?oppStatuses=closed%7Carchived%7Cposted%7Cforecasted&fon=PAR-25-328) Workspace to prepare and submit your application and [eRA Commons](http://public.era.nih.gov/commons/) to track your application.
...
The development of safe and effective medications for the treatment of substance use disorders (SUDs) is a public health priority. Currently, there are medications approved by the Food and Drug Administration (FDA) for the treatment of nicotine and opiate use disorders. However, none of these medications provides the optimal outcomes. Moreover, there are no FDA approved medications for cocaine, methamphetamine, or cannabis use disorders. Thus, the development of safe and effective medications to treat these disorders is an urgent public health need priority. Improving the outcome of treatments for SUDs with medications can have vast public health implications.

Scientific advances are offering extraordinary opportunities for the development of medications to treat SUDs. These include the discovery of genes and proteins, receptors, neurotransmitters, neuromodulators, and brain circuits associated with SUDs, as well as risk and protective factors for the onset and progression of these disorders, and the development of new small and large molecules. Multiple therapeutic approaches, ranging from small molecules to biologics (e.g., vaccines) are ready for the next step in the FDA approval process, and concerted efforts are needed to advance these potential pharmacotherapies to approval. It is likely that effective pharmacotherapies for SUDs will produce immediate reductions in the rates of drug use as well as on its medical and psychosocial consequences.
...
- Preclinical Development: drug interaction studies between medications and drugs of use/misuse and evaluation of safety and/or efficacy in established animal models, as well as pharmacokinetic and pharmacodynamic studies of potential pharmacotherapies for SUDs
...
- Use of Artificial Intelligence/Machine Learning (AI/ML) tools for chemistry, preclinical, and clinical medications development for SUDs. For example, use of AI/ML for de novo design of new molecules, virtual screening and drug-drug interaction studies, or use of AI in clinical trial design/analysis, etc.
...
- Applications that evaluation of the safety and/or efficacy of psychosocial interventions
- Applications that address alcohol as the only substance of use
- Applications that do not focus on the development of compounds for the treatment of SUDs
- Applications that do not provide entry and exit points of the proposed research in the FDA approval pathway.
...
NIH intends to fund an estimate of five awards per year.

Award Budget Application budgets are limited to $5 million per year for direct costs and need to reflect the actual needs of the proposed project.

Award Project Period The maximum period of support is 3 years.
...
The letter of intent should be sent to: \[[email protected].\](/cdn-cgi/l/email-protection#fbb5b2bfbab79e8f8f9e89949db2958f9e958fbb969a9297d5959293d59c948dd5)
...
The applications must describe the entry point at the beginning of the award and the exit point at the end of the award, in the FDA approval pathway.
...
- Evaluate the proposed research in terms of significantly advancing the development of medications in the FDA approval pathway.
...
- The PD/PI agrees to accept close coordination, cooperation, and participation of NIDA staff in those aspects of scientific and technical management of the study as stated in these terms and conditions. Recipients should be advised that they will retain custody of and primary rights to their data developed under the award, subject to current Government policies regarding rights of access consistent with current DHHS, PHS, and NIH policies.
- The PD/PI has the responsibility for medical safety and protection of study participants. The PD/PI has the responsibility to submit to the Program Official for approval a detailed Data and Safety Monitoring Plan (DSMP) for each clinical trial conducted under this award. The DSMP may be developed using Guidelines for Developing a Data and Safety Monitoring Plan at [http://www.drugabuse.gov/funding/clinical-research/guidelines-developing-data-safety-monitoring-plan](http://www.drugabuse.gov/funding/clinical-research/guidelines-developing-data-safety-monitoring-plan). PO's approval of the DSMP is required before any research study with human subjects is implemented. Any changes to the protocol must first be discussed with and approved by the PO before they are implemented. An amended DSMP incorporating approved changes and reflecting the required IRB approval will be submitted to the Program Official for approval before the changes are implemented.
- The PI/PD has the responsibility to report to the Program Official any medical safety issues in the grant. For Serious Adverse Events (SAE), in addition to existing OHRP and institutional requirements, SAEs will be reported directly to the Program Official or through the NIDA Serious Adverse Event Tracking and Reporting System (SAETRS). The Project Scientist will provide access to the PI/PD to the Serious Adverse Event Tracking and Reporting System (SAETRS) at no cost to the grantee. Adverse Events will be reported in the annual progress report.
...
- Recipients are expected to publish and publicly disseminate results, data, and other products of the study, concordant with governance policies and protocols. Publications and oral presentations of work performed under this agreement will require appropriate acknowledgment of support by the NIDA. Timely publication of major findings is encouraged.

**NIH staff have substantial programmatic involvement that is above and beyond the normal stewardship role in awards, as described below:**

- In addition to the Program Officer who will be responsible for normal program stewardship of the grant, the cooperative agreement will be assigned an NIH Project Scientist with expertise in medications development. The Project Scientist will have substantial programmatic involvement that is above and beyond the normal stewardship role in awards and will be named in the award notice.
- The Project Scientist will participate in the definition of objectives and approaches, and in planning, conducting, analyzing, and publishing results, interpretations, and conclusions of their studies. However, the dominant role and prime responsibility for the activity reside with the recipient for the project as a whole, but not necessarily for each task.
- The Project Scientist will serve as a resource to aid in resolving scientific and regulatory issues as they arise.
- The Program Official will be responsible for the programmatic stewardship of the award and will be named in the award notice. The Government, via the Program Official, will have access to data generated under this Cooperative Agreement and may periodically review the data and progress reports. The Program Official may use information obtained from the data for the preparation of internal reports on the activities of the study. However, recipients will retain custody of and have primary rights to all data developed under these awards.
- In order to advance the development of lead compounds, it is expected that recipients will collaborate or cooperate with other NIDA -funded projects and/or U.S. government agencies, for example, CDC, FDA, and/or USDA, and/or industry.

**Areas of Joint Responsibility include:**

- The PD(s)/PI(s) and the Project Scientist will work collaboratively in evaluating the most appropriate research methods, data quality control strategies, medical safety monitoring, protocol design and implementation, data analysis and interpretation and publication and dissemination of study results.
- During performance of the award, the Project Scientist, with assistance from other scientific program staff will provide appropriate scientific advice and guidance. The role of the Project Scientist will be to facilitate and not to direct the activities. Proposals for the design and implementation of each new study will be discussed between the recipient and the Project Scientist before a decision is made to proceed with the study. Both parties shall agree on the most appropriate protocol design and outcome measures for each study. It is anticipated that decisions in all activities will be reached by consensus between the PD/PI and the Project Scientist, and that NIDA staff will be given the opportunity to offer input into this process. The Project Scientist will facilitate liaison activity for partnerships, and provide assistance with access to NIDA-supported resources and services. The recipient and the Project Scientist will confer on the most optimal strategy to ensure and monitor medication compliance.
- Status reports in the format of conference calls between the PI/PD and the Project Scientist will take place on a regular basis. These reports will include information concerning but not limited to results of pre-clinical tests, synthesis or manufacture of compounds, recruitment and retention of subjects, medical safety issues, as well asprogress, obstacles and steps taken to remedy them. Status reports will also discuss the results of each study as they become available.
- The release of each annual funding by NIDA will be based on the NIDA Program Officials review of progress towards achieving the previously agreed upon research goals, interim objectives and milestones. NIDA reserves the right to terminate or curtail a study (or any individual award) in the event of inadequate progress, poor quality, or other major breach of the approved project.
- The specific timelines, interim objectives and funding levels agreed to by the recipient and NIDA shall be included in the terms and conditions of award. Given the nature of product development, it is recognized that timelines and interim objectives may require revision and renegotiation during the course of the project period. The Program Director/Principal Investigator and the Program Official must agree to all such revisions.
...
Scientific/Research Contact(s) Drew Townsend, Ph.D.\
National Institute on Drug Abuse (NIDA)\
Telephone: 301-443-4577\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#13776176643d677c647d60767d77537d7a7b3d747c65)

Ivan Montoya, M.D., M.P.H.\
National Institute on Drug Abuse (NIDA)\
Telephone: 301-827-5936\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#2f464240415b40564e6f424e46430141464701484059)

Evan Herrmann, Ph.D.\
National Institute on Drug Abuse (NIDA)\
Telephone: (301) 827-6406\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#98fdeef9f6b6f0fdeaeaf5f9f6f6d8f6f1f0b6fff7ee)

Peer Review Contact(s) NIDA Review\
National Institute on Drug Abuse (NIDA)\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#a4eaede0e5f4c1c1d6f6c1d2cdc1d3e4cacdcc8ac3cbd2)

Financial/Grants Management Contact(s) Chief Grants Management Officer\
National Institute of Drug Abuse (NIDA)\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#77191e1316101a15121a161e1b37191e131659191e1f59101801)
