<!--
meta-description: NIH Funding Opportunities and Notices in the NIH Guide for Grants and Contracts: Chemical Countermeasures Research Program (CCRP) Initiative: Basic Research on The Deleterious Effects of Acute Exposure to Ultra-Potent Synthetic (UPS) Opioids (R01 Clinical Trial Not Allowed) RFA-DA-26-034. NIDA
meta-keywords: RFA-DA-26-034: Chemical Countermeasures Research Program (CCRP) Initiative: Basic Research on The Deleterious Effects of Acute Exposure to Ultra-Potent Synthetic (UPS) Opioids (R01 Clinical Trial Not Allowed)
meta-viewport: width=device-width, initial-scale=1.0
title: RFA-DA-26-034: Chemical Countermeasures Research Program (CCRP) Initiative: Basic Research on The Deleterious Effects of Acute Exposure to Ultra-Potent Synthetic (UPS) Opioids (R01 Clinical Trial Not Allowed)
-->
...
Funding Opportunity Title Chemical Countermeasures Research Program (CCRP) Initiative: Basic Research on The Deleterious Effects of Acute Exposure to Ultra-Potent Synthetic (UPS) Opioids (R01 Clinical Trial Not Allowed)Activity Code [R01](//grants.nih.gov/grants/funding/ac_search_results.htm?text_curr=r01&Search.x=0&Search.y=0&Search_Type=Activity) Research Project Grant

Announcement Type Reissue of [RFA-DA-23-056](https://grants.nih.gov/grants/guide/rfa-files/RFA-DA-23-056.html)\
...
Funding Opportunity Number (FON) RFA-DA-26-034Companion Funding Opportunity None Number of Applications See [Section III. 3. Additional Information on Eligibility](#_3._Additional_Information).

Assistance Listing Number(s) 93.279, 93.855 Funding Opportunity Purpose This notice of funding opportunity (NOFO) will support research towards understanding and mitigating the deleterious effects of acute exposure to Ultra-Potent Synthetic (UPS) opioids (e.g., fentanyl, carfentanil, nitazenes) and their combinations (e.g., fentanyl and xylazine). This NOFO will also support research on the persistent and/or delayed pathophysiological effects after acute exposure to such agents.

Funding Opportunity Goal(s) To support basic and clinical neuroscience, biomedical, behavioral and social science, epidemiologic, health services and health disparity research. To develop new knowledge and approaches related to the prevention, diagnosis, treatment, etiology, and consequences of drug abuse and addiction, including HIV/AIDS.

## Key Dates

Posted Date November 20, 2024 Open Date (Earliest Submission Date) October 18, 2025 Letter of Intent Due Date(s) 30 days prior to application due date

| Application Due Dates | | | Review and Award Cycles | | |
| --- | --- | --- | --- | --- | --- |
| New | Renewal / Resubmission / Revision (as allowed) | AIDS - New/Renewal/Resubmission/Revision, as allowed | Scientific Merit Review | Advisory Council Review | Earliest Start Date |
| November 18, 2025 | Not Applicable | Not Applicable | March 2026 | May 2026 | July 2026 |
| November 18, 2026 | November 18, 2026 | Not Applicable | March 2027 | May 2027 | July 2027 |
| November 18, 2027 | November 18, 2027 | Not Applicable | March 2028 | May 2028 | July 2028 |

All applications are due by 5:00 PM local time of applicant organization.

Applicants are encouraged to apply early to allow adequate time to make any corrections to errors found in the application during the submission process by the due date.

Expiration Date November 19, 2027 Due Dates for E.O. 12372 Not Applicable
...
1. Use [Grants.gov](https://grants.gov/search-grants?oppStatuses=closed%7Carchived%7Cposted%7Cforecasted&fon=RFA-DA-26-034) Workspace to prepare and submit your application and [eRA Commons](http://public.era.nih.gov/commons/) to track your application.
...
The [Chemical Countermeasures Research Program](https://www.niaid.nih.gov/research/chemical-countermeasures-program) (CCRP) is a trans-NIH initiative supporting mechanistic and pre-clinical research on medical countermeasures (MCMs) towards strengthening national medical and public health preparedness for response to, and recovery from, chemical emergencies.

Ultra-potent synthetic (UPS) opioids derived from the 4-anilinopiperidine scaffold (e.g., fentanyl, carfentanil) and the structurally dissimilar ‘benzimidazoles (aka nitazenes) have been designated as high consequence chemicals of concern (CoC) by the Department of Homeland Security (DHS). Concerns stem from multiple factors that include their highly toxic and addictive properties, ease of synthesis from simple precursor chemicals, and wide availability. Owing to their high *in vivo* potency, rapid onset, and effects on the neurorespiratory system, UPS opioids are considered a public health risk under the ongoing opioid epidemic. Notably, UPS opioids have also been deemed as chemical threats by both military and civilian agencies when there is accidental exposure or when used intentionally, in weaponized form (e.g., aerosolized) on a large-scale. Documented case studies involving civilian casualties and related trace residue analysis on exposed subjects have indicated the presence of UPS opioids, as single agents and in some instances as a mixture of agents.

The UPS opioid fentanyl exhibits a unique pharmacology while behaving as a µ-opioid receptor (µOR) agonist. The dissociation kinetics of fentanyl and congeners differ significantly when compared to that of classical µOR agonists such as morphine. The immediate effects after acute UPS opioid exposure primarily include opioid-induced respiratory depression (OIRD), opioid-induced persistent apnea (OIPA), wooden chest syndrome, decreased brain and nerve function, depressed level of consciousness, and cardiomyopathy, which are often associated with lethality. To add, the nitazene class of compounds have re-emerged as a new and enduring threat. For example, metonitazene overdose has been associated with cardiac arrest while the *in vivo* data for several other nitazenes has indicated that they display higher potencies than fentanyl.

In this context, previously approved µOR antagonists that could reverse some of the deleterious effects of UPS opioids are being repurposed lately in other clinical settings. The short-acting µOR antagonist naloxone, despite its limitations to counter re-narcotization, was approved as a high-dose formulation to protect against potential exposure to weaponized UPS opioids. This product was also meant to protect military personnel and emergency responders entering an area contaminated with such agents. The longer acting µOR antagonist nalmefene was recently relaunched as a nasal spray and as an auto-injector for the emergency treatment of known or suspected opioid overdose. However, the therapeutic utility of these products as broad UPS opioid MCMs may be limited since there is evidence suggesting the involvement of non-µOR mechanisms, secondary targets, and other non-canonical pathways contributing to the severity of symptoms upon exposure. The non-µOR effects of UPS opioids when mixed with other chemical agents (e.g., xylazine), in principle, cannot be reversed by the current standards of care or any of the known µOR antagonists alone.

As with other CoCs, acute exposure to UPS opioids may also lead to long-lasting and delayed health sequelae as a function of direct toxic effects of agents wherein survivors might experience unknown intermediate, persistent and debilitating non-lethal effects (e.g., hypoxic brain injury caused by OIRD and/or OIPA), soft tissue injuries, and organ damage. There is also a knowledge gap on how UPS opioids and combinations of fentanyl mixed with the non-opioid sedative xylazine cause persistent or delayed morbidities involving lasting molecular, cellular, and behavioral changes following acute exposure. To address this issue, the National Institute of Allergy and Infectious Diseases (NIAID) is collaborating with the National Institue on Drug Abuse (NIDA) through the CCRP to support basic research on understanding these adverse health effects and finding solutions towards treating and/or preventing injuries and fatalities caused by their exposure. The goal would be to facilitate the discovery and development of new standalone or concurrent/adjunctive therapies that can be universally effective, scalable, and easily field deployable during mass casualty public emergencies.

**Scientific Research Objectives and Scope**

The overarching goal of this NIDA-NIAID CCRP notice of funding opportunity (NOFO) is to reveal, elucidate and validate mechanisms (e.g., molecular, cellular, genetic, circuitry, structural) and biological pathways (e.g., gene expression, signal transduction, neural, developmental), while introducing novel drug discovery paradigms to address: 1) the deleterious effects and lethal consequences of acute exposure to UPS opioids (e.g., fentanyl, carfentanil, nitazenes) and their chemical combinations (e.g., fentanyl and xylazine) and/or 2) non-lethal, delayed, or persistent pathophysiological effects after acute exposure to such chemical agents.

Applications must be clear in dissociating potential direct toxic effects from long-term effects caused by acute exposure to UPS opioids or their combinations. Additionally, mechanisms secondary to acute effects must be dissociated from direct pharmaco-toxicological effects of the agents/s at the end-organ. Applicants are encouraged to contact the Scientific/Research Contact(s) prior to submission as they may choose to develop their research projects in one or more areas based on their expertise and feasibility.

Representative topics of programmatic interest include:

- Research on the mechanisms underlying the effects of acute UPS opioid exposure (e.g., neurorespiratory depression, neurologic injury, and sudden death).
- Analysis of candidate genes, molecular signatures and signaling pathways; interactions between the pathways and circuits in the context of overdose and acute exposure to agents.
- Deciphering transcriptional alterations of acute exposure; multi?omics analysis and precision approaches to inform mechanisms and functional consequences of overdose and toxicity.
- Research on the etiology and pathophysiology of the non-lethal, persistent, or delayed effects of acute exposure, and long-term effects following apparent recovery from acute effects.
- Studies on mechanisms and markers associated with key physiological processes whose function may be disrupted upon acute exposure (e.g., cardiovascular, hepatic, gastrointestinal, endocrine, immune) including pregnancy and birth outcomes.
- Research on the non-lethal, delayed, or persistent pathophysiological effects after exposure to fentanyl and xylazine.
- Harnessing novel paradigms in drug discovery for defining and validating therapeutic targets; identifying centrally and/or peripherally focused post-exposure reversal/mitigation strategies.

When developing applications, applicants are strongly encouraged to further review the guidelines listed below:

- Applications must include at least one opioid identified as the DHS CoC (e.g., fentanyl, carfentanil, acetylfentanyl, sufentanil, remifentanil, lofentanil, alfentanil, meto-, eto-, isoto-nitazene). Chemicals not on the DHS list may be used as tools to probe mechanisms, but the main research including validation studies must focus on the DHS CoC either as a single agent or as a combination of agents (e.g., fentanyl and xylazine)**.** Information on the Master Question List (MQL; CSAC 21-013) for Synthetic Opioids published by the DHS Science and Technology Directorate (S&T) can be found at: [https://www.dhs.gov/publication/st-master-question-list-synthetic-opioids](https://www.dhs.gov/publication/st-master-question-list-synthetic-opioids).
- Acute UPS opioid exposure may comprise a single sub-lethal dose or a dose equivalent to its LD50 value(s). Alternatively, experiments emulating the dose, route of delivery, rate of administration and/or overall quality of exposure to exemplify a mass casualty event may also be proposed.
- Applications are encouraged to test and validate their mechanistic hypothesis using an appropriate translational post-exposure model (e.g., respiratory depression), while including multiple time points (i.e., to capture acute/immediate and/or delayed/persistent effects).
- To ensure and enhance rigor and reproducibility, applicants are encouraged to propose studies using multiple assays/models and systems(e.g., *in vitro*includingmicrophysiological, *ex vivo,* *in vivo*).
- Applications are allowed to propose new and innovative research involving the µOR; however, the application cannot focus solely on the discovery and testing of orthosteric/direct µOR antagonists.

Prior to submission, applicants are encouraged to contact the Scientific/Research Contact(s) for all questions relating to this NOFO, including questions on the DHS CoC.

**Applications Not Responsive to this NOFO**

The following types of studies are not responsive to this NOFO and will not be reviewed:

- Applications using opioids or other agents that are not on the DHS list of CoC.
- Applications focusing on pain management, substance use disorders (SUD), or behavioral research to improve medication-based treatment programs.
- Efficacy studies, e.g., creation or validation of pre-identified candidate MCMs, without examining the causal mechanisms underlying the effects of overdose and toxicity and/or the delayed or extended pathophysiology stemming from acute exposure.
- Mitigation strategies where antidotes are administered prophylactically or co-administered with UPS opioids; outcomes using chronic or sub-chronic dosing/exposure regimens and paradigms that do not emulate acute UPS exposure.
- Applications focusing solely on the discovery and testing of orthosteric/direct µOR antagonists.
...
Funds Available and Anticipated Number of Awards NIH intends to support up to four awards, corresponding to a total of $2 M in FY 2026. Future year amounts will depend on annual appropriations.

Award Budget Application budgets are limited to $300,000 direct costs per year and need to reflect the actual needs of the proposed project.
...
The letter of intent should be sent to:\[[email protected]\](/cdn-cgi/l/email-protection#6a24232e2b260f1e1e0f18050c23041e0f041e2a070b030644040302440d051c).
...
Applications investigating mechanisms (e.g., molecular, cellular, genetic, circuitry, structural) and biological pathways (e.g., gene expression, signal transduction, neural, developmental), while introducing novel drug discovery paradigms to address: 1) the deleterious effects and lethal consequences of acute exposure to UPS opioids (e.g., fentanyl, carfentanil, nitazenes) and their chemical combinations (e.g., fentanyl and xylazine) and/or 2) non-lethal, delayed, or persistent pathophysiological effects after acute exposure to such chemical agents, are appropriate for this NOFO. Applicants must adhere to the general guidelines listed in the NOFO regarding the scope, and non-responsive criteria. Along with other sections, the following should also be addressed when preparing the application package:

- Adequately address gaps associated with the effects of overdose and toxicity and/or the delayed or extended pathophysiology, stemming from acute exposure to UPS opioids and/or their combinations
- Describe the innovative aspects and the significant advantages that the proposed studies offer over existing data and literature.
- Describe how completion of the research objectives will lead to an improved understanding of the mechanisms of toxicity and overdose associated with relevant agents.
- Describe how completion of the research objectives will lead to identifying an actionable therapeutic target/s and/or reversal/mitigation strategies.
- Applications must clearly describe an experimental plan on testing and validating the proposed mechanistic hypothesis.
- Applications must focus on the opioid/s identified as the DHS CoC
...
Send written disclosures to the NIH Chief Grants Management Officer listed on the Notice of Award for the IC that funded the award and to the[HHS Office of Inspector Grant Self Disclosure Program](https://oig.hhs.gov/compliance/self-disclosure-info/hhs-oig-grant-self-disclosure-program/) at \[[email protected]\](/cdn-cgi/l/email-protection#bed9ccdfd0cadad7cdddd2d1cdcbccdbcdfed1d7d990d6d6cd90d9d1c8).
...
Applications will be evaluated for scientific and technical merit by (an) appropriate Scientific Review Group(s) convened by NIDA, in accordance with[NIH peer review policy and procedures](https://grants.nih.gov/grants/guide/url_redirect.php?id=11154), using the stated review criteria. Assignment to a Scientific Review Group will be shown in the eRA Commons.
...
Email:\[[email protected]\](/cdn-cgi/l/email-protection#5d1a2f3c33292e14333b321d333435733a322b)(preferred method of contact)\
Telephone: 301-480-7075

Grants.gov Customer Support (Questions regarding Grants.gov registration and Workspace)\
Contact Center Telephone: 800-518-4726\
Email:\[[email protected]\](/cdn-cgi/l/email-protection#483b3d3838273a3c082f3a29263c3b662f273e)

Scientific/Research Contact(s) Kiran Vemuri, Ph.D.\
National Institute on Drug Abuse (NIDA)\
Telephone: 301-435-4446\
Email:\[[email protected]\](/cdn-cgi/l/email-protection#f79c9e859699d981929a82859eb7999e9fd9909881)

Dave Yeung, Ph.D.\
National Institute of Allergy and Infectious Diseases (NIAID)\
Telephone: 301-796-7237\
Email:\[[email protected]\](/cdn-cgi/l/email-protection#33574a040345735d5a5b1d545c45)

Peer Review Contact(s) NIDA Review\
National Institute on Drug Abuse (NIDA)\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#135d5a5752437676614176657a7664537d7a7b3d747c65)

Financial/Grants Management Contact(s) Chief Grants Management Officer\
National Institute of Drug Abuse (NIDA)\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#7b15121f1a1c16191e161a12173b15121f1a55151213551c140d)

Tamia Carter\
National Institute of Allergy and Infectious Diseases (NIAID)\
Telephone: (240) 669-2982\
Email:\[[email protected]\](/cdn-cgi/l/email-protection#5a2e3b37333b742a352d3f36361a343332743d352c)
