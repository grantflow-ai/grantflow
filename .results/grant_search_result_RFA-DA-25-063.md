<!--
meta-description: NIH Funding Opportunities and Notices in the NIH Guide for Grants and Contracts: Microglial Pathophysiology in Comorbid Substance Use Disorder (SUD) and HIV (R61/R33 Clinical Trial Not Allowed) RFA-DA-25-063. NIDA
meta-keywords: RFA-DA-25-063: Microglial Pathophysiology in Comorbid Substance Use Disorder (SUD) and HIV (R61/R33 Clinical Trial Not Allowed)
meta-viewport: width=device-width, initial-scale=1.0
title: RFA-DA-25-063: Microglial Pathophysiology in Comorbid Substance Use Disorder (SUD) and HIV (R61/R33 Clinical Trial Not Allowed)
-->
...
Funding Opportunity Title Microglial Pathophysiology in Comorbid Substance Use Disorder (SUD) and HIV (R61/R33 Clinical Trial Not Allowed)Activity Code [R61](//grants.nih.gov/grants/funding/ac_search_results.htm?text_curr=r61&Search.x=0&Search.y=0&Search_Type=Activity)/[R33](//grants.nih.gov/grants/funding/ac_search_results.htm?text_curr=r33&Search.x=0&Search.y=0&Search_Type=Activity) Exploratory/Developmental  Phased Award

Announcement Type Reissue of [RFA-DA-25-014](https://grants.nih.gov/grants/guide/rfa-files/RFA-DA-25-014.html)\
...
Funding Opportunity Number (FON) RFA-DA-25-063Companion Funding Opportunity None Number of Applications See Section III. 3. Additional Information on Eligibility.

Assistance Listing Number(s) 93.279 Funding Opportunity Purpose The purpose of this notice of funding opportunity (NOFO) is to seek applications that examine protein interaction networks in HIV-infected microglia, and how these host-viral interactions contribute to cell type- and brain region-specific alterations in cellular signaling in the context of comorbid HIV and substance use disorder (SUD).

## Key Dates

Posted Date August 23, 2024 Open Date (Earliest Submission Date) July 14, 2025 Letter of Intent Due Date(s) July 14, 2025
...
Expiration Date August 15, 2025 Due Dates for E.O. 12372 Not Applicable
...
1. Use [Grants.gov](https://grants.gov/search-grants?oppStatuses=closed%7Carchived%7Cposted%7Cforecasted&fon=RFA-DA-25-063) Workspace to prepare and submit your application and [eRA Commons](http://public.era.nih.gov/commons/) to track your application.
...
SUDs are a common comorbidity in people with HIV and the co-occurrence of SUD and HIV results in cognitive-behavioral and neuro-pathologies that are distinct from either condition encountered alone. The disruption of neural circuits and region-specific inflammation in brain regions known to play roles in SUD (e.g. basal ganglia, frontal cortex) have been described as shared factors, but the mechanisms underlying this region- and circuit-specific effects produced by SUD in the context of HIV need investigating. Microglia represent a potential link, as they are the principal CNS reservoir for HIV, and even latent viral infection impacts cellular protein dynamics and disrupts signaling processes. Microglia are also involved in the establishment and progression of SUDs through activities such as synaptic pruning, metabolic regulation, and neuromodulatory signaling which impact both neuronal and nonneuronal cellular functions. The interactions of HIV infection and drug-induced alterations in microglial neuroimmune interactions with neurons and other CNS-resident cells are likely key contributors to HIV/SUD pathology. The diversity of signaling pathways and neuroanatomical circuits involved in the complex interactions of substance use and HIV makes it challenging to isolate and validate discrete causal mechanisms and key circuit components. Proteomic techniques have matured to the point where it is feasible to construct quantitative host:viral and host:host protein interaction networks from unbiased profiling of rare cell subpopulations. Applying these approaches to organismal model systems that recapitulate important pathophysiological features in the complex syndromes of HIV and SUD is the goal of this funding opportunity. Focusing on impacts to microglial protein expression and linking those changes to alterations in microglial functions in the context of HIV and SUD will provide a novel pathway towards therapeutic interventions that target the mutual exacerbation of these conditions.

**Research Objectives**

To generate brain region and cell-type specific microglial protein profiles in the context of HIV and SUD, investigators should describe the analytical methods to be employed, and how they will be suited to the model systems and experiment designs necessary to capture the relevant pathophysiological contexts. It is known that HIV co-occurring with SUD produces brain region and cell-type specific functional effects, and that microglia are a crucial linchpin in the complex comorbidity of both conditions. The mechanisms underlying those regions and cell-type specific effects and the role of microglia in their manifestation is a significant knowledge gap. This knowledge deficit can be addressed by profiling microglial protein expression and posttranslational modifications in discrete brain regions in the context of each condition alone and when presented together. These data will then inform mechanistic studies of how the identified disruptions in microglial protein expression and regulation are contributing to neural circuit dysfunctions and what key processes are viable intervention targets. These studies could be performed with human CNS tissue samples, nonhuman primate and/or rodent models; key to the model selection is demonstration of sufficient cellular complexity and regional architecture that captures the critical elements of altered microglial signaling and function. Ultimately this research will yield foundational knowledge that may inform the development of a future HIV cure and therapies for patients with and without SUD.

**Research questions include, but are not limited to:**

- Effects of HIV infection and SUD on protein expression and posttranslational modifications in microglia and neurons of brain region-specific circuits
- Spatial transcriptomic profiles of microglia and other HIV-reactive cells in specific brain regions and/or signaling environments impacted by HIV and SUD
- Effects of human antiretroviral therapy on virus:host and host:host protein interaction networks in microglia and neuroimmune interactions
- Effects of addictive drugs on virus:host and host:host protein interaction networks in microglia and neuroimmune interactions
- Assessment of microglial protein interactions in brain regions and circuits involved in addiction
- Validation of microglial mechanisms of altered neural circuit activity in comorbid SUD and HIV
- Development of innovative approaches to investigate the non-nuclear, subcellular regional transcriptome (e.g., processes and intercellular contact areas), which may not be captured by single cell nuclear RNA sequencing

**Applications not responsive to this NOFO**

The following types of studies are not responsive to this NOFO and will not be reviewed:

1. Approaches relying solely on *in vitro* models of microglia and microglia-interactions.
1. Experiment designs that do not account for repetitive substance use.
1. Studies centered only on alcohol use.
...
Funds Available and Anticipated Number of Awards NIDA intends to commit $2.5M in FY 2026 to fund 3-6 awards.

Award Budget Application budgets are not limited but need to reflect the actual needs of the proposed project.

Award Project Period Projects proposed may not exceed five years of total effort.
...
The letter of intent should be sent to: \[[email protected]\](/cdn-cgi/l/email-protection#4b05020f0a072e3f3f2e39242d02253f2e253f0b25222f2a65252223652c243d)
...
Applications should detail quantitative metrics and milestones based on analytical approaches and biological model systems for project progress assessment. If the application is selected for award, it is anticipated that NIDA program representatives will work with the proposers refining or adjusting these metrics prior to notice of award. Progress towards project goals will be examined by program representatives annually during project performance.
...
Send written disclosures to the NIH Chief Grants Management Officer listed on the Notice of Award for the IC that funded the award and to the[HHS Office of Inspector Grant Self Disclosure Program](https://oig.hhs.gov/compliance/self-disclosure-info/hhs-oig-grant-self-disclosure-program/) at \[[email protected]\](/cdn-cgi/l/email-protection#bcdbceddd2c8d8d5cfdfd0d3cfc9ced9cffcd3d5db92d4d4cf92dbd3ca).
...
Overall Impact Reviewers will provide an overall impact score to reflect their assessment of the likelihood for the project to exert a sustained, powerful influence on the research field(s) involved, in consideration of the following review criteria and additional review criteria (as applicable for the project proposed). An application does not beed to be strong in all categories to be judged likely to have a major scientific impact.
...
Scientific/Research Contact(s) Tristan McClure-Begley, PhD\
National Institute on Drug Abuse (NIDA)\
Phone: 301-451-1467\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#582c2a312b2c393676353b3b342d2a3d753a3d3f343d2118363130763f372e)

Peer Review Contact(s) NIDA Review\
National Institute on Drug Abuse (NIDA)\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#f4babdb0b5a4919186a691829d9183b49a9d9cda939b82)

Financial/Grants Management Contact(s) Chief Grants Management Officer\
National Institute of Drug Abuse (NIDA)\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#8fe1e6ebeee8e2edeae2eee6e3cfe1e6ebeea1e1e6e7a1e8e0f9)
...
[Weekly TOC for this Announcement](/grants/guide/WeeklyIndex.cfm?08-23-24)\
