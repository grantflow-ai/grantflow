<!--
meta-description: NIH Funding Opportunities and Notices in the NIH Guide for Grants and Contracts: Archiving and Documenting Child Health and Human Development Data Sets (R03 Clinical Trial Not Allowed) PAR-25-092. NICHD
meta-keywords: PAR-25-092: Archiving and Documenting Child Health and Human Development Data Sets (R03 Clinical Trial Not Allowed)
meta-viewport: width=device-width, initial-scale=1.0
title: PAR-25-092: Archiving and Documenting Child Health and Human Development Data Sets (R03 Clinical Trial Not Allowed)
-->
...
Funding Opportunity Title Archiving and Documenting Child Health and Human Development Data Sets (R03 Clinical Trial Not Allowed)Activity Code [R03](//grants.nih.gov/grants/funding/ac_search_results.htm?text_curr=r03&Search.x=0&Search.y=0&sort=ac&Search_Type=Activity&text_prev=) Small Grant Program

Announcement Type Reissue of [PAR-24-256](https://grants.nih.gov/grants/guide/pa-files/PAR-24-256.html)\
...
Funding Opportunity Number (FON) PAR-25-092Companion Funding Opportunity None Number of Applications See [Section III. 3. Additional Information on Eligibility](#_3._Additional_Information).

Assistance Listing Number(s) 93.865 Funding Opportunity Purpose The purpose of this notice of funding opportunity (NOFO) is to support the archiving and documentation of existing data sets within the scientific mission of the *Eunice Kennedy Shriver* National Institute of Child Health and Human Development (NICHD) in order to enable secondary analysis of these data by the scientific community. The highest priority is to archive original data collected with NICHD funding.
...
Expiration Date November 17, 2025 Due Dates for E.O. 12372 Not Applicable
...
1. Use [Grants.gov](https://grants.gov/search-grants?oppStatuses=closed%7Carchived%7Cposted%7Cforecasted&fon=PAR-25-092) Workspace to prepare and submit your application and [eRA Commons](http://public.era.nih.gov/commons/) to track your application.
...
The purpose of this notice of funding opportunity (NOFO) is to support the archiving and documentation of existing data sets within the scientific mission of the *Eunice Kennedy Shriver* National Institute of Child Health and Human Development (NICHD) to facilitate secondary analysis of these data by the scientific community. The highest priority is to facilitate the sharing of original data collected with NICHD funding.

**Background**

NICHD leads research and training to understand human development, improve reproductive health, enhance the lives of children and adolescents, and optimize abilities for all. [NICHD's broad and diverse research portfolio](https://www.nichd.nih.gov/research/fundedbyNICHD) supports research related to conception and pregnancy; typical and atypical development in childhood; childhood trauma, injury, and critical illness; the transition from adolescence to adulthood; reproductive health; rehabilitation; intellectual, developmental, and physical disabilities; and population dynamics across the lifespan.

The products of this research include a wide variety of data types and biological samples on a wide array of relevant inputs including imaging, measures related to psychosocial and sociodemographic factors, cognition, genetic and genomic or other -omic data, biomarkers, pregnancy, reproductive health, behavioral medicine, and well-being over the life course. To encourage data sharing, NICHD supports the [Data and Specimen Hub](https://dash.nichd.nih.gov/) (DASH) and [Data Sharing for Demographic Research (DSDR)](http://www.icpsr.umich.edu/icpsrweb/DSDR/ "Link to Non-U.S. Government Site"), which also provides scientific expertise and training in addressing complex data archiving and analysis and supports researchers collecting data and those who wish to use the data. NICHD encourages the use of DASH, DSDR, dbGaP/SRA and other NICHD relevant data repositories that meet NIHs DMS Policy expectations.

Data sharing increases the scientific value of research. NIH encourages researchers to make their data as widely and freely available as possible while safeguarding the privacy of participants and protecting confidential and proprietary data. The details of NIHs data sharing requirements are available on the [NIH Scientific Data Sharing website](https://sharing.nih.gov/). The [NICHD Office of Data Science and Sharing (ODSS)](https://www.nichd.nih.gov/about/org/od/odss) offers several resources for preparing applications consistent with NIH Policy for Data Management and Sharing.

**Scope**

The scope of this initiative includes archiving activities associated with providing access to data that can be used for secondary research within the scientific mission of the NICHD. For the purposes of this announcement, "archiving activities" include activities related to data management and sharing including assembling, cleaning, harmonizing, documenting, creating metadata for, and disseminating data via [submission to an appropriate repository](https://sharing.nih.gov/data-management-and-sharing-policy/sharing-scientific-data/selecting-a-data-repository). Types of data of interest include, but are not limited to: administrative data, survey data, results of assays conducted on bio-specimens, data from clinical trials, data from patient registries, and imaging data. Data from research studies using humans and/or animal models are within the scope of this NOFO.

Proposed activities must protect and maintain confidentiality for research subjects and must include all protections outlined in subject or patient consent forms, if any. Algorithms used for any data cleaning, recoding, and harmonizing activities must be made publicly available. Researchers are expected to maximize the appropriate sharing of scientific data generated from NIH-funded or conducted research, consistent with privacy, security, informed consent, and proprietary issues. Data resources produced with support from this initiative may be available without restriction to researchers or may be subject to restricted access to ensure respondent confidentiality.

To encourage maximum use of all data resources produced by this NOFO, NICHD requires that relevant data, associated metadata, and characterization of sample sources and preparation will be made available to the research community via sharing through an appropriate repository, consistent with achieving the goals of this program. As a term of the award, grantees agree to make final data and documentation broadly available to scientific researchers no later than the end of the award period, as appropriate and consistent with achieving the goals of the program.

**Specific Areas of Interest**

Examples of activities encouraged by this NOFO include, but are not limited to:

- Archiving data from completed clinical trials; in the case of NICHD clinical networks, this includes extracting, cleaning, de-identifying, and sharing data that complements already shared data; for example, electronic health records, images, or other data associated with shared NICHD clinical trial networks datasets
...
- Creating data sets that can be made available to the general scientific community from controlled access data that cannot be made publicly accessible because they include identifying or sensitive information. Examples include creating synthetic data and/or constructing de-identified non-sensitive versions of variables
- Data/results of preliminary/exploratory studies that have not previously been made publicly available
- Archiving data from awards active in FY22 or earlier that plan to submit competing continuations

Applications should propose archiving activities for existing data that are within the scientific mission of NICHD. The highest priority is archiving original data collected with NICHD funding.

**Non-Responsiveness**

The following activities will be considered non-responsive to this NOFO and will not be reviewed:

- Support for freestanding archives or specialty data collections
- Archiving data that are not within the scientific mission of NICHD
- Archiving data for which data collection is not complete at the time of application
- Archiving data to meet the data sharing requirement for grant applications submitted to NIH for the January 25, 2023, and subsequent receipt dates

**Data Dissemination**

Grantees are required to archive and disseminate data through an existing public data archive and are strongly encouraged to submit their data in an NICHD-supported public archive such as the [NICHD Data and Specimen Hub (DASH)](https://dash.nichd.nih.gov/), or [Data Sharing for Demographic Research (DSDR)](http://www.icpsr.umich.edu/icpsrweb/DSDR/ "Link to Non-U.S. Government Site"). For projects generating large-scale human genetic data, applicants should provide a Provisional or Institutional Certification specifying whether the individual-level data can be shared through an NIH approved repository, such as dbGaP and the Sequence Read Archive, in line with the NIH Genomic Data Sharing Policy.
...
Award Budget Application budgets are limited to $50,000 in direct costs per year. Award Project Period The scope of the proposed project should determine the project period. The maximum period is 2 years.
...
The Research Strategy should include a description of the importance of the data resource resulting from this R03 and the proposed plans for data preparation, user documentation, and data sharing.

The application should describe how the data resource resulting from this R03 will address an important problem or critical barrier to scientific progress. Applicants should also describe how the availability of this data resource will support research that will challenge and seek to shift current research or clinical practice paradigms by utilizing novel theoretical concepts, approaches or methodologies, instrumentation, or interventions.

The application should include detailed plans for data preparation, user documentation, and data sharing.  A timeline and milestones for data preparation, user documentation, metadata creation, and deposit in an appropriate archive is a required application element.  Documentation of consent, if appropriate should also be included.

As needed for the research strategy, the applicant may elaborate on the core elements of Data Management and Sharing Plans described in the SF424 (see Other Plans). Additionally, applicants are asked to provide a DMS Plan attachment (see Other Plans) where they will summarize the Elements of a DMS Plan as it relates to this project.

Both the Research Strategy and the DMS Plan will be considered in the peer review and impact score as it relates to the goals of the announcement
...
- Applicants should summarize the Elements of a DMS Plan as it relates to this project.
- The DMS Plan is intended to provide a broad overview of the elements listed in the SF424 Application Guide.  The Research Strategy section should be used to elaborate on details of the Elements in the DMS Plan as appropriate for the proposed project.
...
Send written disclosures to the NIH Chief Grants Management Officer listed on the Notice of Award for the IC that funded the award and to the[HHS Office of Inspector Grant Self Disclosure Program](https://oig.hhs.gov/compliance/self-disclosure-info/hhs-oig-grant-self-disclosure-program/) at\[[email protected]\](/cdn-cgi/l/email-protection#eb8c998a859f8f8298888784989e998e98ab84828cc5838398c58c849d).
...
Evaluate the extent to which the project proposes to create or preserve a data resource that will be available for secondary analyses to address an important problem or critical barrier to scientific progress.

Evaluate the extent to which the project is likely to produce a data resource that will support research that will challenge and seek to shift current research or clinical practice paradigms by utilizing novel theoretical concepts, approaches or methodologies, instrumentation, or interventions.
...
- the plans for data preparation, data documentation and other data archiving activities are well-reasoned and appropriate to accomplish the specific aims of the project
- The planned activities provide adequate data protections and maintenance of confidentiality
- the planned activities provide adequate documentation for secondary users
- the application incorporates elements of NIH Data Management and Sharing Plans, to the extent reasonable and appropriate for the stated aims. Elements of NIH Data Management and Sharing Plans include, but are not necessarily limited to:
  - Data Type
  ...
  - Letter of support from the archive in which the data or biospecimens will be deposited
- the applicant provides a realistic timeline for data preparation and depositing the data in DASH, DSDR, or another existing data repository no later than the end of the award period
...
Scientific/Research Contact(s) Susan M. Jekielek, PhD\
*Eunice Kennedy Shriver* National Institute of Child Health & Human Development (NICHD)\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#51222422303f7f3b343a38343d343a113f38397f363e27)

Peer Review Contact(s) Joanna Kubler-Kielb, PhD\
*Eunice Kennedy Shriver* National Institute of Child Health & Human Development (NICHD)\
Telephone: 301-435-6916\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#8ce7e5e9e0eee6cce1ede5e0a2e2e5e4a2ebe3fa)

Financial/Grants Management Contact(s) Teri Pailen\
*Eunice Kennedy Shriver* National Institute of Child Health and Human Development (NICHD)\
Telephone: 301-979-0142\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#fd8d9c9491989389bd909c9491d3939495d39a928b)
