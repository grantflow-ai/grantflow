<!--
meta-description: NIH Funding Opportunities and Notices in the NIH Guide for Grants and Contracts: Early Stage Investigator HIV/AIDS Research Using Nonhuman Primate (NHP) Models (R21 Clinical Trial Not Allowed) PAR-25-165. ORIP
meta-keywords: PAR-25-165: Early Stage Investigator HIV/AIDS Research Using Nonhuman Primate (NHP) Models (R21 Clinical Trial Not Allowed)
meta-viewport: width=device-width, initial-scale=1.0
title: PAR-25-165: Early Stage Investigator HIV/AIDS Research Using Nonhuman Primate (NHP) Models (R21 Clinical Trial Not Allowed)
-->
...
Funding Opportunity Title Early Stage Investigator HIV/AIDS Research Using Nonhuman Primate (NHP) Models (R21 Clinical Trial Not Allowed)Activity Code [R21](//grants.nih.gov/grants/funding/ac_search_results.htm?text_curr=r21&Search.x=0&Search.y=0&Search_Type=Activity) Exploratory/Developmental Research Grant

Announcement Type Reissue of [PAR-23-215](https://grants.nih.gov/grants/guide/pa-files/PAR-23-215.html)\
...
1. Use [Grants.gov](https://grants.gov/search-grants?oppStatuses=closed%7Carchived%7Cposted%7Cforecasted&fon=PAR-25-165) Workspace to prepare and submit your application and [eRA Commons](http://public.era.nih.gov/commons/) to track your application.
...
Due to their anatomical and genetic similarities to humans, NHPs provide the best representation of natural routes of infection, prevention, and disease for HIV/AIDS among animal models. As a result, NHPs remain the premier preclinical model for HIV/AIDS and are used as the penultimate step before translation of the majority of therapies and interventions in humans. However, research with NHPs presents challenges that do not exist with most other animal models. For example, due to their larger size, longer life span, and enhanced requirements for maintenance and care, work with NHPs incurs much higher expenses than for most other animal models. Additionally, NHPs have specialized care and handling requirements during research that do not exist for most other biomedical models. The high expense and specialized expertise required for NHP research can create a prohibitive barrier for ESIs to explore promising preclinical research directions in the HIV/AIDS field. The purpose of this notice of funding opportunity  is to provide ESIs with adequate funds and independence to initiate preclinical and translational HIV/AIDS research with NHPs. As a consequence of this early support, these ESIs should become competitive for major research awards (e.g., R01) and for transition to independent positions, which will help advance HIV/AIDS researchers trained to use NHPs to fill this national need.

The FY 2021-2025 NIH Strategic Plan for HIV and HIV-Related Research ([https://www.oar.nih.gov/hiv-policy-and-research/strategic-plan](https://www.oar.nih.gov/hiv-policy-and-research/strategic-plan)) identifies several high-priority areas for HIV/AIDS treatment and prevention for which NHP models are highly relevant.

- [Reduce the Incidence of HIV](https://www.oar.nih.gov/hiv-policy-and-research/research-priorities-overview/reduce-incidence-hiv), including supporting the development of safe and effective vaccines, microbicides and pre-exposure prophylaxis.
- [Develop Next-Generation HIV Therapies](https://www.oar.nih.gov/hiv-policy-and-research/research-priorities-overview/next-generation-hiv-therapies) with improved safety and ease of use.
- Conduct [Research Toward HIV Cure](https://www.oar.nih.gov/hiv-policy-and-research/research-priorities-overview/research-toward-hiv-cure).
- [Address HIV-Associated Comorbidities, Coinfections, and Complications](https://www.oar.nih.gov/hiv-policy-and-research/research-priorities-overview/address-hiv-associated-comorbidities-coinfections-complications) through research designed to decrease and/or manage these conditions.
- Advance [Cross-Cutting Areas](https://www.oar.nih.gov/hiv-policy-and-research/research-priorities-overview/cross-cutting-research) of research in the basic sciences, behavioral and social sciences, epidemiology, implementation science, information dissemination, and research training.

The topics of interest to this NOFO  include, but are not limited to:
...
In addition to ORIPs interests, described above, specific research interests of each of the participating Institutes and Centers (ICs) are discussed below.
...
*Nonresponsive:* Studies focused on peripheral viral reservoirs and pathogenesis research not in the context of antiretroviral therapy will not be supported.
...
Award Budget No more than $200,000 in direct costs may be requested in any single year. The combined budget may not exceed $400,000 direct costs for the two-year period.
...
The PD(s)/PI(s) and/or collaborators should have appointments at a NHP facility which can provide NHPs, core facilities, and intellectual resources for using NHPs in HIV/AIDS research, such as a National Primate Research Center or similar. If the PD(s)/PI(s) do not have an appointment at a NHP facility, there should be documentation of a commitment from an appropriate NHP facility to host the research.

#### SF424(R&R) Other Project Information

All instructions in the How to Apply- Application Guide must be followed.

The PD(s)/PI(S) and collaborators should have experience performing preclinical HIV/AIDS research in nonhuman primates.
...
This project should lay the immediate groundwork for translational/clinical HIV/AIDS studies in humans.

The research plan should describe preclinical HIV/AIDS research in nonhuman primates with clear potential translation to humans.
...
Upon receipt, applications will be evaluated for completeness and compliance with application instructions by the Center for Scientific Review and responsiveness by ORIP and/or NIMH, NIH. Applications that are incomplete, non-compliant and/or nonresponsive will not be reviewed.
...
Send written disclosures to the NIH Chief Grants Management Officer listed on the Notice of Award for the IC that funded the award and to the[HHS Office of Inspector Grant Self Disclosure Program](https://oig.hhs.gov/compliance/self-disclosure-info/hhs-oig-grant-self-disclosure-program/) at\[[email protected]\](/cdn-cgi/l/email-protection#137461727d67777a60707f7c6066617660537c7a743d7b7b603d747c65).
...
- Evaluate how likely the project is to lay the immediate groundwork for translational/clinical HIV/AIDS studies in humans.
...
- Evaluate how the research plan describes preclinical HIV/AIDS research in nonhuman primates with clear potential translation to humans.
...
- Evaluate the experience PD(s)/PI(s) and collaborators have in performing preclinical HIV/AIDS research in nonhuman primates.

- Evaluate whether the PD(s)/PI(s) and/or collaborators have appointments at a NHP facility which can provide NHPs, core facilities, and intellectual resources for using NHPs in HIV/AIDS research, such as a National Primate Research Center or similar.

- If the PD(s)/PI(s) do not have an appointment at a NHP facility, evaluate the documentation of a commitment from an appropriate NHP facility to host the research.
...
Scientific/Research Contact(s) Yongjun Sui, PhD\
Office of Research Infrastructure Programs (ORIP)\
Phone: 240-760-6726\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#156c7a7b727f607b3b66607c557b7c7d3b727a63)

Vasudev R Rao, MBBS, MS.\
National Institute of Mental Health (NIMH)\
Telephone: 301-825-3259\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#20564153554445560e52414f604e49480e474f56)
...
Financial/Grants Management Contact(s) Sabrina R. Oasan\
National Heart, Lung and Blood Institute (NHLBI - ORIP Team)\
Telephone: 301-443-9123\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#ccbfadaebea5a2ade2a3adbfada28ca2a5a4e2aba3ba)

Rita Sisco\
National Institute of Mental Health (NIMH)\
Telephone: 301-443-2805\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#61120812020e13210c00080d4f0f08094f060e17)
