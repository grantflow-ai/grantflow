<!--
meta-description: NIH Funding Opportunities and Notices in the NIH Guide for Grants and Contracts: Pilot Health Services and Economic Research on the Treatment of Drug, Alcohol, and Tobacco Use Disorders (R34 Clinical Trial Optional) PAR-25-100. NIDA
meta-keywords: PAR-25-100: Pilot Health Services and Economic Research on the Treatment of Drug, Alcohol, and Tobacco Use Disorders (R34 Clinical Trial Optional)
meta-viewport: width=device-width, initial-scale=1.0
title: PAR-25-100: Pilot Health Services and Economic Research on the Treatment of Drug, Alcohol, and Tobacco Use Disorders (R34 Clinical Trial Optional)
-->
...
Funding Opportunity Title Pilot Health Services and Economic Research on the Treatment of Drug, Alcohol, and Tobacco Use Disorders (R34 Clinical Trial Optional)Activity Code [R34](//grants.nih.gov/grants/funding/ac_search_results.htm?text_curr=r34&Search.x=0&Search.y=0&Search_Type=Activity) Planning Grant

Announcement Type Reissue of [PA-21-180](https://grants.nih.gov/grants/guide/pa-files/PA-21-180.html)\
Related NoticesSee [Notices of Special Interest](https://grants.nih.gov/grants/guide/NOSIs_targetingList.cfm?GuideDocID=42076) associated with this funding opportunity

- **June 3, 2025** - Notice of Change to PAR-25-100, "Pilot Health Services and Economic Research on the Treatment of Drug, Alcohol, and Tobacco Use Disorders (R34 Clinical Trial Optional)". See Notice [NOT-DA-25-039](https://grants.nih.gov/grants/guide/notice-files/NOT-DA-25-039.html).
...
1. Use [Grants.gov](https://grants.gov/search-grants?oppStatuses=closed%7Carchived%7Cposted%7Cforecasted&fon=PAR-25-100) Workspace to prepare and submit your application and [eRA Commons](http://public.era.nih.gov/commons/) to track your application.
...
The National Institute on Drug Abuse (NIDA) Services Research Branch (SRB) supports rigorous research to optimize high-quality personalized substance use treatment, retention, recovery, and other related services to advance sustained recovery from addiction and reduce substance use disorder (SUD)-related harms. SRB research uses a diverse set of methodological research to ensure services are efficiently delivered when and where patients need them across the continuum of recovery.

The purpose of this notice of funding opportunity (NOFO) encourages pilot and preliminary research in preparation for larger-scale, rigorous, services research effectiveness trials on a broad range of approaches at the provider, organizational, system, and/or payer levels for optimizing access to, and the quality, effectiveness, affordability, and utilization of tobacco or substance use disorder treatments and treatments for comorbid medical and mental conditions. Relevant approaches may be those that are novel or those that are commonly used in practice but have an insufficient evidence base supporting their effectiveness.

This NOFO supports pilot testing key components of the research methods likely to be used in a subsequent larger (R01-level) trial. This may include, but is not limited to, developing the trial design; pilot testing and finalizing elements of study protocols (site recruitment; developing and testing incentives and other study supports; randomization procedures; data collection procedures including tests for feasibility of proposed analyses and access to needed administrative or other secondary data); pilot testing the experimental intervention and/or control condition with sites drawn from the intended target population; and developing materials, methods, or platforms necessary to conduct the larger services research trial. The size and scope of the R34 mechanism permit provider, payer, organizational- and systems-level pilot and preliminary studies, which often require more time and resources than are available in smaller developmental mechanisms.

Applications should attend to methods to accelerate the translation of insights generated by the proposed research into practice. Methods such as implementation science, hybrid implementation/effectiveness trials, and dissemination research are critical tools for achieving this acceleration. Applications are strongly encouraged to attend to the following issues in the study design:
...
- Sustainability of the proposed intervention should it prove to be successful, including payment and funding models;
- Health disparities and the relevance to the interventions or services being studied;
- Perspectives of patients or recipients of the services or interventions being studied.

Applicants should collect preliminary data to assess the feasibility of the proposed approach; appropriate individual-, provider-, organization-, or system-level outcomes; and other process and outcome data as needed to inform a subsequent study. Although the R34 is a developmental mechanism, applicants are nevertheless expected to identify hypothesis-driven research questions in the context of a broader conceptual model, which should follow through to the envisioned subsequent R01 trial.

Research Areas of interest include, but are not limited to:

- Novel and adapted service delivery models for treatment, recovery, and harm reduction;
- Implementation interventions designed to enhance uptake of research-supported services in treatment, recovery, and harm reduction;
- Interventions to enhance service engagement and retention for individuals in need of treatment;
- Approaches to reduce stigma-related barriers to service engagement and retention;
- Interventions designed to engage and retain patients in treatment;
- Applications of user-centered design principles to seek patient-driven input to refine and improve services;
- Interventions to improve care quality;
- Interventions to address social dynamics (e.g. , family and peer relationships) that influence service engagement, retention, and recovery;
- Interventions to address social determinants of health that may hinder or facilitate treatment, retention, and recovery;
- Interventions to support more effective and efficient linkages and collaborative care delivery across various service systems or levels of care;
- Interventions and services that specifically target transitions in care, including relapse prevention, aftercare and recovery management;
- Interventions that address the complex interactions of co-occurring pain and SUD s, particularly opioid use disorders;
- Integrated care models that target SUD and co-occurring medical (e.g., HIV, HCV) and psychiatric disorders (e.g., anxiety, depression, suicidality).

Across all areas, the use of technology to more efficiently deliver, target, and personalize existing or adapted interventions is of interest.

Studies may take place in a variety of settings including those in the SUD treatment, general and specialty healthcare including primary and emergency care settings, criminal legal settings, social and human services, pain clinics, pharmacies, workplaces, mental health services; and other community settings. Applicants are encouraged to consider nontraditional service delivery settings when these could potentially broaden the reach of evidence-based services to underserved populations and communities, including NIH-designated health disparity populations and other groups that have historically experienced challenges in access to addiction services.

The sections above outline the scope of science covered under this NOFO as well as some examples of research areas of interest. Investigators are encouraged to review existing NOFOs and Notices of Scientific Interest (NOSIs) for additional details on research areas of interest, access the [NIDA](https://nida.nih.gov/about-nida/organization/divisions/division-epidemiology-services-prevention-research-despr/prevention-research-branch-prb)website, and consult with Program staff in advance of a submission to determine alignment with current priorities (see Scientific Contact below).

**Applications Not Responsive to this NOFO**

The following types of studies are not responsive to this NOFO and will not be reviewed:

- Applications that involve alcohol alone as a substance of use
...
Award Budget Direct costs are limited to $450,000 over the 3-year project period, with no more than $225,000 in direct costs allowed in any single year.

Award Project Period The total project period for an application submitted may not exceed three years.
...
Email:\[[email protected]\](/cdn-cgi/l/email-protection#e0939590908f9294a08792818e9493ce878f96)

Scientific/Research Contact(s) Shelley Su, PhD\
National Institute on Drug Abuse (NIDA)\
Telephone: 301-402-3869\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#7f0c171a13131a06510c0a3f11161751181009)
...
Email: \[[email protected]\](/cdn-cgi/l/email-protection#8be5e2efeaece6e9eee6eae2e7cbe5e2efeaa5e5e2e3a5ece4fd)
