<!--
meta-description: NIH Funding Opportunities and Notices in the NIH Guide for Grants and Contracts: Development of Resources and Technologies for Enhancing Rigor, Reproducibility, and Translatability of Animal Models in Biomedical Research (R01 Clinical Trial Not Allowed) PAR-25-076. ORIP
meta-keywords: PAR-25-076: Development of Resources and Technologies for Enhancing Rigor, Reproducibility, and Translatability of Animal Models in Biomedical Research (R01 Clinical Trial Not Allowed)
meta-viewport: width=device-width, initial-scale=1.0
title: PAR-25-076: Development of Resources and Technologies for Enhancing Rigor, Reproducibility, and Translatability of Animal Models in Biomedical Research (R01 Clinical Trial Not Allowed)
-->
...
Funding Opportunity Title Development of Resources and Technologies for Enhancing Rigor, Reproducibility, and Translatability of Animal Models in Biomedical Research (R01 Clinical Trial Not Allowed)Activity Code [R01](//grants.nih.gov/grants/funding/ac_search_results.htm?text_curr=r01&Search.x=0&Search.y=0&Search_Type=Activity) Research Project Grant

Announcement Type Reissue of [PAR-23-040](https://grants.nih.gov/grants/guide/pa-files/PAR-23-040.html)\
...
Funding Opportunity Number (FON) PAR-25-076Companion Funding Opportunity None Number of Applications See [Section III. 3. Additional Information on Eligibility](#_3._Additional_Information).

Assistance Listing Number(s) 93.351 Funding Opportunity Purpose The Office of Research Infrastructure Programs ([ORIP](https://orip.nih.gov)) encourages research project grant applications aimed at developing and implementing broadly applicable technologies, tools, and resources for validating animal models and enhancing rigor, reproducibility, and translatability of animal research. Research projects submitted under this Notice of  Funding Opportunity (NOFO) should be hypothesis driven with strong preliminary data. Proposed studies, models, resources, or technologies under this NOFO must either address research interests of multiple NIH Institutes and Centers (ICs), explore multiple organ systems, or be applicable to diseases and processes that impact multiple organ systems in order to align with [ORIPs NIH-wide mission](https://orip.nih.gov/strategic-plan) and programs. Applications should aim to enhance the rigor, reproducibility, and translatability of animal research through the development and implementation of technologies, tools, and resources that have significant impact across a broad range of research areas using animal models. Applications must demonstrate how the proposed resources and technologies impact rigor and reproducibility of animal studies.

## Key Dates

Posted Date October 25, 2024 Open Date (Earliest Submission Date) January 05, 2025 Letter of Intent Due Date(s) Not Applicable
...
1. Use [Grants.gov](https://grants.gov/search-grants?oppStatuses=closed%7Carchived%7Cposted%7Cforecasted&fon=PAR-25-076) Workspace to prepare and submit your application and [eRA Commons](http://public.era.nih.gov/commons/) to track your application.
...
The success of developing drugs or therapeutic approaches relies heavily on the use of animal models in preclinical studies. The rigor and reproducibility of animal models have been long recognized as key factors facilitating the translation of findings in animal studies to successful clinical trials. The Office of Research Infrastructure Programs (ORIP) convened a group of experts from broad areas of animal research for a workshop entitled Validation of Animal Models and Tools for Biomedical Research that was held as a series of virtual sessions between November 2020 and January 2021 ([https://orip.nih.gov/about-orip/workshop-reports](https://orip.nih.gov/about-orip/workshop-reports)). This workshop was organized by ORIP in collaboration with the National Heart, Lung, and Blood Institute (NHLBI), the National Institute on Aging (NIA), the National Institute of Diabetes and Digestive and Kidney Diseases (NIDDK), the National Institute of General Medical Sciences (NIGMS), and the National Institute of Neurological Disorders and Stroke (NINDS). The workshop participants identified technology and resource gaps and needs for assessing the value and limitations of animal models and for improving rigor, reproducibility, and translatability of animal research.

**Research Objectives**

With this Notice of Funding Opportunity (NOFO), ORIP intends to support research projects aimed at developing or improving technologies, tools, and resources for validating animal models and improving rigor, reproducibility, and translatability of animal research, which will be broadly applicable to biomedical research involving animal models. Research projects submitted under this NOFO should be hypothesis driven with strong preliminary data. With this NOFO, ORIP seeks research projects aimed at addressing key animal resource- and/or technology-related gaps that were identified in the ORIP-supported Validation of Animal Models and Tools for Biomedical Research workshop. The identified gaps include the need for systematically phenotyping animal models, improved genetic technologies, high-throughput screening, and integration of multiple research organisms. Animal models of interest for this NOFO include, but are not limited to, invertebrate and vertebrate organisms ranging from *C. elegans* and *Drosophila* to zebrafish, mice, rats, pigs, and nonhuman primates.

ORIP advances the NIH mission by supporting research infrastructure and research-related resource programs, including animal models and facilities for research relevant to human health and diseases (for more details see [ORIP Strategic Plan for 2021-2025](https://orip.nih.gov/sites/default/files/ORIP_Strategic_Plan_2021-2025_508.pdf)). Proposed studies, models, resources, or technologies under this NOFO must address research interests of multiple NIH Institutes and Centers (ICs) and must explore multiple organ systems or be applicable to diseases and processes that impact multiple organ systems. Applications must demonstrate how the proposed technologies, tools, and resources impact rigor and reproducibility of animal studies in biomedical research. Applications are not acceptable and will be withdrawn if they only address a specific disease or single area of research, are relevant to the mission and programs of a single IC or are related predominantly to the interest of one IC and only peripherally to the interests of other ICs.

Examples of projects suitable for this NOFO include but are not limited:
...
Projects that ARE NOT suitable for this NOFO and would be deemed nonresponsive and withdrawn include, but are not limited to:
...
Investigators interested in submitting applications are strongly encouraged to contact ORIP program staff (listing in Section VII under Scientific contact) before submission to discuss whether their research plans are appropriate for and responsive to this NOFO. Applications with projects outside areas of interests of this NOFO will be considered nonresponsive and withdrawn.
...
Applicants requesting $500,000 or more in direct costs in any year (excluding consortium F&A) must contact a Scientific/ Research Contact for approval at least 6 weeks before submitting the new, resubmission, or renewal application.

Award Project Period The duration of the proposed project may not exceed five years.
...
The applicant should address how the project will impact or improve validation of animal models, and how the project will impact or improve rigor, reproducibility, and translatability of animal research across broad biomedical research areas.

The applicant should also address whether the approach of developing and validating animal models or related resources is feasible, if the proposed plan is reasonable and feasible, and if the application describes a clear plan to disseminate information and possible future distribution of the proposed resources or research to the scientific community after the project is completed.
...
Upon receipt, applications will be evaluated for completeness and compliance with application instructions by the Center for Scientific Review and responsiveness by ORIP, NIH. Applications that are incomplete, non-compliant and/or nonresponsive will not be reviewed.
...
- Evaluate how the project impacts or improves validation of animal models.

- Evaluate how the project impacts or improves rigor, reproducibility, and translatability of animal research across broad biomedical research areas.
...
Email:\[[email protected]\](/cdn-cgi/l/email-protection#89cefbe8e7fdfac0e7efe6c9e7e0e1a7eee6ff)(preferred method of contact)\
...
Scientific/Research Contact(s) Sige Zou, Ph.D.\
Office of Research Infrastructure Programs (ORIP)\
Phone: 301-435-0749\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#2d5742585e6d404c444103434445034a425b)

Peer Review Contact(s) Elena Smirnova, PhD\
Center for Scientific Review (CSR)\
Telephone: 301-357-9112\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#37445a5e4559584152775a565e5b19595e5f19505841)
