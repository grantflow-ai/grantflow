<!--
meta-description: NIH Funding Opportunities and Notices in the NIH Guide for Grants and Contracts: Integration of Imaging and Fluid-Based Tumor Monitoring in Cancer Therapy (R01 Clinical Trial Optional) PAR-25-175. NCI
meta-keywords: PAR-25-175: Integration of Imaging and Fluid-Based Tumor Monitoring in Cancer Therapy (R01 Clinical Trial Optional)
meta-viewport: width=device-width, initial-scale=1.0
title: PAR-25-175: Integration of Imaging and Fluid-Based Tumor Monitoring in Cancer Therapy (R01 Clinical Trial Optional)
-->
...
Funding Opportunity Title Integration of Imaging and Fluid-Based Tumor Monitoring in Cancer Therapy (R01 Clinical Trial Optional)Activity Code [R01](//grants.nih.gov/grants/funding/ac_search_results.htm?text_curr=r01&Search.x=0&Search.y=0&Search_Type=Activity) Research Project Grant

Announcement Type Reissue of [PAR-21-290](https://grants.nih.gov/grants/guide/pa-files/PAR-21-290.html)\
...
Funding Opportunity Number (FON) PAR-25-175Companion Funding Opportunity None Number of Applications See [Section III. 3. Additional Information on Eligibility](#_3._Additional_Information).

Assistance Listing Number(s) 93.393, 93.395, 93.394 Funding Opportunity Purpose Through this Notice of Funding Opportunity (NOFO), the National Cancer Institute (NCI) invites R01 grant applications describing projects that integrate imaging and fluid-based tumor monitoring (liquid biopsy) assays during cancer therapy in patients to determine the optimal use of these modalities in the characterization of therapy response and/or emergence of treatment resistance.
...
1. Use [Grants.gov](https://grants.gov/search-grants?oppStatuses=closed%7Carchived%7Cposted%7Cforecasted&fon=PAR-25-175) Workspace to prepare and submit your application and [eRA Commons](http://public.era.nih.gov/commons/) to track your application.
...
The purpose of this initiative is to support study design and integration of imaging and fluid-based tumor monitoring analyses into one or more therapeutic settings for assessing treatment success, failure or recurrence. The knowledge gained from this initiative is expected to capture dynamic changes and clinically meaningful indices that contribute to conventional clinical and pathologic information. The long-term goal for research supported through this NOFO will focus on determination of the precise use of imaging and fluid-based tumor monitoring assay combinations during cancer therapy to accurately monitor treatment response and emergence of resistance.

**BACKGROUND AND RATIONALE**

Precision medicine aims to tailor specific treatment to each specific individual with the ultimate goal of improving patient outcomes. Imaging procedures play a critical role in monitoring cancer diagnosis and treatment.  Monitoring tumor molecular and genetic evolution during active treatment is believed to be beneficial in predicting metastatic potential, response, and treatment resistance. Although emerging molecular and functional imaging techniques now enable tumor characterization at the cellular and molecular levels, obtaining multigenetic profiling to select appropriate targeted therapies still requires tumor tissue acquisition. Liquid biopsy has emerged as a breakthrough molecular diagnostic platform with a demonstrated capability for cancer detection and diagnosis and most importantly, for prediction of treatment response. Like imaging, liquid biopsy is minimally invasive and lends itself to serial assessments. However, the sensitivity and specificity of the two modalities in tumor detection often vary depending on tumor location, size, types and treatment settings. Therefore, combination of these two tumor monitoring modalities could be complementary, leading to more accurate monitoring and prediction of tumor treatment response. In cancer treatments of the near future, oncologists will likely move towards monitoring response to therapy with a specific combination of fluid-based (liquid biopsy) and molecular or functional imaging tumor monitoring assays to achieve accurate and rapid assessments of tumor treatment response dynamics.  One of the many hurdles in achieving this vision is to understand how a specific fluid-based tumor monitoring assay may complement and enhance a specific imaging assay, or vice versa, in cancer detection, characterization and monitoring of treatment response across the treatment duration. The sciences of fluid-based tumor monitoring and molecular and functional imaging continue to move forward but in parallel. Advancing their complementarity and synergy  and demonstrating utility with  added value of these combinations in patient care will require an integrated approach and concerted efforts across disciplines.

**RESEARCH OBJECTIVE AND KEY REQUIREMENTS FOR THIS NOFO**

This NOFO is intended to promote collaboration among imaging scientists, fluid-based assay developers and clinical scientists to conduct integrated studies to determine the most appropriate use of imaging and liquid biopsy assays to accurately monitor patient disease and response to therapy during cancer treatment. The precise application of this combination will lead to more accurate determination of therapeutic strategy and identification of the emergence of treatment resistance at the earliest time point.

The specific combination of assays will be dependent on the molecular characteristics of the cancer and the assay detection limits. The goal can be met by a research strategy where liquid biopsy biomarkers that have already entered clinical practice are combined with experimental imaging methods, or conversely, where established clinical imaging methods are combined with experimental liquid biopsy biomarkers.  Importantly, the chosen experimental liquid biopsy and imaging methods must already be developed and validated (e.g., performed on a pre-existing set of human biospecimens with the same disease or condition as that in the proposed validation application) or in final validation (e.g., in any phase of a human clinical trial) that support their clinical utility in diagnosis, prognosis, monitoring, and/or prediction of response to treatment. For this initiative, imaging is defined as any *in vivo* molecular or functional clinical imaging modality. Fluid-based tumor monitoring (liquid biopsy) assay is defined as detection, quantification and characterization of molecular or cellular indicators (e.g., circulating tumor cells, circulating tumor DNA, circulating RNA, exosomes etc) in body fluids, such as blood, CSF, saliva or urine. This NOFO will support clinical studies that propose to include tissue-based assessment for the purpose of establishing correlation to the imaging and liquid biopsy findings.

Funding will support the integration and analysis of imaging and fluid-based tumor monitoring (liquid biopsy) assays into one or more therapeutic settings. **Refer to Research Strategy section listed in Section IV Application Submission and Information for specific instructions in designing and implementing clinical projects that are scientifically rigorous**. Appropriate cancer treatment settings include:

- Clinical trials in which patients are undergoing active treatment for the first recurrence of a cancer with effective second-line treatments and are being monitorred for treatment success, failure, or recurrence;
...
**RESEARCH AREAS OF INTERESTS TO THIS NOFO INCLUDE BUT ARE NOT LIMITED TO THE FOLLOWING:**

Examples of questions in important areas of investigation included in this NOFO include, but are not limited to the following:

- How do imaging and liquid biopsy based tumor monitoring results correlate within each cancer type prior to, during therapy or after treatment?
- What is the minimal liquid biopsy-based monitoring change corresponding with a detectable change in tumor using imaging during treatment and vice versa?
- Are there specific combinations of liquid biopsy and imaging approaches for distinct cancer therapy types?
- Are there circumstances where a combination of imaging and liquid biopsy based tumor monitoring assay results is more powerful than either assay alone?
- Are there cancer types where tumor response or emergence of resistance is detectable by imaging earlier than liquid biopsy based tumor monitoring and vice versa?
- Are there times when routine imaging surveillance in the patients without evidence of molecular residual disease can be substituted with serial monitoring by using liquid biopsy?
- Is there evidence for circumstances where abnormal results on liquid biopsy might be used to prompt imaging assessment?
...
- Early detection in screening setting;
- Pre-clinical development and testing of imaging agents/modalities or fluid-based tumor monitoring (liquid biopsy) assays; and
...
Award Budget Application budgets are limited to less than $500,000 in direct costs per year and the requested amount in any year needs to reflect the actual needs of the proposed project.
...
Email: wangyi1[@nih.gov](/cdn-cgi/l/email-protection#3a5952535b435f545d144d5b545d7a545352145d554c)
...
**Research Strategy.** In this section of the application, the applicants must address each of the following points:

- Justify the choice of patient population;
- Provide evidence that the necessary clinical trial and patient population will be available to the investigators;
- Provide the organizational structure of and communication plans for the study if it involves multiple sites and/or a separate data coordinating center;
- Demonstrate FDA IND/IDE (if applicable) for imaging methods or agents and fluid-based tumor monitoring assays;
- Provide evidence that the clinical trial data will be able to be completed in the 5-year funding time frame;
- Provide rigorous statistical and power analyses to assure that the integration of imaging and fluid-based tumor monitoring results will be clinically meaningful.

**Letter of Support:** Letters of support from clinical partners, research collaborators, or other groups the investigators propose to work with should be included.
...
Send written disclosures to the NIH Chief Grants Management Officer listed on the Notice of Award for the IC that funded the award and to the[HHS Office of Inspector Grant Self Disclosure Program](https://oig.hhs.gov/compliance/self-disclosure-info/hhs-oig-grant-self-disclosure-program/) at\[[email protected]\](/cdn-cgi/l/email-protection#b1d6c3d0dfc5d5d8c2d2dddec2c4c3d4c2f1ded8d69fd9d9c29fd6dec7).
...
- Evaluateto what extent the study population and cancer treatment are appropriate and justified.Evaluate the evidence provided by the applicant that the necessary clinical trial and/or patient population will be available to the investigators and, if relevant, that the clinical trial will be able to be completed in the 5-year funding time frame? If relevant, evaluate whether applicants demonstrated FDA IND/IDE status of imaging methods or agents and fluid-based tumor monitoring assays? Assess to what extent the applicants state the strengths and weaknesses of integrating imaging and liquid biopsy biomarker(s) research strategy in terms of added value in risk assessment and clinical management decisions during treatment monitoring process?  Evaluate whether the applicants provided statistical rationale that the integration of imaging and fluid-based tumor monitoring results will be clinically meaningful? For studies involving genetic/genomic or multi-omics analyses, evaluate whether the plan for biospecimen analysis appropriate and justified?
...
Email:\[[email protected]\](/cdn-cgi/l/email-protection#1d5a6f7c73696e54737b725d737475337a726b)(preferred method of contact)\
Telephone: 301-480-7075

Grants.gov Customer Support (Questions regarding Grants.gov registration and Workspace)\
Contact Center Telephone: 800-518-4726\
Email:\[[email protected]\](/cdn-cgi/l/email-protection#89fafcf9f9e6fbfdc9eefbe8e7fdfaa7eee6ff)

Scientific/Research Contact(s) Yisong Wang, Ph.D.\
National Cancer Institute (NCI)\
Telephone: 240-620-0690\
Email:\[[email protected]\](/cdn-cgi/l/email-protection)

Peer Review Contact(s) Yuanna Cheng, Ph.D.\
Center for Scientific Review (CSR)\
Telephone: 301-435-1195\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#d3b0bbb6bdb4aae693beb2babffdbdbabbfdb4bca5)

Financial/Grants Management Contact(s) Shane Woodward\
National Cancer Institute (NCI)\
Telephone: 240-276-6303\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#8dfae2e2e9faecfffecde0ece4e1a3e3e4e5a3eae2fb)
