<!--
meta-description: NIH Funding Opportunities and Notices in the NIH Guide for Grants and Contracts: NIDCR Small Research Grants for Analyses of Existing Genomics Data (R03 Clinical Trial Not Allowed) PAR-25-166. NIDCR
meta-keywords: PAR-25-166: NIDCR Small Research Grants for Analyses of Existing Genomics Data (R03 Clinical Trial Not Allowed)
meta-viewport: width=device-width, initial-scale=1.0
title: PAR-25-166: NIDCR Small Research Grants for Analyses of Existing Genomics Data (R03 Clinical Trial Not Allowed)
-->
...
Funding Opportunity Title NIDCR Small Research Grants for Analyses of Existing Genomics Data (R03 Clinical Trial Not Allowed)Activity Code [R03](//grants.nih.gov/grants/funding/ac_search_results.htm?text_curr=r03&Search.x=0&Search.y=0&sort=ac&Search_Type=Activity&text_prev=) Small Grant Program

Announcement Type Reissue of [PAR-23-132](https://grants.nih.gov/grants/guide/pa-files/PAR-23-132.html)\
...
1. Use [Grants.gov](https://grants.gov/search-grants?oppStatuses=closed%7Carchived%7Cposted%7Cforecasted&fon=PAR-25-166) Workspace to prepare and submit your application and [eRA Commons](http://public.era.nih.gov/commons/) to track your application.
...
NIDCR is the primary NIH Institute that supports genomic studies relevant to human dental, oral, or craniofacial (DOC) biology, and diseases and conditions. The wealth of data generated by studies funded by NIDCR and others provides unique and cost-effective opportunities to perform large-scale and/or cross-study analyses, improve research reproducibility, and investigate additional DOC research questions.
...
Publicly available genomic data types that can be analyzed together with associated metadata for DOC relevant projects include, e.g., genome-wide single nucleotide variants, whole exome sequences, whole genome sequences, transcriptomic data, epigenomic data, epitranscriptomic data, single cell genomic and expression data, and metagenomic data. In addition, other data types, if complementary to the genomic data used in a project to address the specific aims, can be analyzed along with genomic data. These include metabolomics, proteomics, and various phenotypic data types. These data are available publicly through [FaceBase](https://www.facebase.org/ "Link to Non-U.S. Government Site"), [HOMD](http://www.homd.org/ "Link to Non-U.S. Government Site"), [Gabriella Miller Kids First Data Resource Portal](https://kidsfirstdrc.org/ "Link to Non-U.S. Government Site"), [GDC](https://gdc.cancer.gov/), [NIMH Data Archive](https://nda.nih.gov/), [dbGaP](https://www.ncbi.nlm.nih.gov/gap/), [*All of Us*](https://www.researchallofus.org/ "Link to Non-U.S. Government Site"), and other programs/data sites. Image data, including datasets available at [FaceBase](https://www.facebase.org/ "Link to Non-U.S. Government Site"), [TCIA](https://www.cancerimagingarchive.net/ "Link to Non-U.S. Government Site"), and other publicly available resources, are among data types that can be analyzed in association with genomic data. Other complementary data types include clinical and environmental exposure data (e.g., data from electronic heath records and patient data resources such as those generated by [OCHINs ADVANCE Collaborative](https://ochin.org/advance-network "Link to Non-U.S. Government Site")). Applicants can mine, integrate, and analyze data from multiple studies for a proposed project. Data generated from human study participants, animal models, or *in vitro* studies can all be used for understanding human DOC conditions and traits. Data analysis of each project can be performed using existing and/or novel methods to be developed in the same project, including AI/ML/DL methods.
...
These types of projects are not recommended: 1) projects that will not use any publicly shared data; and 2) projects that do not include any genomic data analysis.

See **Research Strategy** in section IV of this NOFO for specific instructions on proposing a data reuse project under this NOFO.
...
Award Budget The combined budget for direct costs for the two-year project period may not exceed $200,000. No more than $100,000 direct costs may be requested in any single year.

Award Project Period A project duration of up to two years may be requested.
...
**Research Strategy**Describe how the investigators expertise aligns with and is sufficient for the proposed data analyses in the context of DOC biology or health disparities.Articulate how the proposed analyses of the existing data resources will enhance DOC research and/or fill in knowledge gaps in DOC biology, diseases and conditions, or health disparities.\
Justify the selection of data source(s) for the proposed research question(s) addressing human DOC health. Address quality of the data within proposed dataset(s), including relevant variables, data completeness, and how data integration or harmonization (if needed) of data from different sources will be achieved. Clearly describe and justify the proposed approach for validation of results or a newly developed analytic method.

While this NOFO **strongly recommends only** the use of publicly shared datasets, if subsets of data proposed for analysis are appropriately consented for public sharing but not yet shared publicly, and production of the data is under a separate study carried out by the applicant or a different PI, the applicant must provide information about public sharing of the data. For example, the applicant can indicate PI name, grant number, study title of associated grant, and summary of the public data sharing plan in the grant, and an update on data sharing timeline.

If a PI intends to include the reuse of subsets of data that are not and will not be publicly shared, strong justification must be provided, and will be considered during review, e.g., lack of consent for public data sharing of a given data resource and lack of alternative publicly shared data.

**Protections of Human Subjects**
Individuals are encouraged to follow closely the SF424 instructions for preparing the section on Protection of Human Subjects. Research based on existing coded information from humans may or may not be considered human subjects research. Even if the application is not Human Subjects Research, information should be included to address de-identification, confidentiality, and access to the key that deciphers any de-identifying codes.
...
Send written disclosures to the NIH Chief Grants Management Officer listed on the Notice of Award for the IC that funded the award and to the[HHS Office of Inspector Grant Self Disclosure Program](https://oig.hhs.gov/compliance/self-disclosure-info/hhs-oig-grant-self-disclosure-program/) at\[[email protected]\](/cdn-cgi/l/email-protection#8deaffece3f9e9e4feeee1e2fef8ffe8fecde2e4eaa3e5e5fea3eae2fb).
...
Evaluate the likelihood of the project to succeed in analyzing existing data resources to enhance DOC research and knowledge of DOC biology.
...
- Evaluate whether the investigators clearly justified why the proposed datasets are appropriate to answer the proposed DOC research question.

- Evaluate whether the approach adequately considers the quality of proposed datasets, and particularly for datasets from different sources that may not be well integrated.
...
Evaluate whether the project team possesses sufficient expertise in analysis of genomics and associated data in the context of DOC biology.
...
Scientific/Research Contact(s) Noffisat O. Oki, Ph.D.\
National Institute of Dental and Craniofacial Research (NIDCR)\
Telephone: 301-402-6778\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#e08e8f868689938194ce8f8b89a08e8988ce878f96)

Peer Review Contact(s) Yasaman Shirazi, Ph.D.\
National Institute of Dental and Craniofacial Research (NIDCR)\
Telephone: 301-594-5593\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#88d1e9fbe9e5e9e6a6fbe0e1fae9f2e1c8e6e1e0a6efe7fe)

Financial/Grants Management Contact(s) Gabriel Hidalgo\
National Institute of Dental and Craniofacial Research (NIDCR)\
Telephone: 301-827-4630\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#ed8a8c8f9f848881c38584898c818a82ad838485c38a829b)
