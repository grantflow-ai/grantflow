<!--
meta-description: NIH Funding Opportunities and Notices in the NIH Guide for Grants and Contracts: Ancillary Studies to Ongoing Clinical Projects (R21 Clinical Trial Not Allowed) PAR-25-230. NIAMS
meta-keywords: PAR-25-230: Ancillary Studies to Ongoing Clinical Projects (R21 Clinical Trial Not Allowed)
meta-viewport: width=device-width, initial-scale=1.0
title: PAR-25-230: Ancillary Studies to Ongoing Clinical Projects (R21 Clinical Trial Not Allowed)
-->
...
Funding Opportunity Title Ancillary Studies to Ongoing Clinical Projects (R21 Clinical Trial Not Allowed)Activity Code [R21](//grants.nih.gov/grants/funding/ac_search_results.htm?text_curr=r21&Search.x=0&Search.y=0&Search_Type=Activity) Exploratory/Developmental Research Grant

Announcement Type Reissue of [PAR-23-026](https://grants.nih.gov/grants/guide/pa-files/PAR-23-026.html)\
Related NoticesSee [Notices of Special Interest](https://grants.nih.gov/grants/guide/NOSIs_targetingList.cfm?GuideDocID=42082) associated with this funding opportunity
...
- **January 16, 2025** - Notice of Change to PAR-24-289 Ancillary Studies to Ongoing Clinical Projects
  (R01 Clinical Trial Not Allowed). See
  Notice [NOT-AR-25-012](//grants.nih.gov/grants/guide/notice-files/NOT-AR-25-012.html).
...
1. Use [Grants.gov](https://grants.gov/search-grants?oppStatuses=closed%7Carchived%7Cposted%7Cforecasted&fon=PAR-25-230) Workspace to prepare and submit your application and [eRA Commons](http://public.era.nih.gov/commons/) to track your application.
...
Clinical studies, including clinical trials ([https://grants.nih.gov/grants/guide/notice-files/NOT-OD-15-015.html](https://grants.nih.gov/grants/guide/notice-files/NOT-OD-15-015.html)) and clinical observational studies, often represent a substantial financial commitment from the sponsors and enormous effort from the investigators who establish an infrastructure for patient recruitment, examination, and follow-up. Clinical studies offer unique experimental windows to study human disease that are often not fully exploited. Ancillary studies are not part of the original parent project but go beyond the core activities of the original clinical project, thus such studies can explore novel research opportunities offered in the established cohorts and generate new information to enhance the clinical and scientific content of the original project.

This NOFO uses the NIH Exploratory/Developmental Research Grant (R21) award mechanism. Applications in response to this announcement will support innovative projects that may involve considerable risk but may lead to a breakthrough in a particular area with potential for significant impact. Such projects may also develop novel technology or tools that have the potential to significantly accelerate research fields; or may apply methods, technologies or approaches from outside this field of research in a novel way to conduct an important ancillary study. Projects not suitable for this program are ones specifically to develop preliminary data for longer-term projects in a well established research area, or pilot projects that are less than highly innovative. Projects that do not meet these characteristics of innovative, ground breaking research should consider applying for a Research Project Grant (R01) instead, through the accompanying NOFO for NIAMS R01 grants for ancillary studies ([PAR-23-025](https://grants.nih.gov/grants/guide/pa-files/PAR-23-025.html)). Potential applicants are strongly encouraged to contact the appropriate NIAMS Program Director prior to submitting an application to determine the suitability of the project for the R21 mechanism. Preference in funding decisions will be given to projects within NIAMS mission areas that are especially innovative, ground breaking, and have a high potential impact in the relevant fields of research.

#### Objectives

This NOFO solicits grant applications that propose to conduct time-sensitive studies ancillary to privately or publicly funded, ongoing clinical parent projects. The ancillary studies supported under this NOFO should focus on areas that are not studied in the parent project and address new research questions that are related to the mission of NIAMS. (<http://www.niams.nih.gov/About_Us/Mission_and_Purpose/mission.asp>)

The parent projects provide existing resources to facilitate the ancillary research and make it more efficient than initiating another project de novo. The parent projects can be interventional clinical trials, observational clinical studies, or disease-specific repositories that are actively collecting patient samples and/or clinical data. In addition, these clinical projects must provide cohorts with sufficiently well-characterized patients, infrastructure, data, and biological samples. The parent projects must be independently funded by the NIAMS or other NIH institutes or government agencies or private sponsors; they will not receive additional financial support from this NOFO.

The objectives of the parent study need not relate to the NIAMS mission, so long as the parent study provides an appropriate venue for the proposed ancillary study. Information about clinical trials currently supported by a variety of public and private entities can be obtained from [http://www.clinicaltrials.gov/](https://www.clinicaltrials.gov/).

Ancillary studies are encouraged to be mechanistic in nature but can expand to non-mechanistic research. Examples of research may include but are not limited to those listed below under this NOFO. These are only examples and are not meant to be all inclusive:
...
Ancillary studies must not interfere with the parent project or unduly burden participants. Ancillary studies may involve the entire cohort of participants in a parent study or selected subsets, depending on the scientific questions posed and the sample size required to answer them. The ancillary studies may also draw patients from two or more parent projects if they are able to obtain approval from these parent projects and if their research plan is feasible. This NOFO will not support the recruitment of patients who are not already enrolled in the parent study or studies; however, recruitment of a small number of healthy controls is acceptable provided that the cost is minimal (e.g., no more than one budget module).

This NOFO encourages collaboration between basic and clinical investigators and partnership with private entities. In addition, this NOFO encourages junior investigators to take a leading role in clinical research with the support and collaboration of senior investigators. The prospective applicants are not necessarily investigators of the parent study. However, collaborations in which a senior investigator from the parent study supports a junior investigator to serve as PI on an ancillary study are encouraged.

Applicants are invited to visit the NIAMS Ancillary Studies website for answers to frequently asked questions:

[https://www.niams.nih.gov/grants-funding/funding-opportunities/supported-scientific-areas/PAR-ancillary-studies-faqs](https://www.niams.nih.gov/grants-funding/funding-opportunities/supported-scientific-areas/PAR-ancillary-studies-faqs).

Once a parent project clinical protocol is finalized, its investigators often are ready to begin recruiting patients as soon as they obtain Institutional Review Board approval. This time-sensitive feature demands a robust administrative process within NIAMS that is compatible with the timeline of the parent project to avoid any missed research opportunities; an accelerated review and award process would allow the initiation of ancillary studies in a timely fashion to take advantage of the unique resources and well-characterized cohorts established in the parent project. Applications submitted to this NOFOwill be subject to an accelerated peer review and award process.

Examples of characteristics that would support the case for time-sensitivity include (1) the need to collect samples or data prior to the end of recruitment, so that these can be used for immediate or comparative analysis, (2) the need to analyze soon-to-be-collected fresh specimens, or (3) the need to collect post-intervention data from research participants in a trial that is ending.

The Ancillary Studies to Ongoing Clinical Projects R21 NOFO will not accept applications for clinical trials.
...
Applications that do not demonstrate the need for accelerated review and award are considered non responsive to this PAR and will not be reviewed. These applications can be submitted to the Parent R21 ([https://grants.nih.gov/grants/guide/pa-files/PA-20-195.html](https://grants.nih.gov/grants/guide/pa-files/PA-20-195.html)) .

Examples of research that are not responsive to this NOFO include those that do not need to be concurrent with the parent project. The following are examples that will be considered non-responsive and will not be reviewed or considered for funding.
...
Award Budget Direct costs are limited to $400,000 over a two-year period, with no more than $250,000 in direct costs in any single year.
...
Email:\[[email protected]\](/cdn-cgi/l/email-protection#6c22252d213f332023251f2c010d050042020504420b031a)
...
**Research Strategy**: In Significance, the applicant should explain why the proposed ancillary study needs to recruit the cohorts in the identified parent project, as opposed to similar subjects not participating in the parent project. Each application MUST clearly describe the ancillary studys scientific rationale and premise, and indicate the insight to be gained from the proposed study.

The intent of this NOFO is to fund scientifically meritorious applications that efficiently leverage the parent project(s) and demonstrate the need for expedited review and award in order to complete the proposed work. Each application MUST submit a timeline to demonstrate that the parent project has adequate time left for the proposed ancillary study to be carried out. Each application MUST justify the time-sensitive nature of the ancillary study by identifying why an expedited review and award process is essential to its feasibility. These should be clearly stated in a separate and clearly identifiable paragraph titled "Timeline" and "Time-Sensitivity Justification" in the Approach section of the Research Strategy section of the application.
...
**Letters of Support**: All ancillary study applications MUST include a letter or statement from one of the parent study leadership committees with decisional power (i.e., Steering Committee, Scientific Advisory Board, Data Safety Monitoring Board, or other equivalent oversight committee) documenting its approval of the proposed ancillary study. This letter of approval must explicitly state the decisional power of the letter-submitting party for approving the ancillary study, and that the required patient cohorts, samples, data, and biological materials from the parent project are accessible to the ancillary study. The letter should also provide the details of any agreement reached between the parent and ancillary study if there are requirements for limited data access and distribution. It must also provide assurance that there is adequate time left in the parent study for the ancillary study to be carried out. Applications missing the approval letter from the parent study will be considered incomplete.
...
The following modifications to the appendix apply and MUST be included:

- A one-page statement indicating the parent clinical study PD/PI name, funding source, and funding period, and
- A three-page or less synopsis of the parent clinical project(s). The synopsis of the parent clinical project should provide a summary of the parent project with sufficient information to enable the reviewers to assess the ability of the parent project to provide appropriate, sufficient, and well-characterized patients, biological samples and/or clinical data necessary for the ancillary study.

Applications for this NOFOthat fail to include these two items in the Appendix will be considered incomplete and will not be reviewed.
...
Does the proposed ancillary study enhance the scientific content and value of the parent project(s)?
...
Does the application provide an adequate "Timeline" and "Time-Sensitivity Justification"?
...
Email:\[[email protected]\](/cdn-cgi/l/email-protection#aee9dccfc0dadde7c0c8c1eec0c7c680c9c1d8)(preferred method of contact)\
...
Scientific/Research Contact(s) Heiyoung Park, Ph.D.\
National Institute of Arthritis and Musculoskeletal and Skin Diseases (NIAMS)\
Telephone: 301-594-5032\
Email:\[[email protected]\](/cdn-cgi/l/email-protection#7b0b1a0910134a3b161a121755151213551c140d)

Peer Review Contact(s) Kathy Salaita, Sc.D.\
National Institute of Arthritis and Musculoskeletal and Skin Diseases (NIAMS)\
Telephone: 301-594-5033\
Email:\[[email protected]\](/cdn-cgi/l/email-protection#a6d5c7cac7cfd2c7cde6cbc7cfca88c8cfce88c1c9d0)

Financial/Grants Management Contact(s) Teresa N. Do\
National Institute of Arthritis and Musculoskeletal and Skin Diseases (NIAMS)\
Telephone: 301-594-3512\
Email:\[[email protected]\](/cdn-cgi/l/email-protection#a1c5ced5c4e1ccc0c8cd8fcfc8c98fc6ced7)
