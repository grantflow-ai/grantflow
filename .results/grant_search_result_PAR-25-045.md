<!--
meta-description: NIH Funding Opportunities and Notices in the NIH Guide for Grants and Contracts: NIDCR Small Research Grants for Oral Health Data Analysis and Statistical Methodology Development (R03 Clinical Trial Not Allowed) PAR-25-045. NIDCR
meta-keywords: PAR-25-045: NIDCR Small Research Grants for Oral Health Data Analysis and Statistical Methodology Development (R03 Clinical Trial Not Allowed)
meta-viewport: width=device-width, initial-scale=1.0
title: PAR-25-045: NIDCR Small Research Grants for Oral Health Data Analysis and Statistical Methodology Development (R03 Clinical Trial Not Allowed)
-->
...
Funding Opportunity Title NIDCR Small Research Grants for Oral Health Data Analysis and Statistical Methodology Development (R03 Clinical Trial Not Allowed)Activity Code [R03](//grants.nih.gov/grants/funding/ac_search_results.htm?text_curr=r03&Search.x=0&Search.y=0&sort=ac&Search_Type=Activity&text_prev=) Small Grant Program

Announcement Type Reissue of [PAR-22-160](https://grants.nih.gov/grants/guide/pa-files/PAR-22-160.html)\
Related NoticesSee [Notices of Special Interest](https://grants.nih.gov/grants/guide/NOSIs_targetingList.cfm?GuideDocID=42094) associated with this funding opportunity

- **May 1, 2025** - Notice to Extend the Expiration Date of PAR-25-045, NIDCR Small Research Grants for Oral Health Data Analysis and Statistical Methodology Development (R03 Clinical Trial Not Allowed). See Notice [NOT-DE-25-047](https://grants.nih.gov/grants/guide/notice-files/NOT-DE-25-047.html).
...
Funding Opportunity Number (FON) PAR-25-045Companion Funding Opportunity None Number of Applications See Part 2 Section III. 3. Additional Information on Eligibility.

Assistance Listing Number(s) 93.121 Funding Opportunity Purpose The goal of this Notice of Funding Opportunity (NOFO) announcement is to support meritorious research projects that involve secondary data analyses of existing oral or craniofacial database resources, or that develop needed statistical methodology for analyzing existing dental, oral or craniofacial databases.

## Key Dates

Posted Date December 10, 2024 Open Date (Earliest Submission Date) January 16, 2025 Letter of Intent Due Date(s) Not Applicable.
...
Dates in ***bold and italics*** reflect changes per [NOT-DE-25-047](https://grants.nih.gov/grants/guide/notice-files/NOT-DE-25-047.html).

| **Application Due Dates** | | | **Review and Award Cycles** | | |
| --- | --- | --- | --- | --- | --- |
| **New** | **Renewal / Resubmission / Revision (as allowed)** | **AIDS - New/Renewal/Resubmission/Revision, as allowed** | **Scientific Merit Review** | **Advisory Council Review** | **Earliest Start Date** |
| February 16, 2025 * | March 16, 2025 * | May 07, 2025 * | July 2025 | October 2025 | December 2025 |
| ***June 16, 2025 \**** | ***July 16, 2025 \**** | ***September 7, 2025*** | ***November 2025*** | ***January 2026*** | ***April 2026*** |

All applications are due by 5:00 PM local time of applicant organization.

Applicants are encouraged to apply early to allow adequate time to make any corrections to errors found in the application during the submission process by the due date.

Expiration Date **New Date** September 08, 2025 per [NOT-DE-25-047](https://grants.nih.gov/grants/guide/notice-files/NOT-DE-25-047.html) (Prior Date May 08, 2025). Due Dates for E.O. 12372 Not Applicable
...
1. Use [Grants.gov](https://grants.gov/search-grants?oppStatuses=closed%7Carchived%7Cposted%7Cforecasted&fon=PAR-25-045) Workspace to prepare and submit your application and [eRA Commons](http://public.era.nih.gov/commons/) to track your application.
...
This NOFO supports two types of meritorious research projects: 1) secondary data analyses using existing databases relevant to dental, oral, or craniofacial health or practice; and/or 2) development of statistical methodology necessary for improving methods to analyze existing dental, oral, or craniofacial health data.

**Research Objectives**

The NIDCR supports a broad portfolio of clinical trials and large-scale epidemiologic research projects that collect extensive data to fulfill each project's specific aims. The resultant wealth of data generated by these studies often provides unique, cost-effective opportunities to investigate additional research questions or develop improved analytical approaches secondary to a project's originally intended purpose. This NOFO is designed to provide investigators with the support necessary to conduct such secondary data analyses or to develop new statistical methods for analyzing dental, oral, or craniofacial health data utilizing existing database resources. Research aims in these applications may be related to, but must be distinct from, the specific aims of the original data collection.

Dental, oral, and craniofacial data may be derived from NIDCR-funded studies or from other sources. The analyses may integrate multiple existing data sources, such as electronic dental and medical records, registries, health tracking devices, pharmacy, insurance, emergency services, environmental, laboratory, imaging, or other data. Existing video or audio data may also be appropriate for answering clinical, functional, behavioral, social, or implementation research questions. Applications may propose analyses of different types of studies, including, but not limited to: large-scale cohort studies, natural experiments, comparative effectiveness research, health economics or cost effectiveness studies, process or mechanistic research, etc.

Applications proposing data analysis and statistical methodology applied to genomics data are not appropriate for this NOFO, and should instead respond to PAR-23-132 ([https://grants.nih.gov/grants/guide/pa-files/PAR-23-132.html](https://grants.nih.gov/grants/guide/pa-files/PAR-23-132.html)) or its reissues.
...
Applications may also propose new data science and statistical methodologies for analyzing dental, oral, and craniofacial health data. However, the need for and applicability of any proposed new statistical methodologies to oral and craniofacial research must be justified, and the new methodology must be applied to one or more datasets relevant to dental, oral or craniofacial health or practice.

For applications focusing on behavioral and social sciences, priority will be given to studies that help to identify the causal mechanisms of behavior change or mechanisms of action of an intervention as opposed to correlates, predictors, risk and protective factors, etc. This emphasis on identifying causal mechanisms means that certain local, state, or national surveys may not be appropriate sources of data for some research questions. Also, applicants are encouraged to consider a range of data sources to test causal explanations for oral health behavior, for example, audiotaped or videotaped sessions, provided informed consents/assents are secured. Given that behavioral and social factors important in oral health are also important in other health conditions, data sets about nutrition, health education or promotion, parenting, tobacco use, adherence to provider recommendations, organizational behavior, etc., also may be relevant data sources. Additional information about the priorities of NIDCR's Behavioral and Social Sciences Research Branch can be found at the Behavioral and Social Sciences Research Program web page ([https://www.nidcr.nih.gov/grants-funding/grant-programs/behavioral-social-sciences-research-program](https://www.nidcr.nih.gov/grants-funding/grant-programs/behavioral-social-sciences-research-program)).

Applicants should also consider the relevance of their proposed analyses to NIDCR programs and priorities as described in the "NIDCR Strategic Plan" (<http://www.nidcr.nih.gov/Research/ResearchPriorities/StrategicPlan/>).
...
Award Budget A budget for direct costs of up to $100,000 per year, with a maximum of $200,000 direct costs over two years, may be requested.

Award Project Period The total project period for an application submitted in response to this funding opportunity may not exceed two years.
...
Research Strategy. Under the heading of Research Strategy, applications should include the following:

- A clear justification of why the data source is appropriate to answer the proposed research question(s);
- A description of the quality of the proposed dataset(s), including the presence of relevant variables, completeness, bias, and any methods that will be used to control or account for deficiencies;
- A well-justified timeline of study activities; and
- For applications proposing to develop new methodologies, a compelling justification for the need to improve future analyses of dental, oral or craniofacial data.

Protection of Human Subjects. Individuals are encouraged to closely follow the SF424 guidelines for addressing Human Subjects Research, in particular sections on the use of secondary data. Even if the application is not Human Subjects Research, information should be included to address de-identification, confidentiality, and access to the key that deciphers any de-identifying codes.

**Resource Sharing Plan**: Individuals are required to comply with the instructions for the Resource Sharing Plans as provided in the How to Apply- Application Guide.

- All applications that include development of new statistical analysis methods should include a Data Sharing Plan that describes the plan for disseminating newly-developed statistical analysis methods and tools.
...
The R03 small grant supports discrete, well-defined projects that realistically can be completed in two years and that require limited levels of funding. Because the research project is usually limited, an R03 grant application may not contain extensive detail or discussion. Accordingly, reviewers should evaluate the conceptual framework and general approach to the problem. Appropriate justification for the proposed work can be provided through literature citations, data from other sources, or from investigator-generated data. Preliminary data are not required, particularly in applications proposing pilot or feasibility studies.
...
- Evaluate if new statistical methodologies are proposed, evaluate the evidence that these new methodologies are needed to improve future analyses of dental, oral, or craniofacial research data.

- Evaluate the potential of the proposed secondary analyses to provide novel insight into dental, oral or craniofacial health problems rather than confirm previous findings.
...
- Evaluate the quality of datasets for addressing the studys proposed specific aims.

- Evaluate adequacy of methods to identify, control, and account for missingness and bias in datasets.

- Evaluate the appropriateness of the study timeline and concrete deliverables for accomplishing the specific aims.
...
Take into consideration the responses to comments from the previous Scientific Review Group.
...
Applications will be evaluated for scientific and technical merit by (an) appropriate Scientific Review Group(s) convened by the National Institute of Dental and Craniofacial Research, in accordance with NIH peer review policies and practices, using the stated review criteria. Assignment to a Scientific Review Group will be shown in the eRA Commons.
...
Email:\[[email protected]\](/cdn-cgi/l/email-protection#793e0b18170d0a30171f1639171011571e160f)(preferred method of contact)\
Telephone: 301-480-7075

Grants.gov Customer Support (Questions regarding Grants.gov registration and Workspace)\
Contact Center Telephone: 800-518-4726\
Email:\[[email protected]\](/cdn-cgi/l/email-protection#5a292f2a2a35282e1a3d283b342e29743d352c)

Scientific/Research Contact(s) Lorena Baccaglini, DDS, MS, PhD\
National Institute of Dental and Craniofacial Research (NIDCR)\
Telephone: 301-435-7908\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#cca0a3bea9a2ade2aeadafafadaba0a5a2a58ca2a5a4e2aba3ba)

For questions related to behavioral and social sciences research, contact:

William Elwood, PhD\
National Institute of Dental and Craniofacial Research (NIDCR)\
Telephone: 301-402-0116\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#224e4d50474c430c4043414143454e4b4c4b624c4b4a0c454d54)

Peer Review Contact(s) Yasaman Shirazi, Ph.D.\
National Institute of Dental and Craniofacial Research (NIDCR)\
Telephone: 301-594-5593\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#ca93abb9aba7aba4e4b9a2a3b8abb0a38aa4a3a2e4ada5bc)

Financial/Grants Management Contact(s) Gabriel Hidalgo

National Institute of Dental and Craniofacial Research (NIDCR)\
Telephone: 301-827-4630\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#136b6b6b6b537e727a7f3d7d7a7b3d747c65)
