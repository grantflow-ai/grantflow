<!--
meta-description: NIH Funding Opportunities and Notices in the NIH Guide for Grants and Contracts: New Approaches for Measuring Brain Changes Across Longer Timespans (R01 Clinical Trial Optional) PAR-25-279. NIA
meta-keywords: PAR-25-279: New Approaches for Measuring Brain Changes Across Longer Timespans (R01 Clinical Trial Optional)
meta-viewport: width=device-width, initial-scale=1.0
title: PAR-25-279: New Approaches for Measuring Brain Changes Across Longer Timespans (R01 Clinical Trial Optional)
-->
...
Funding Opportunity Title New Approaches for Measuring Brain Changes Across Longer Timespans (R01 Clinical Trial Optional)Activity Code [R01](//grants.nih.gov/grants/funding/ac_search_results.htm?text_curr=r01&Search.x=0&Search.y=0&Search_Type=Activity) Research Project Grant

Announcement Type Reissue of [PAR-24-160](https://grants.nih.gov/grants/guide/pa-files/PAR-24-160.html)\
...
Posted Date November 25, 2024 Open Date (Earliest Submission Date) January 05, 2025 Letter of Intent Due Date(s) Not applicable
...
1. Use [Grants.gov](https://grants.gov/search-grants?oppStatuses=closed%7Carchived%7Cposted%7Cforecasted&fon=PAR-25-279) Workspace to prepare and submit your application and [eRA Commons](http://public.era.nih.gov/commons/) to track your application.
...
- Technological or analytic methods to track growing brain regions or to measure changes in structure or function
- Software/computational tools to harmonize repeated measurements from the same individual across the lifespan
- Modifications to magnetoencephalogram (MEG), electroencephalogram (EEG), magnetic resonance imaging (MRI), or other neuroimaging modalities to enable more accurate longitudinal studies across the lifespan, especially in hard-to-image populations such as those with autism, motor or sensory disorders, or others for whom current imaging technologies may be logistically challenging
- Tools for tracking different cell types, excitatory-inhibitory balance, or neurotransmitter systems across life stages in mammals, especially primates
- Computational analytic techniques to track developmental changes in information processing capabilities such as via local field potential (LFP) synchrony in specific frequency bands
- Tools for linking molecularly defined cell types to brain connectivity from early timepoints to older age
- Methods to assess the role of specific cell populations in driving neoteny in some mammalian brain regions, and the role this may play in human brain disorders
- Constructing and testing computational models to predict how earlier developmental parameters in cell fate specification, migration, myelination, neurotransmitter release, or neural activity patterns lead to later cognitive, affective, or social outcomes

All projects must include a methods development aim and a hypothesis testing aim. Applications are required to include at least two timepoints in each participant or animal.
...
- Studies that do not include a methods development aim and a hypothesis testing aim
- Studies without two timepoints
- Studies using invertebrate animal models
- Projects that do not include a scientific project to demonstrate how the methodology expands brain measurement capacity across the lifespan
...
NCI supports cancer health disparity research focused on basic, hypothesis-driven studies that explicitly address the unequal burden of cancer among racial/ethnic minorities or other underserved populations across the cancer continuum (prevention, early detection, diagnosis, treatment, and survivorship).
...
- Evaluate whether the proposed work applies novel concepts, methods or technologies or uses existing concepts, methods, technologies in novel ways, to enhance the overall impact of the project.
  ***Specific to this NOFO:***
  Evaluate how significantly the project will improve the ability to collect and/or analyze brain measures across longer time periods for the same participants/animals.

Evaluate how well the hypothesis-testing aim demonstrates the utility of the new technology, and how well it addresses an important scientific question.
...
Evaluate the appropriateness of the project's methods development aim and hypothesis testing aim.

Evaluate whether data has been collected for at least two time periods that are meaningfully separated in time. Evaluate whether at least one of the time periods is during prenatal, juvenile, or advanced age.

Evaluate how clearly the application indicates the exploratory vs. confirmatory components of the study, considers study limitations, provides clear rationale for the chosen model(s) and primary/secondary endpoint(s), and provides clear descriptions of tools and parameters.

Evaluate whether the proposed work develops new methods or advances existing methods to extend measurement of the brain over longer periods than currently feasible, and tests hypotheses demonstrating the utility of the new approach and addressing an important scientific question.

Evaluate how adequately the application describes whether prior research that serves as the key support for the proposed project employed rigorous practices such as minimization of potential experimenter biases, robust experimental designs, transparent reporting of results and analyses, and careful interpretation. Evaluate how adequately the application describes ambiguity, weaknesses, or limitations in rigor of the prior research, if applicable.

Evaluate the strength of the statistical analysis plan.
...
Email:\[[email protected]\](/cdn-cgi/l/email-protection#0f487d6e617b7c466169604f61666721686079)(preferred method of contact)\
...
Scientific/Research Contact(s) Elizabeth Newman, Ph.D.\
National Institute on Aging (NIA)\
Telephone: 301-480-7937\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#d9a1a1a1a199b4b8b0b5f7b7b0b1f7beb6af)

Laura Stoner Machlin\
*Eunice Kennedy Shriver*National Institute of Child Health and Human Development (NICHD)\
Phone: 301-827-6575\
E-mail: \[[email protected]\](/cdn-cgi/l/email-protection#a5c9c4d0d7c48bc8c4c6cdc9cccbe5cbcccd8bc2cad3)
...
Phone: (301) 594-5220\
E-mail: \[[email protected]\](/cdn-cgi/l/email-protection#2e42475b496e434f47420040474600494158)
...
Financial/Grants Management Contact(s) Robin Laney\
National Institute on Aging (NIA)\
Telephone: 301-496-1473\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#d9abb6bbb0b7f7b5b8b7bca099b7b0b1f7beb6af)

Margaret Young\
*Eunice Kennedy Shriver*National Institute of Child Health and Human Development (NICHD)\
Telephone: 301-642-4552\
Email:\[[email protected]\](/cdn-cgi/l/email-protection#d5b8b4a7b2b4a7b0a1fbacbaa0bbb295bbbcbdfbb2baa3)
