<!--
meta-description: NIH Funding Opportunities and Notices in the NIH Guide for Grants and Contracts: NCI Research Specialist (Laboratory-based Scientist) Award (R50 Clinical Trial Not Allowed) PAR-23-242. NCI
meta-keywords: PAR-23-242: NCI Research Specialist (Laboratory-based Scientist) Award (R50 Clinical Trial Not Allowed)
meta-viewport: width=device-width, initial-scale=1.0
title: PAR-23-242: NCI Research Specialist (Laboratory-based Scientist) Award (R50 Clinical Trial Not Allowed)
-->
...
Funding Opportunity Title NCI Research Specialist (Laboratory-based Scientist) Award (R50 Clinical Trial Not Allowed)Activity Code [R50](//grants.nih.gov/grants/funding/ac_search_results.htm?text_curr=r50&Search.x=0&Search.y=0&sort=ac&Search_Type=Activity&text_prev=) Research Specialist Award

Announcement Type Reissue of [PAR-22-187](https://grants.nih.gov/grants/guide/pa-files/PAR-22-187.html)\
...
Notice of Funding Opportunity (NOFO) Number PAR-23-242Companion Funding Opportunity [PAR-23-243](https://grants.nih.gov/grants/guide/pa-files/PAR-23-243.html), [R50](https://grants.nih.gov/grants/funding/ac_search_results.htm?text_curr=R50&&Search.x=0&&Search.y=0&&Search_Type=Activity)Research Specialist Award
Number of Applications See [Section III. 3. Additional Information on Eligibility](#_3._Additional_Information).

Assistance Listing Number(s) 93.393, 93.395, 93.394, 93.396, 93.397, 93.398, 93.399 Funding Opportunity Purpose This notice of funding opportunity (NOFO) invites grant applications for the Research Specialist Award (R50) in any area of NCI-funded cancer research. This NOFO is specifically targeted toward laboratory-based scientists.
...
Posted Date August 09, 2023 Open Date (Earliest Submission Date) October 02, 2023 Letter of Intent Due Date(s) 30 days prior to the application due date .
...
Expiration Date November 04, 2025 Due Dates for E.O. 12372 Not Applicable
...
1. Use [Grants.gov](https://grants.gov/search-grants?oppStatuses=closed%7Carchived%7Cposted%7Cforecasted&fon=PAR-23-242) Workspace to prepare and submit your application and [eRA Commons](http://public.era.nih.gov/commons/) to track your application.
...
#### **Unit Director of Laboratory Research Program**
...
Award Budget Application budgets may request the following two expenses in direct costs per year:
...
Award Project Period The total award project period may not exceed 5 years.
...
#### ***Additional Unit Director Requirements:***

- The Unit Director must be the PD/PI of an NCI-funded research grant that will have at least 1 full funding year remaining (exclusive of no cost extension and supplements) in the current competitive segment at the time the R50 is awarded.
- The Unit Directors above stated NCI funded grant(s) must include the effort of Research Specialist and the Unit Director must be committed to both the Research Specialist and the Research Specialist's research.
- Only one (1) Unit Director may be designated on the application. Applications that list more than one (1) Unit Director, or in which the Unit Director does not indicate eligible NCI grant support will not be reviewed.
- Unit Director must include a Biosketch with the R50 application.
...
Email: \[[email protected]\](/cdn-cgi/l/email-protection#a3e8c6cfcfda8dc0d1ccd7d7dae3cdcacb8dc4ccd5)
...
1. Funds on the Unit Director's award(s) that are freed up through the R50 will be restricted from any other use without NCI prior approval. Freed up funds cannot be requested for Personnel costs, however freed up funds could be requested for other research cost items.
1. The Unit Director's competitive renewal application should not include the research specialist position and associated salary and fringe benefits. If requested, those funds will not be included in the award if the application is funded.
1. The requested salary support for the Research Specialist may not exceed the level of effort and salary supported on the Unit Director's NCI-funded research grants (where the Unit Director is the PD/PI) during the relevant Federal Fiscal Year stated in Eligibility section . A Research Specialist is required to maintain at least 6 person-months of his/her effort on NCI-funded research grant(s).
1. The application may include a request for travel funds, but no research expenses. Research expenses must be covered from other sources such as separate R01, P01, or P50 grants awarded to the Institution.
1. A Research Specialist would have the option, with prior NCI approval, to move to another research program or institution (e.g., if the Unit Director's laboratory is closed, if the institution closes a core, etc.).
1. If the Research Specialist applies for future NCI research support, the Research Specialist Award will be taken into consideration in making funding decisions if ESI status is claimed.
1. The R50 must be relinquished if any other independent grant support is obtained by the Research Specialist.
1. The R50 Unit Director must continue to report the Research Specialist as a Participant on any NCI-funded grant on which the Research Specialist dedicates effort.
1. Award of the R50 (including support recommended for future years) will be contingent upon the Research Specialist's Unit Director being supported by an NCI-funded research grant(s) and upon the Research Specialist devoting 6 person-months to NCI-funded research grants.
1. Change of PD/PI will not be allowed on the R50.
...
Email:\[[email protected]\](/cdn-cgi/l/email-protection#96e5e3e6e6f9e4e2d6f1e4f7f8e2e5b8f1f9e0)

Scientific/Research Contact(s) Kelly Crotty, Ph.D.\
National Cancer Institute (NCI)\
Telephone: 240-255-0917\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#7338161f1f0a5d10011c07070a331d1a1b5d141c05)

Peer Review Contact(s) Referral Officer\
National Cancer Institute (NCI)\
Telephone: 240-276-6390\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#84eae7edf6e1e2ebe2c4e0e1e5aaeae7edaaeaedecaae3ebf2)

Financial/Grants Management Contact(s) Crystal Wolfrey\
National Cancer Institute (NCI)\
Telephone: 240-276-6277\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#10677f7c7662756973507d71797c3e7e79783e777f66)
