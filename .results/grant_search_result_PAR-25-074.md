<!--
meta-description: NIH Funding Opportunities and Notices in the NIH Guide for Grants and Contracts: Assay Validation of High Quality Markers for Clinical Studies in Cancer (UH2/UH3 Clinical Trial Not Allowed) PAR-25-074. NCI
meta-keywords: PAR-25-074: Assay Validation of High Quality Markers for Clinical Studies in Cancer (UH2/UH3 Clinical Trial Not Allowed)
meta-viewport: width=device-width, initial-scale=1.0
title: PAR-25-074: Assay Validation of High Quality Markers for Clinical Studies in Cancer (UH2/UH3 Clinical Trial Not Allowed)
-->
...
Funding Opportunity Title Assay Validation of High Quality Markers for Clinical Studies in Cancer (UH2/UH3 Clinical Trial Not Allowed)Activity Code [UH2](//grants.nih.gov/grants/funding/ac_search_results.htm?text_curr=uh2&Search.x=0&Search.y=0&Search_Type=Activity)/[UH3](//grants.nih.gov/grants/funding/ac_search_results.htm?text_curr=uh3&Search.x=0&Search.y=0&Search_Type=Activity)Phase Innovation Awards Cooperative Agreement

Announcement Type Reissue of [PAR-23-313](https://grants.nih.gov/grants/guide/pa-files/PAR-23-313.html)\
Related NoticesSee [Notices of Special Interest](https://grants.nih.gov/grants/guide/NOSIs_targetingList.cfm?GuideDocID=41628) associated with this funding opportunity
...
Posted Date October 15, 2024 Open Date (Earliest Submission Date) January 14, 2025 Letter of Intent Due Date(s) Not Applicable
...
1. Use [Grants.gov](https://grants.gov/search-grants?oppStatuses=closed%7Carchived%7Cposted%7Cforecasted&fon=PAR-25-074) Workspace to prepare and submit your application and [eRA Commons](http://public.era.nih.gov/commons/) to track your application.
...
Investigators with assays that have already met the above criteria for analytical validation may apply directly for the UH3 phase funding of the clinical validation of assays through the companion NOFO ([PAR-23-314](https://grants.nih.gov/grants/guide/pa-files/PAR-23-314.html)).
...
- Projects focused on technology development for assays or biomarker discovery such as those covered by the [Innovative Molecular Analysis Technologies Program](https://imat.cancer.gov/) (IMAT) or the [Early Detection Research Network](https://edrn.nci.nih.gov/) (EDRN) at the NCI.
...
Award Budget Applicants may request up to $275,000 direct costs for the entire UH2 phase with no more than $200,000 requested in any one year and up to $250,000 direct costs for the UH3 phase per year.
...
Send written disclosures to the NIH Chief Grants Management Officer listed on the Notice of Award for the IC that funded the award and to the[HHS Office of Inspector Grant Self Disclosure Program](https://oig.hhs.gov/compliance/self-disclosure-info/hhs-oig-grant-self-disclosure-program/) at\[[email protected]\](/cdn-cgi/l/email-protection#066174676872626f75656a69757374637546696f61286e6e7528616970).
...
Assess the potential of the proposed assays to be broadly adopted by the healthcare community for use in treatment, prevention or cancer control.

If the markers are already established in practice, evaluate whether the investigators propose to develop the assays for a novel clinical context of use. Although innovation criteria in a traditional sense may not apply for projects involving harmonization studies, evaluate whether sufficient justification is provided for the critical need for harmonization and identified steps in assay procedures (new technology, new reference standards) that would enable success in harmonization efforts.
...
Evaluate whether the plan to validate or to harmonize the clinical marker(s) and assay(s) is well considered.Evaluate whether the analytical validation in the UH2 phase with sufficient attention paid to pre-analytic variables for stabilizing the analytes (markers) is appropriate. In the plan for clinical validation of the assays in the UH3 phase, evaluate whether the number of specimens for associating assay results with a pre-specified clinical endpoint, justified by a statistical plan. Evaluate whether the plan for assay distribution is sufficient to assure its availability for the healthcare community. Assess whether the milestones for transitioning from the UH2 to the UH3 phase are specific and clear. Evaluate whether the milestones provide quantitative metrics. Evaluate whether the milestones deal with assay performance characteristics that are pertinent to the intended use of the assays. If applicable, evaluate whether the plans for collaboration with a commercial partner are adequate  to support the distribution and commercialization of the assays.
...
Evaluate whether the team will be able to manage the further development of the assay(s) should it be successful so that it can be distributed and ultimately available to the healthcare community.
...
Email:\[[email protected]\](/cdn-cgi/l/email-protection#501722313e2423193e363f103e39387e373f26)(preferred method of contact)\
...
Scientific/Research Contact(s) *For inquires related to response, resistance, and risk stratification markers for treatment trials, please contact*:

**Sumana Dey, Ph.D.**
National Cancer Institute (NCI)\
Telephone: 240-276-5748\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#bbc8ced6dad5da95dfdec2fbd5d2d395dcd4cd)
...
Email: \[[email protected]\](/cdn-cgi/l/email-protection#a4c8ddcacad7e4c9c5cdc88acacdcc8ac3cbd2)

*For inquires related to assays involving cancer epidemiology and population science:*\
**Rao Divi, Ph.D.**
National Cancer Institute (NCI)\
Telephone: 240-276-6913\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#6e0a0718071c2e030f07024000070640090118)

*For inquires related to assays involving cancer epidemiology and population science:*\
**Mukesh Verma, Ph.D.**
National Cancer Institute (NCI)\
Telephone: 240-276- 6889\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#542231263935391439353d387a3a3d3c7a333b22)

Peer Review Contact(s) **Referral Officer**
National Cancer Institute (NCI)\
Telephone: 240-276-6390\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#8fe1ece6fdeae9e0e9cfebeaeea1e1ece6a1e1e6e7a1e8e0f9)

Financial/Grants Management Contact(s) **Shane Woodward**
National Cancer Institute (NCI)\
Telephone: 240-276-6303\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#8fd8e0e0ebf8eefdfccfe2eee6e3a1e1e6e7a1e8e0f9)
