<!--
meta-description: NIH Funding Opportunities and Notices in the NIH Guide for Grants and Contracts: Limited Competition: Small Grant Program for NIDDK K01/K08/K23/K25 Recipients (R03 Clinical Trial Optional) PAR-25-091. NIDDK
meta-keywords: PAR-25-091: Limited Competition: Small Grant Program for NIDDK K01/K08/K23/K25 Recipients (R03 Clinical Trial Optional)
meta-viewport: width=device-width, initial-scale=1.0
title: PAR-25-091: Limited Competition: Small Grant Program for NIDDK K01/K08/K23/K25 Recipients (R03 Clinical Trial Optional)
-->
...
Funding Opportunity Title Limited Competition: Small Grant Program for NIDDK K01/K08/K23/K25 Recipients (R03 Clinical Trial Optional)Activity Code [R03](//grants.nih.gov/grants/funding/ac_search_results.htm?text_curr=r03&Search.x=0&Search.y=0&sort=ac&Search_Type=Activity&text_prev=) Small Grant Program

Announcement Type Reissue of [PAR-22-129](https://grants.nih.gov/grants/guide/pa-files/PAR-22-129.html)\
Related NoticesSee [Notices of Special Interest](https://grants.nih.gov/grants/guide/NOSIs_targetingList.cfm?GuideDocID=42279) associated with this funding opportunity
...
1. Use [Grants.gov](https://grants.gov/search-grants?oppStatuses=closed%7Carchived%7Cposted%7Cforecasted&fon=PAR-25-091) Workspace to prepare and submit your application and [eRA Commons](http://public.era.nih.gov/commons/) to track your application.
...
The NIDDK encourages recipients of NIDDK-supported mentored career development awards (K01/K08/K23/K25) to apply for grant support during the latter years of their awards through the NIDDK Small Grant Program (R03). This program is a limited competition and open only to current NIDDK individual career development recipients as noted below.This additional support will enable K recipients to either expand their current research objectives or to branch out to a closely related pilot study, thus demonstrating their growth as independent investigators. This should facilitate the transition to fully independent investigator status. The added grant support in the latter years of a K award is expected to have the following benefits:
...
- An opportunity for the awardee to demonstrate additional success in the peer review process during their career development award.

The NIDDK encourages every NIDDK-supported K01/K08/K23/K25 recipient to apply for R01, or equivalent, grant support during their career awards. According to NIH policy, K recipients may receive concurrent salary support from an NIH career development award and a research grant under certain circumstances ([https://grants.nih.gov/grants/guide/notice-files/NOT-OD-18-157.html](https://grants.nih.gov/grants/guide/notice-files/NOT-OD-18-157.html)). However, any K01/K08/K23/K25 recipient who successfully competes for an R01, or equivalent, grant will no longer be eligible to receive an R03 grant under this R03 program. The definition of 'equivalent' R01 grant is found on the Office of Extramural Research [website](https://grants.nih.gov/grants/glossary.htm#R01EquivalentGrant).  Additionally, individuals are only eligible to received one award under this program.

Applicants are encouraged to leverage resources available from the [NIDDK Central Repository](https://repository.niddk.nih.gov/home/), as appropriate, for proposals involving secondary data and sample analyses.

**Applications Not Responsive to this NOFO**

While applications for the R03 program do not necessarily need to be directly related to the ongoing K award, they must propose projects within the [mission interests](https://www.niddk.nih.gov/about-niddk/research-areas) of the NIDDK.  Applications that propose projects outside of NIDDK's research mission interests will be considered non-responsive.  Non-responsive applications will not be reviewed.
...
Resubmission - From this NOFO and [PAR-22-129](https://grants.nih.gov/grants/guide/pa-files/par-22-129.html).
...
Award Budget Application budgets are limited to $75,000 direct costs per year and must reflect the actual needs of the proposed project. Award Project Period The maximum project period is two years.
...
Only current NIDDK-supported K01, K08, K23, or K25 recipients are eligible to apply for this funding opportunity. K-recipients who have already successfully competed for an R01, or equivalent, grant are ineligible. See [this website](https://grants.nih.gov/grants/glossary.htm#R01EquivalentGrant) for the definition of 'equivalent' R01 grant.
...
NIDDK mentored career development award (K01, K08, K23, K25) recipients are encouraged, sometime during the latter years of their K award, to submit an R03 application in response to this announcement. Ideally, awardees should have at least one year remaining on their career development award at the intended start date of the R03; however, at a minimum, the K award must be active at the time of earliest intended start date of the R03 grant (this would include any no-cost extensions). Likewise, resubmission applications may be submitted at any time prior to the K award expiration date without prior approval, provided the K-award is still active at the time of the intended R03 start date. The award for the second year of the R03 does not require concurrent K-support. Applicants may receive funding for only one R03 grant under this program.
...
**Other Attachments**: K Award Information

The filename "K Award Information.pdf" must be used for this attachment. R03 applications must include a brief summary of the PD/PI's K-award that is funded by NIDDK. This should provide the specific aims of the K, as well as a brief summary of these aims so that the reviewers may understand the relationship of the K award to the proposed aims in the R03 grant application, and how the proposed R03 research will lead to a future research project grant application (e.g. R01, or equivalent). The PD/PI should indicate how the R03 application is informed by, or results from, the research supported by the K-award, if applicable, and how the R03 project has diverged from the K award. This attachment, combined with the information in the Research Strategy should provide adequate explanation and justification documenting how the proposed R03 support will affect plans and enhance the advancement of the K awardee toward research independence. This attachment is limited to two pages.

Applications that lack the K Award Information attachment will be considered incomplete and will not be reviewed.

**Other Attachments:** Mentor's Letter

The filename "Mentor's Letter.pdf" must be used for this attachment. A letter from the applicant's K award mentor(s) must be included in the application. If there is more than one mentor, a single counter-signed letter is sufficient. The letter should address the applicant's potential for a future, independent, research career, and describe how the mentor will facilitate the applicant's full transition to research independence.

Applications without the Mentor's Letter will be considered incomplete and will not be reviewed.
...
Send written disclosures to the NIH Chief Grants Management Officer listed on the Notice of Award for the IC that funded the award and to the[HHS Office of Inspector Grant Self Disclosure Program](https://oig.hhs.gov/compliance/self-disclosure-info/hhs-oig-grant-self-disclosure-program/) at\[[email protected]\](/cdn-cgi/l/email-protection#ec8b9e8d829888859f8f80839f999e899fac83858bc284849fc28b839a).
...
Email:\[[email protected]\](/cdn-cgi/l/email-protection#662114070812152f08000926080f0e48010910)(preferred method of contact)\
Telephone: 301-480-7075

Grants.gov Customer Support (Questions regarding Grants.gov registration and Workspace)\
Contact Center Telephone: 800-518-4726\
Email:\[[email protected]\](/cdn-cgi/l/email-protection#deadabaeaeb1acaa9eb9acbfb0aaadf0b9b1a8)

Scientific/Research Contact(s) Lisa M. Spain, Ph.D.\
Division of Diabetes, Endocrinology, and Metabolic Diseases\
National Institute of Diabetes and Digestive and Kidney Diseases (NIDDK)\
Telephone: 301-451-9871\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#2f7c5f4e4641636f41464b4b440141464701484059)

David E. Saslowsky, Ph.D.\
Division of Digestive Diseases and Nutrition\
National Institute of Diabetes and Digestive and Kidney Diseases (NIDDK)\
Telephone: 301-594-8876\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#3a7e5b4c535e14695b4956554d4951437a545352145d554c)

Voula Osganian, M.D., Sc.D., M.P.H. (where parent K award involves a clinical trial)\
Division of Digestive Diseases and Nutrition\
National Institute of Diabetes and Digestive and Kidney Diseases (NIDDK)\
Telephone: 301-827-6939\
Email:\[[email protected]\](/cdn-cgi/l/email-protection#275148524b460948544046494e464967494e4f09404851)

Cindy Roy, Ph.D. (for Hematology)\
Division of Kidney, Urologic, and Hematologic Diseases\
National Institute of Diabetes and Digestive and Kidney Diseases (NIDDK)\
Telephone: 301-594-8805\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#d6b5bfb8b2aff8a4b9af96bbb7bfbaf8b8bfbef8b1b9a0)

Tracy L. Rankin, Ph.D., M.P.H. (for Kidney and Urology)\
Division of Kidney, Urologic, and Hematologic Diseases\
National Institute of Diabetes and Digestive and Kidney Diseases (NIDDK)\
Telephone: 301-594-4748\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#473526292c2e2933072a262e2b69292e2f69202831)

Peer Review Contact(s) Charlene Repique, Ph.D.\
National Institute of Diabetes and Digestive and Kidney Diseases (NIDDK)\
Telephone: 301-594-7791\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#5e3d363f2c323b303b702c3b2e372f2b3b1e30373670393128)

Financial/Grants Management Contact(s) Natasha Loveless\
National Institute of Diabetes and Digestive and Kidney Diseases (NIDDK)\
Telephone: 301-594-8853\
Email: \[[email protected]\](/cdn-cgi/l/email-protection#145a756075677c753a587b627178716767547a7d7c3a737b62)
