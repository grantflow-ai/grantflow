				...
				backgroundStack={
					<>
						...
						<div
							...
							style={{
								background:
									"radial-gradient(65% 34% at 50% 100%, var(--primary) -38%, transparent 100%)",
							}}
						/>
					</>
				}
				...
				<div className="relative flex min-h-screen w-full flex-col items-center">
					<div className="max-w-198 w-full">
						<p className="mb-20 text-lg leading-tight md:text-base">
							GrantFlow is a tool designed to support researchers through one of the most time-consuming
							parts of their work: applying for grants. Researchers today spend a large part of their time
							on funding-related documentation, most of it could otherwise be invested in research and
					...
					<div className="max-w-198 mb-20 w-full">
						...
						<p className="font-normal leading-tight">
							Grants are the most important funding source for STEM research. However, the application
							process is often slow, complex, and resource-intensive.{" "}
						</p>
						<p className="font-normal leading-tight">
							By simplifying the grant writing process, GrantFlow supports researchers in focusing on
							their core work advancing knowledge and innovating.
						</p>
					</div>
					<p className="max-w-198 w-full font-semibold leading-tight">
						GrantFlow is currently in the final stage of development. If you&apos;re interested in early
						access, you&apos;re welcome to join the waitlist and be one of the first to try it when we
						launch.
					</p>
				</div>
			</LegalPageContainer>
