...
export default function SignIn() {
	...
	return (
		<CookieConsentTrigger triggerElementTestId="login-link-button">
			<div
								...
								<AppCardContent className="flex flex-col gap-12 p-0">
									<div className="flex flex-col gap-6">
										<p className="text-left font-normal text-sm leading-5 text-app-black">
											...
											<span className="text-primary">{submittedEmail}</span>. Please check your
											inbox and click the link to activate your GrantFlow account.
										</p>
