			...
			<nav className="flex-1 overflow-y-auto">
				<Link
					className={cn(
						...
						pathname === routes.organization.project.detail() && "bg-[#e1dfeb]",
					)}
					href={routes.organization.project.detail()}
				>
						...
						<div className="mt-2 space-y-1">
							{applications.length > 0 ? (
								applications.map((app) => {
									const appPath = routes.organization.project.application.detail();
									return (
										<Link
											className={cn(
						...
						<div className="mt-2 space-y-1">
							<Link
								className={cn(
									...
									pathname === routes.organization.settings.account() && "bg-[#e1dfeb]",
								)}
							...
							{(userRole === UserRole.OWNER || userRole === UserRole.ADMIN) && (
								<>
									<Link
										className={cn(
											"flex items-center gap-3 px-8 py-2 text-[14px] font-['Source_Sans_Pro'] text-[#636170] hover:bg-[#e1dfeb] transition-colors",
											pathname === routes.organization.settings.billing() && "bg-[#e1dfeb]",
										)}
									...
									<Link
										className={cn(
											"flex items-center gap-3 px-8 py-2 text-[14px] font-['Source_Sans_Pro'] text-[#636170] hover:bg-[#e1dfeb] transition-colors",
											pathname === routes.organization.settings.members() && "bg-[#e1dfeb]",
										)}
							...
							<Link
								className={cn(
									"flex items-center gap-3 px-8 py-2 text-[14px] font-['Source_Sans_Pro'] text-[#636170] hover:bg-[#e1dfeb] transition-colors",
									pathname === routes.organization.settings.notifications() && "bg-[#e1dfeb]",
								)}
			...
			<nav className="flex-1 flex flex-col items-center gap-4">
				<Link
					className={cn(
						...
						pathname === routes.organization.project.detail()
