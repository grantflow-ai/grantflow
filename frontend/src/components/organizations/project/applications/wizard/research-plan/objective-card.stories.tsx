...
const buildObjective = (overrides?: Parameters<typeof ResearchObjectiveFactory.build>[0]): ResearchObjective =>
	ResearchObjectiveFactory.build(overrides) as ResearchObjective;
const buildTask = (
	overrides?: Parameters<typeof ResearchTaskFactory.build>[0],
): ResearchObjective["research_tasks"][number] =>
	ResearchTaskFactory.build(overrides) as ResearchObjective["research_tasks"][number];
