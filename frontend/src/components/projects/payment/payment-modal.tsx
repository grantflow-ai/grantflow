...
const Monthlyplans = [
  {
    btn: "Start Now",
    features: [
      "One Grant application for free!",
...
export default function Paymentmodal({ isOpen, onClose }: PaymentModalProps) {
  return (
    <div>
      <BaseModal
        className="w-full !max-w-[1200px] text-black px-14 py-8"
        isOpen={isOpen}
        onClose={onClose}
      >
        <DialogHeader className=" w-full  flex items-center justify-center">
          ...
          <DialogDescription className="font-normal text-base leading-5 text-black">
            Flexible options designed for labs of all sizes. Get the tools,
            collaboration, and support you need to win more grants.
          </DialogDescription>
        </DialogHeader>
        <main>
                ...
                {Monthlyplans.map((plan, index) => (
                  ...
                  >
                    ...
                    <article className="flex flex-col gap-4">
                      <h5 className="font-semibold text-base leading-[22px]">
                        includes
                      </h5>
