...
import { ApplicationPreview, TemplateFileUploader, WizardLeftPane } from "@/components/projects/wizard/shared";
...
const titleErrorMessage = (titleLength: number) => {
	return titleLength === 0 ? "Title is required" : "Title is required and must be at least 10 characters";
};
