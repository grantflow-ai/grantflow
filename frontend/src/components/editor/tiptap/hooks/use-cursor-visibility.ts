...
import { useWindowSize } from "@/components/editor/tiptap/hooks/use-window-size";
...
export interface CursorVisibilityOptions {
	 ...
	 */
	elementRef?: null | React.RefObject<HTMLElement>;
	/**
 ...
 */
export type RectState = Pick<DOMRect, "height" | "width" | "x" | "y">;
 ...
 * @returns void
 */
export function useCursorVisibility({ editor, elementRef = null, overlayHeight = 0 }: CursorVisibilityOptions) {
