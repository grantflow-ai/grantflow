 ...
 */
export function cn(...classes: (boolean | null | string | undefined)[]): string {
...
const ATTR_WHITESPACE =
	// biome-ignore lint/suspicious/noControlCharactersInRegex: this is valid
	/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g;
...
export function isAllowedUri(uri: string | undefined, protocols?: ProtocolConfig) {
	...
	return (
		...
		new RegExp(
			...
			"i",
		).exec(uri.replaceAll(ATTR_WHITESPACE, ""))
	);
}
