	...
	return (
		<div className="space-y-6" data-testid="institution-location-step">
			<div data-testid="institution-location-step-header">
				<h3 className="text-2xl font-semibold text-dark" data-testid="institution-location-step-title">
					Institution Location
				</h3>
				<p className="mt-2 text-muted" data-testid="institution-location-step-description">
