...
CREATE TABLE "generation_results" (
  ...
  "text" text NOT NULL,
  PRIMARY KEY ("id"),
  CONSTRAINT "generation_results_application_id_fkey" FOREIGN KEY ("application_id") REFERENCES "grant_applications" ("id") ON UPDATE CASCADE ON DELETE CASCADE
);
...
-- Create "research_innovations" table
CREATE TABLE "research_innovations" (
  "id" uuid NOT NULL,
  "application_id" uuid NOT NULL,
  "text" text NOT NULL,
  PRIMARY KEY ("id"),
  CONSTRAINT "research_innovations_application_id_fkey" FOREIGN KEY ("application_id") REFERENCES "grant_applications" ("id") ON UPDATE CASCADE ON DELETE CASCADE
);
-- Create "research_significances" table
CREATE TABLE "research_significances" (
  "id" uuid NOT NULL,
  "application_id" uuid NOT NULL,
  "text" text NOT NULL,
  PRIMARY KEY ("id"),
  CONSTRAINT "research_significances_application_id_fkey" FOREIGN KEY ("application_id") REFERENCES "grant_applications" ("id") ON UPDATE CASCADE ON DELETE CASCADE
);
