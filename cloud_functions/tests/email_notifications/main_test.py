...
class TestEmailNotificationFunction:
    ...
    @pytest.fixture
    def cloud_event_data(self) -> dict[str, Any]:
    ...
    @pytest.fixture
    def mock_cloud_event(self, cloud_event_data: dict[str, Any]) -> CloudEvent:
    ...
    @pytest.fixture
    def mock_application_data(self) -> dict[str, Any]:
    ...
    async def test_get_application_data_success(
        self, mock_application_data: dict[str, Any], monkeypatch: pytest.MonkeyPatch
    ) -> None:
    ...
    async def test_get_application_data_not_found(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def test_markdown_to_docx(self) -> None:
...
"""
    ...
    async def test_send_resend_email_api_error(self, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    async def test_send_application_email_invalid_event(self) -> None:
        ...
        assert result["message"] == "Invalid CloudEvent format"

    async def test_send_application_email_missing_application_id(self) -> None:
    ...
    async def test_send_application_email_database_error(
        self, mock_cloud_event: CloudEvent, monkeypatch: pytest.MonkeyPatch
    ) -> None:
    ...
    def test_sync_wrapper_success(self, mock_cloud_event: CloudEvent, monkeypatch: pytest.MonkeyPatch) -> None:
