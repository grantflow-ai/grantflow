...
**Test Date**: 2025-09-17T06:06:18
**Test Type**: length_compliance_and_rouge_baseline
**Total Iterations**: 5
...
- **ROUGE-L (semantic similarity)**: 0.274
- **ROUGE-2 (bigram overlap)**: 0.113
...
- **Minimum ROUGE-L Score**: ≥0.274 (baseline average)
...
2. **Semantic Proximity**: ROUGE-L scores of 0.274 indicate good semantic similarity between requirements and generated text.
